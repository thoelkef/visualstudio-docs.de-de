...
Alternativ können Sie [Remotedebugging](vs-azure-tools-debugging-cloud-services-overview.md) verwenden, um direkt an einen Clouddienst anzuhängen, der in Azure ausgeführt wird.
