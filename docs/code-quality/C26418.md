...
Grundlegende Richtlinien: **C++** R. 36: Nehmen Sie ein shared_ptr @ no__t-0widget > &-Parameter, um auszudrücken, dass es möglicherweise einen Verweis Zähler für das Objekt beibehält.
