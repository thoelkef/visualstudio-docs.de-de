...
**C++-Core-Richtlinien**: R.36: Nehmen Sie eine const "shared_ptr"<widget>& Parameter an, dass es einen Verweiszähler auf das Objekt beibehalten möglicherweise express
