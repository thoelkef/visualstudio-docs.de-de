---
title: "Analysieren der Qualität von C/C++-Code mithilfe der Codeanalyse | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Verwenden der C++-Core-Richtlinienprüfungen](../code-quality/using-the-cpp-core-guidelines-checkers.md)|Fügen Sie die Spielsteine C++ Core Richtlinien zu Ihrem Projekt hinzu.|  
