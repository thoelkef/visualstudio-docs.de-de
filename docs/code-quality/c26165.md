...
ms.locfileid: "31889250"
---
# <a name="c26165"></a>C26165
Warnung C26165: möglicherweise fehlschlagen Sperre aufhebt \<Sperre > in der Funktion \<Func >.

 Warnung C26165 ähnelt Warnung [C26115](../code-quality/c26115.md) mit dem Unterschied, dass der Vertrauensgrad niedriger ist. Die Funktion kann z. B. Anmerkung Fehler enthalten.
...
## <a name="example"></a>Beispiel
 Um diese Warnung zu beheben, ändern Sie im vorherige Beispiel wie folgt.
