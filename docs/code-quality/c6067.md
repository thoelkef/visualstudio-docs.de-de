...
ms.locfileid: "72009151"
---
# <a name="c6067"></a>C6067
Warnung C6067: der Parameter \<number > im Aufrufen von \<function > muss die Adresse der Zeichenfolge sein.
...
```
 ...
 Der folgende Code generiert diese Warnung, weil beim Übergeben des Parameters, Buffer, an `scanf` eine falsche Dereferenzierungsebene angegeben wird:
