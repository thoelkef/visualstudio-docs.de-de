...
ms.locfileid: "72008955"
---
# <a name="c6211"></a>C6211
Warnung C6211: Das Verlust von Speicher \<pointer > aufgrund einer Ausnahme. Verwenden Sie einen lokalen Catch-Block, um den Arbeitsspeicher zu bereinigen.
...
## <a name="example"></a>Beispiel
 Der folgende Code generiert diese Warnung, weil eine Ausnahme während der zweiten Zuordnung ausgelöst werden konnte, wodurch die erste Zuordnung verworfen wird, oder eine Ausnahme an einer beliebigen Stelle im Code ausgelöst wird, die durch den Kommentar "`code ...`" dargestellt wird. beide Zuordnungen.
