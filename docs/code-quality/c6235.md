...
ms.locfileid: "72013558"
---
# <a name="c6235"></a>C6235
Warning C6235: (\<ungleich NULL-Konstante > &#124; &#124; \<expression >) ist immer eine Konstante ungleich 0 (null).
...
```
 ...
 Der folgende Code verwendet den bitweisen AND-Operator (`&`), um diese Warnung zu beheben:
