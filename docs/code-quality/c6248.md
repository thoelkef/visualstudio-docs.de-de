...
```
 ...
 Ein vollständiges Beispiel zum Erstellen der Sicherheitsbeschreibung finden Sie unter [Erstellen einer Sicherheitsbeschreibung für ein neues Objekt in C++](http://msdn.microsoft.com/library/aa446595.aspx). Weitere Informationen finden Sie unter [Creating a DACL](/windows/desktop/SecBP/creating-a-dacl).