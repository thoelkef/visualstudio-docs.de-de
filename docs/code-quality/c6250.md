...
ms.locfileid: "72009097"
---
# <a name="c6250"></a>C6250
Warnung C6250: Wenn \<function > VirtualFree ohne das MEM_RELEASE-Flag aufgerufen wird, wird möglicherweise Speicher freigegeben, aber keine Adress Deskriptoren (VADs). Ergebnisse in Adressraum Lecks
