...
ms.locfileid: "72444849"
---
# <a name="c6250"></a>C6250
Warnung C6250: durch das Aufrufen von \<function > VirtualFree ohne das MEM_RELEASE-Flag wird möglicherweise Arbeitsspeicher freigegeben, aber keine Adress Deskriptoren (VADs). Ergebnisse in Adressraum Lecks
 ...
 Weitere Informationen finden Sie unter [virtualzuweisung](http://go.microsoft.com/fwlink/?LinkId=181201) und [VirtualFree](http://go.microsoft.com/fwlink/?LinkId=181202).
