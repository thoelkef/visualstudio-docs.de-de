...
## <a name="see-also"></a>Siehe auch
 [Calloc](/cpp/c-runtime-library/reference/calloc) ["malloc"](/cpp/c-runtime-library/reference/malloc) [freien](/cpp/c-runtime-library/reference/free) [new-Operator](/cpp/cpp/new-operator-cpp) [delete-Operator](/cpp/cpp/delete-operator-cpp) ["shared_ptr"](/cpp/standard-library/shared-ptr-class) [Unique_ptr](/cpp/standard-library/unique-ptr-class) [intelligente Zeiger](/cpp/cpp/smart-pointers-modern-cpp)