...
## <a name="see-also"></a>Siehe auch
 <xref:System.EventArgs?displayProperty=fullName> <xref:System.Object?displayProperty=fullName> [Behandeln und Auslösen von Ereignissen](/dotnet/standard/events/index)