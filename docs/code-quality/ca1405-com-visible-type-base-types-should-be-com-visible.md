...
## <a name="see-also"></a>Siehe auch
 <xref:System.Runtime.InteropServices.ClassInterfaceAttribute?displayProperty=fullName> [Interoperation mit nicht verwaltetem Code](/dotnet/framework/interop/index)