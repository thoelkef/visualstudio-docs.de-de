---
title: 'CA1825: Array Zuordnungen der Länge 0 (null) vermeiden'
ms.date: 09/16/2019
ms.topic: reference
f1_keywords:
...
---
# <a name="ca1825-avoid-zero-length-array-allocations"></a>CA1825: Array Zuordnungen der Länge 0 (null) vermeiden
...
Um einen Verstoß zu beheben, ersetzen Sie die Array Zuordnung der Länge 0 (null) durch einen <xref:System.Array.Empty%2A?displayProperty=nameWithType>. Die folgenden beiden Code Ausschnitte zeigen z. b. einen Verstoß gegen die Regel und wie Sie behoben werden:
...
- [CA1814: Verzweigte Arrays mehrdimensionalen Arrays vorziehen](ca1814.md)
