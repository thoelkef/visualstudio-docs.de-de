...
Informationen zum Ändern des Ziel-Frameworks eines Projekts finden Sie unter Gewusst [wie: Zielversion von .net](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
