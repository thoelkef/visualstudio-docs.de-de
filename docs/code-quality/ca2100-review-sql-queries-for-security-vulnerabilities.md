---
title: "CA2100: Überprüfen Sie SQL-Abfragen für Sicherheitsrisiken | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [System.Data.SqlServerCe.SqlCeCommand](https://msdn.microsoft.com/library/system.data.sqlserverce.sqlcecommand.aspx) und [System.Data.SqlServerCe.SqlCeDataAdapter](https://msdn.microsoft.com/library/system.data.sqlserverce.sqlcedataadapter.aspx)  
...
## <a name="see-also"></a>Siehe auch  
 [Sicherheit (Übersicht)](/dotnet/framework/data/adonet/security-overview)