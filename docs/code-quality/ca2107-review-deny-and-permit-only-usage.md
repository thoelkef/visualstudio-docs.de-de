...
- Werte, die zum Erstellen von Pfad basierten Berechtigungen verwendet werden, können in der Regel auf verschiedene Weise angegeben werden. Durch das Verweigern des Zugriffs auf eine Form des Pfads wird nicht der Zugriff auf alle Formulare verweigert. Wenn z. b. eine Datei \\Freigabe \server\freigabe einem Netzwerklaufwerk X: zugeordnet ist, müssen Sie zum Verweigern des Zugriffs auf eine Datei auf der Freigabe " \\\server\share\file", "x:\file" und jedem anderen Pfad, der auf die Datei zugreift, verweigern.
