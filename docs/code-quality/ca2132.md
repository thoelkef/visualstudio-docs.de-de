...
Warnungen von dieser Regel nicht unterdrücken. Verstöße gegen diese Regel durch Anwendungscode führen dazu, dass CoreCLR den Typ mit einem <xref:System.TypeLoadException> lädt.
