...
Code, der als <xref:System.Security.SecurityTransparentAttribute> gekennzeichnet ist, werden keine ausreichenden Berechtigungen für Assert erteilt.

## <a name="rule-description"></a>Regelbeschreibung
Mit dieser Regel werden alle Methoden und Typen in einer Assembly analysiert, die entweder 100% transparent oder gemischt transparent/kritisch ist, und jede deklarative oder imperative Verwendung von <xref:System.Security.CodeAccessPermission.Assert%2A>.
