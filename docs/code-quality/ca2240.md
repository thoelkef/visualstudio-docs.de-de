...
- Der Typ erbt jedoch nicht die <xref:System.Runtime.Serialization.ISerializable.GetObjectData%2A?displayProperty=fullName>-Methode, und der Typ deklariert Instanzfelder, die nicht mit dem Attribut "<xref:System.NonSerializedAttribute?displayProperty=fullName>" gekennzeichnet sind.
