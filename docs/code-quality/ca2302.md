...
Eine <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType>-Deserialisierungsmethode wurde aufgerufen, auf die verwiesen wird, und die <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>-Eigenschaft kann NULL sein.

## <a name="rule-description"></a>Regelbeschreibung

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Diese Regel findet <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType>-deserialisierungsmethodenaufrufe oder Verweise, wenn die <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> NULL sein kann. Wenn Sie die Deserialisierung mit <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> unabhängig von der Eigenschaft <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> nicht zulassen möchten, deaktivieren Sie diese Regel und [CA2301](ca2301.md), und aktivieren Sie Regel [CA2300](ca2300.md).
...
- Deserialisierte Typen einschränken. Implementieren Sie eine benutzerdefinierte <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType>. Legen Sie vor der Deserialisierung mit <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> die <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>-Eigenschaft auf eine Instanz des benutzerdefinierten <xref:System.Runtime.Serialization.SerializationBinder> fest. Lösen Sie in der überschriebenen <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A>-Methode, wenn der Typ unerwartet ist, eine Ausnahme aus, um die Deserialisierung zu beenden.
  - Stellen Sie sicher, dass für alle Codepfade die Eigenschaft <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> festgelegt ist.
...
[CA2300: Verwenden Sie nicht unsichere Deserialisierungsprogramm BinaryFormatter @ no__t-0

[CA2301: Rufen Sie nicht BinaryFormatter. Deserialize auf, ohne zuerst BinaryFormatter. Binder @ no__t-0 festzulegen.
