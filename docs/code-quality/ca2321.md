---
title: 'CA2321: Führen Sie mit mithilfe einer SimpleTypeResolver JavaScriptSerializer nicht deserialisiert werden'
ms.date: 05/08/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "65459383"
---
# <a name="ca2321-do-not-deserialize-with-javascriptserializer-using-a-simpletyperesolver"></a>CA2321: Führen Sie mit mithilfe einer SimpleTypeResolver JavaScriptSerializer nicht deserialisiert werden
...
Ein <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> Deserialisierungsmethode war aufgerufen oder auf die verwiesen wird nach dem Initialisieren von mit einer <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="rule-description"></a>Regelbeschreibung

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Diese Regel sucht nach <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> Deserialisierung Methoden- oder Verweise, hinter der Initialisierung der <xref:System.Web.Script.Serialization.JavaScriptSerializer> mit einem <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="how-to-fix-violations"></a>Behandeln von Verstößen

- Nicht initialisieren <xref:System.Web.Script.Serialization.JavaScriptTypeResolver?displayPropertyName=nameWithType> mit einem <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.
...
[CA2322: Sicherstellen Sie, dass JavaScriptSerializer vor der Deserialisierung nicht mit SimpleTypeResolver initialisiert ist](ca2322.md)