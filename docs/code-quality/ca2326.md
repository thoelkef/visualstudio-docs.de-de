...
- Auf einen " [newtonsoft. JSON. typamehanding](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) "-Enumerationswert, mit Ausnahme von `None` , wird verwiesen.
...
Diese Regel findet einen anderen Wert als " [newtonsoft. JSON. typamehanding](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) `None` ". Wenn Sie nur deserialisieren möchten, wenn eine " [newtonsoft. JSON. Serialization. iserializationbinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm) " angegeben wird, um deserialisierte Typen einzuschränken, deaktivieren Sie diese Regel, und aktivieren Sie stattdessen die Regeln [CA2327](ca2327.md), [CA2328](ca2328.md), [CA2329](ca2329.md)und [CA2330](ca2330.md) .
