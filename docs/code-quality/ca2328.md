...
- Sie wissen, dass die [newtonsoft. JSON. jsonserializersettings. SerializationBinder](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_SerializationBinder.htm) -Eigenschaft immer festgelegt wird, wenn die [typenamehandelt](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm) - `None`Eigenschaft ein anderer Wert als ist.
