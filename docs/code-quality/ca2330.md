---
title: 'CA2330: Stellen Sie sicher, dass jsonSerializer bei der Deserialisierung eine sichere Konfiguration aufweist.'
...
ms.locfileid: "69893826"
---
# <a name="ca2330-ensure-that-jsonserializer-has-a-secure-configuration-when-deserializing"></a>CA2330: Stellen Sie sicher, dass jsonSerializer bei der Deserialisierung eine sichere Konfiguration aufweist.
...
- Die [typamehanding](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_TypeNameHandling.htm) -Eigenschaft ist ein anderer Wert `None`als.
...
[CA2326: Verwenden Sie nicht "typamehanding"-Werte außer "None".](ca2326.md)
