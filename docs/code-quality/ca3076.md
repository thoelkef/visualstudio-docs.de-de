...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Verstoß&mdash;Dokument Funktion und Skriptausführung nicht deaktiviert
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Lösungs&mdash;Deaktivieren der Dokument Funktion und Skriptausführung
