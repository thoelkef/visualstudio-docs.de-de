...
ms.locfileid: "53053385"
---
# <a name="c-core-guidelines-checker-reference"></a>C++ Core Guidelines Überprüfungsprogramm Verweis

Dieser Abschnitt listet die Warnungen für C++ Core Richtlinien aus. Weitere Informationen zur Codeanalyse finden Sie unter [/ analyze (Codeanalyse)](/cpp/build/reference/analyze-code-analysis) und [Schnellstart: Codeanalyse für C/C++-](../code-quality/quick-start-code-analysis-for-c-cpp.md).
...
Finden Sie unter [C++ Core Guidelines: F.6: Wenn Ihre Funktion nicht ausgelöst werden kann, deklarieren Sie es "noexcept"](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#f6-if-your-function-may-not-throw-declare-it-noexcept).
