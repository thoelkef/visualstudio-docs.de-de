...
[C26448 USE_GSL_FINALLY](c26448.md) Verwenden Sie `gsl::finally`, wenn die endgültige Aktion beabsichtigt ist. Finden Sie unter [C++ Core Guidelines: GSL.util: Dienstprogramme](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
