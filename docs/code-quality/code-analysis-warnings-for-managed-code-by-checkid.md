...
| CA1069 | [CA1069: Enumerationswerte dürfen keine doppelten Werte aufweisen.](../code-quality/ca1069.md) | Eine Enumeration verfügt über mehrere Member, denen explizit derselbe Konstante Wert zugewiesen wird. |
| CA1070 | [CA1070: Ereignis Felder nicht als virtuell deklarieren](../code-quality/ca1070.md) | Ein [Feld ähnliches Ereignis](/dotnet/csharp/language-reference/language-specification/classes#field-like-events) wurde als virtuell deklariert. |
...
| CA2011 | [CA2011: keine Eigenschaft innerhalb des Setter zuweisen](ca2011.md) | Einer Eigenschaft wurde versehentlich ein Wert innerhalb ihrer eigenen [Set-Zugriffs](/dotnet/csharp/programming-guide/classes-and-structs/using-properties#the-set-accessor)Methode zugewiesen. |
...
| CA2244 | [CA2244: keine indizierten Element Initialisierungen duplizieren](../code-quality/ca2244.md) | Ein Objektinitialisierer verfügt über mehr als einen indizierten Elementinitialisierer mit demselben Konstanten Index. Alle außer der letzte Initialisierer sind redundant. |
| CA2245 | [CA2245: keine Eigenschaft selbst zuweisen](../code-quality/ca2245.md) | Eine Eigenschaft wurde versehentlich selbst zugewiesen. |
| CA2246 | [CA2246: weisen Sie kein Symbol und seinen Member in derselben Anweisung zu.](../code-quality/ca2246.md) | Es wird nicht empfohlen, ein Symbol und dessen Member, d. h. ein Feld oder eine Eigenschaft, in derselben Anweisung zuzuweisen. Es ist nicht klar, ob der Element Zugriff dazu gedacht war, den alten Wert des Symbols vor der Zuweisung oder den neuen Wert aus der Zuweisung in dieser Anweisung zu verwenden. |
