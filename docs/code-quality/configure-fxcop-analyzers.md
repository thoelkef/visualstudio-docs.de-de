...
ms.locfileid: "90560761"
---
# <a name="configure-net-code-quality-analyzers-with-editorconfig"></a>Konfigurieren von .NET-Code Qualitätsanalysen mit Editor config

Ab .net 5,0 sind Code Qualitätsanalysen ([ `CAxxxx` Regeln](code-analysis-for-managed-code-warnings.md)) im [.NET SDK](/dotnet/fundamentals/productivity/code-analysis.md/#code-quality-analysis)enthalten. Alle Code Quality Analyzer können so optimiert werden, dass Sie durch konfigurierbare Optionen auf die Teile Ihrer Codebasis angewendet werden. Jede Option wird durch Hinzufügen eines Schlüssel-Wert-Paars zu einer [Editor config](https://editorconfig.org) -Datei angegeben. Eine Konfigurationsdatei kann für eine Datei, ein Projekt, eine Lösung oder das gesamte Repository spezifisch sein.
...
## <a name="options-for-net-code-quality-analyzers"></a>Optionen für .NET-Code Qualitätsanalysen
