...
|[CA1007 NACH MÖGLICHKEIT](../code-quality/ca1007-use-generics-where-appropriate.md)|Verwenden Sie Generika|
...
|[CA1024 NACH MÖGLICHKEIT](../code-quality/ca1024-use-properties-where-appropriate.md)|Verwenden Sie Eigenschaften|
...
|[CA1035](../code-quality/ca1035-icollection-implementations-have-strongly-typed-members.md)|ICollection-Implementierungen weisen Member mit starker Typisierung|
...
|[CA1708](../code-quality/ca1708-identifiers-should-differ-by-more-than-case.md)|Bezeichner sollten sich durch die Groß-/Kleinschreibung unterscheiden.|
...
|[CA1814](../code-quality/ca1814-prefer-jagged-arrays-over-multidimensional.md)|Verzweigte Arrays mehrdimensionalen bevorzugen|
|[CA1815](../code-quality/ca1815-override-equals-and-operator-equals-on-value-types.md)|Außer Kraft setzen equals und Gleichheitsoperator für Werttypen|
...
|[CA1702 BEI](../code-quality/ca1702-compound-words-should-be-cased-correctly.md)|Bei zusammengesetzten Begriffen sollte beachtet werden|
...
|[CA1709](../code-quality/ca1709-identifiers-should-be-cased-correctly.md)|Bezeichner sollten beachtet werden|
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|Führen Sie keine Präfixe für Enumerationswerte mit Typnamen|
...
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|Eigenschaftennamen sollten nicht mit dem Get-Methoden übereinstimmen.|
