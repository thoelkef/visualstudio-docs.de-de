...
layout: LandingPage
title: Codeanalyse
description: Erfahren Sie, wie Sie Visual Studio verwenden, um die Codequalität zu analysieren.
ms.date: 12/03/2018
...
ms.locfileid: "62820732"
---
# <a name="code-analysis-in-visual-studio"></a>Codeanalyse in Visual Studio

Visual Studio bietet verschiedene Tools zur Analyse und Verbesserung der Codequalität.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analysieren der Qualität von verwaltetem Code</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analysieren der Qualität von C- und C++-Code</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Messen der Verwaltbarkeit von Code mithilfe von Codemetriken</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Analysen für verwalteten Code (Warnungen)</h3>
                    </div>
                </div>
            </div>
        </div>
