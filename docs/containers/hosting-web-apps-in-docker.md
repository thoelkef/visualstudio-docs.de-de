...
description: Erfahren Sie, wie Sie Visual Studio-Containertools zum Bereitstellen einer ASP.NET Core-Web-App in einer Containerregistrierung verwenden.
author: ghogen
manager: jillfra
