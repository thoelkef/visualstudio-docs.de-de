...
###  <a name="WindowsHTML"></a>Windows 10-Zielgeräte
 ![Windows-Geräte](~/docs/cross-platform/media/windowsdevices.png "WindowsDevices")
...
##  <a name="CPP"></a>Erstellen einer App für Android und Windows (C++)
 ![Verwenden von C++ zur Erstellung für Android, iOS und Windows](~/docs/cross-platform/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")
...
##  <a name="Unity"></a>Erstellen eines plattformübergreifenden Spiels für Android, iOS und Windows mithilfe von Visual Studio-Tools für Unity
 ...
 ![VSTU-Entwicklungsumgebung](~/docs/cross-platform/media/vstu_overview.png "VSTU_Overview")
