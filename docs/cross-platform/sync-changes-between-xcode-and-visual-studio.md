...
### <a name="open-in-xcode"></a>In XCode öffnen  
 ...
 ![Das Fenster „Ausgabe“ zeigt die Aktionen des Remotecomputers. ] (~/docs/cross-platform/media/cppmdd_u2_remotemachine_output.png "CPPMDD_U2_RemoteMachine_Output")  
