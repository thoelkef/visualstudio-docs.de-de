---
title: Generieren Sie ein Feld, eine Eigenschaft oder eine lokale - Generierung von Code (c#) | Microsoft Docs
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-a-field-property-or-local-in-c"></a>Generieren Sie ein Feld, eine Eigenschaft oder eine lokale in c# #
...
1. Als Nächstes führen Sie eine der folgenden:
   * **Tastatur**
     * Drücken Sie **STRG +.** Trigger die **Schnellaktionen und Refactorings** Menü **generieren Feld/Eigenschaft/Local** im Popupmenü Fenster Vorschau.
   * **Maus**
     * Mit der rechten Maustaste, und wählen Sie die **Schnellaktionen und Refactorings** Menü **generieren Feld/Eigenschaft/Local** im Popupmenü Fenster Vorschau.
