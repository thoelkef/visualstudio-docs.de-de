...
## [Erstellen einer SQL­-Datenbank mithilfe Skripts](create-a-sql-database-by-using-a-script.md)
...
### [Gewusst wie: Speichern und Bearbeiten von Verbindungszeichenfolgen](how-to-save-and-edit-connection-strings.md)
...
#### [Gewusst wie: Ändern des Rückgabetyps für eine DataContext-Methode (O/R-Designer)](how-to-change-the-return-type-of-a-datacontext-method-o-r-designer.md)
#### [Gewusst wie: Erstellen von DataContext-Methoden, die zu gespeicherten Prozeduren und Funktionen zugeordnet sind (O/R-Designer)](how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer.md)
### [Datenklassenvererbung (O/R-Designer)](data-class-inheritance-o-r-designer.md)
#### [Gewusst wie: Konfigurieren der Vererbung mit dem O/R-Designer](how-to-configure-inheritance-by-using-the-o-r-designer.md)
...
### [Gewusst wie: Erstellen von LINQ to SQL-Klassen, die zu Tabellen und Ansichten zugeordnet sind (O-R-Designer)](how-to-create-linq-to-sql-classes-mapped-to-tables-and-views-o-r-designer.md)
### [Gewusst wie: Erweitern von durch den O/R-Designer erstellten Code](how-to-extend-code-generated-by-the-o-r-designer.md)
### [Gewusst wie: Erstellen einer Zuordnung (Beziehung) zwischen LINQ to SQL-Klassen (O-R-Designer)](how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md)
...
### [Gewusst wie: Zuweisen von gespeicherten Prozeduren zum Durchführen von Aktionen zum Aktualisieren, Einfügen und Löschen (O/R-Designer)](how-to-assign-stored-procedures-to-perform-updates-inserts-and-deletes-o-r-designer.md)
### [Gewusst wie: Aktivieren/Deaktivieren der Pluralisierung (O/R-Designer)](how-to-turn-pluralization-on-and-off-o-r-designer.md)
### [O-R-Designermeldungen](o-r-designer-messages.md)
...
### [Binden von WPF-Steuerelementen an Daten in Visual Studio](bind-wpf-controls-to-data-in-visual-studio.md)
...
### [Exemplarische Vorgehensweise: Erstellen eines WCF-Diensts in Windows Forms](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
...
### [Arbeiten mit einem konzeptionellen Modell (WCF Data Services)](working-with-a-conceptual-model-wcf-data-services.md)
...
### [Gewusst wie: Hinzufügen, Aktualisieren oder Entfernen eines WCF-Datendienstverweises](how-to-add-update-or-remove-a-wcf-data-service-reference.md)
