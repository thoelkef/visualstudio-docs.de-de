---
title: Binden von WPF-Steuerelementen an Daten in Visual Studio – Teil 1 | Microsoft-Dokumentation
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- data [WPF], displaying
