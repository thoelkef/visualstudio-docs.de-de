...
-   Führen Sie die [Assistenten zur Datenquellenkonfiguration](../data-tools/media/data-source-configuration-wizard.png) und wählen Sie entweder die **Datenbank** oder **Webdienst** Datenquellentyp.
