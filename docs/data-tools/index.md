...
description: Informationen zu den verschiedenen Tools zum Entwickeln von Datenlösungen in Visual Studio, einschließlich .NET-Tools, SQL Server Data Tools, Azure Data Lake, Azure HDInsight und Azure Stream Analytics.
layout: LandingPage
ms.date: 01/01/2018
author: jillre
ms.author: jillfra
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erfahren Sie mehr über Visual Studio und die .NET-Tool- und API-Unterstützung für die Entwicklung von Datenanwendungen.</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erfahren Sie mehr über die Entwicklung von Big Data-Anwendungen mit U-SQL und .NET unter Verwendung von Azure Data Lake</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erfahren Sie mehr über die Ausführung von Hive-Abfragen mit Hadoop in Azure HDInsight</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erfahren Sie mehr über die Entwicklung großer nahezu in Echtzeit arbeitender Datenlösungen mit Azure Streaming Analytics</h3>
                    </div>
                </div>
            </div>
        </div>
