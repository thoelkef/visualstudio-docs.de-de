...
#### <a name="to-add-columns-to-the-data-table"></a>Die Datentabelle Spalten hinzu  
...
## <a name="setting-the-primary-key-for-the-table"></a>Festlegen den Primärschlüssel für die Tabelle  
