...
-   Schreiben von Code zum Füllen der Datentabellen.  
 ...
 ![Link zu Video](~/docs/data-tools/media/playvideo.gif "PlayVideo") Eine Videoversion dieses Themas finden Sie unter [Video How to: Creating an N\-Tier Data Application](http://go.microsoft.com/fwlink/?LinkId=115188).  
