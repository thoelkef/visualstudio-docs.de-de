...
| Topic | Beschreibung |
| - | - |
| [Vorgehensweise: Ausführen von Datendienstabfragen](/dotnet/framework/data/wcf/how-to-execute-data-service-queries-wcf-data-services) | Zeigt, wie ein Datendienst aus einer .NET-Anwendung abgefragt wird. |
