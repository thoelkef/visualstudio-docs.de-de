---
title: Dialog Feld ' Fehler bei der Übersetzung Microsoft-Dokumentation
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.debug.assertions
...
|Abbrechen|Die Programmausführung anhalten und die Debugsitzung beenden.|
