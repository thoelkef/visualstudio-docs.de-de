---
title: Dialog Feld ' Wert kann nicht geändert werden ' | Microsoft-Dokumentation
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
## <a name="error"></a>Fehler
 `The value of this variable cannot be changed` &#124; `The name` *Namen* `does not exist in the current context` &#124; *verschiedene andere Nachrichten*
