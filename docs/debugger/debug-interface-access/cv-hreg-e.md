...
> [!NOTE]
>  Da die `CV_HREG_e`\-Enumeration zu groß ist, um im vollständig Umfang dupliziert zu werden, wird hier eine gekürzte Version als Referenz bereitgestellt.  Fehlende Angaben werden kursiv dargestellt.  Die vollständige Enumeration ist in der cvconst.h\-Headerdatei verfügbar.  
...
## Elements  
 CV\_REG\_\*  
 Register verwendet von Prozessoren 80x86 und ix86 und PCode.  
  
 CV\_R68\_\*  
 Register, die vom 68K\-Prozessor verwendet werden.  
  
 CV\_M4\_\*  
 Register, die von MIPS 4000\-Prozessoren verwendet werden.  
  
 CV\_ALPHA\_\*  
 Register verwendet digital Equipment Corporation vom Alphaaxp\-Reihenprozessor.  
  
 CV\_PPC\_\*  
 Register verwendet von Prozessor Motorola PowerPC\-Prozessor\/IBM.  
  
 CV\_SH3\_\* und CV\_SH\_\*  
 Register wird von SH\-Reihe Hitachis SH3 und Hitachis Prozessor.  
  
 CV\_ARM\_\*  
 Register, die von ARM\-Prozessoren \(Advanced RISC Machine\) verwendet werden.  
  
 CV\_IA64\_\*  
 Register werden von den Reihenprozessoren Intel IA64.  
  
 CV\_TRI\_\*  
 Register verwendet von Prozessor Infineon Technologiess TriCore.  
  
 CV\_AM33\_\*  
 Register wird von Matsushita\/Panasonic AM33 und verknüpfte Prozessoren.  
  
 CV\_M32R\_\*  
 Register verwendet von Prozessor Mitsubishis M32R.  
  
## Hinweise  
 Jeder Prozessortyp verwendet seinen eigenen eindeutigen Registersatz.  
  
 Die Werte in dieser Enumeration werden an die folgenden Methoden übergeben:  
