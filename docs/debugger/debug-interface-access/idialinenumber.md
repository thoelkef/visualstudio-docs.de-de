...
In der folgenden Tabelle sind die Methoden von `IDiaLineNumber` aufgeführt.
...
Die folgende Funktion zeigt Zeilennummern an, die in einer Funktion (dargestellt durch `pSymbol`) verwendet werden.
