...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "IDiaSymbol::get_indirectVirtualBaseClass-Methode"
...
#### Parameter  
 `pRetVal`  
 \[out\]  Gibt `TRUE` zurück, wenn der benutzerdefinierte Datentyp eine indirekte virtuelle Basisklasse ist. andernfalls gibt `FALSE`zurück.  
