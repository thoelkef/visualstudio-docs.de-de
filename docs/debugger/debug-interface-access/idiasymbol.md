...
> [!NOTE]
> Symbole geben für einige dieser Methoden sinnvolle Daten zurück, abhängig vom Typ des Symbols. Wenn eine Methode `S_OK` zurückgibt, hat diese Methode sinnvolle Daten zurückgegeben.
