---
title: Debuggen von uwp-apps in Visual Studio | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Schnellstart: Debuggen von JavaScript](../debugger/quickstart-debug-javascript-using-the-console.md)|Debuggen von JavaScript mithilfe der Konsole zeigt interaktiv Debuggen eine JavaScript-Apps mithilfe von [JavaScript-Konsolenbefehle](../debugger/javascript-console-commands.md).|  
