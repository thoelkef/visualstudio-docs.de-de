---
title: Debugger-Navigation-Beispielcode (JavaScript) | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Der Code in diesem Thema ist die Beispieldatei für die [Steuern der Ausführung in einer Debugsitzung (JavaScript)](../debugger/control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md) Thema.  
