...
Weitere Informationen zu den Verbesserungen von Visual Studio 2015 Update 3 finden Sie unter [C++-bearbeiten und Fortfahren in Visual Studio 2015 Update 3](https://blogs.msdn.microsoft.com/vcblog/2016/07/01/c-edit-and-continue-in-visual-studio-2015-update-3/).  
  
 Die [/zo (optimiertes Debuggen verbessern)](/cpp/build/reference/zo-enhance-optimized-debugging) (Compileroption), die in Visual Studio 2013 Update 3 eingeführte PDB-Dateien (Symboldateien) zusätzliche Informationen hinzugefügt, für die Kompilierung von Binärdateien ohne die  [ /Od (deaktivieren (Debuggen)) ](http://msdn.microsoft.com/library/aafb762y.aspx) Option.  
...
> [!IMPORTANT]
> Erforderliche Buildeinstellungen und andere Informationen zum Funktionskompatibilität, finden Sie unter [C++-bearbeiten und Fortfahren in Visual Studio 2015 Update 3] (https://blogs.msdn.microsoft.com/vcblog/2016/07/01/c-edit-and-continue-in-visual-studio-2015-update-3/.
...
3.  In der **Optionen** wählen Sie im Dialogfeld **Debuggen > Allgemein**.

4.  Aktivieren Sie **bearbeiten und Fortfahren aktivieren**. Deaktivieren Sie das Kontrollkästchen, um zu deaktivieren.
...
5.  Aktivieren bzw. deaktivieren Sie in der Gruppe **Bearbeiten und Fortfahren** das Kontrollkästchen **Bearbeiten und Fortfahren aktivieren** .  
 ...
 Eine Änderung dieser Einstellung betrifft alle Projekte, an denen Sie arbeiten. Sie müssen die Anwendung nicht neu erstellen, nachdem Sie die Einstellung geändert haben. Wenn Sie die Anwendung über die Befehlszeile oder mit einem Makefile erstellen, aber Sie in Visual Studio-Umgebung debuggen, noch können bearbeiten und fortfahren, wenn Sie festlegen, die **/Zi** Option.  
...
##  <a name="BKMK_How_to_apply_code_changes_explicitly"></a> Gewusst wie: Explizites Übernehmen von Codeänderungen  
 ...
 Wenn Sie codeänderungen explizit übernehmen, bleibt sich das Programm im Unterbrechungsmodus - nicht ausgeführt.  
