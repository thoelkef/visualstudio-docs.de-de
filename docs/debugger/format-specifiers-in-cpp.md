...
>   
>  -   [Formatbezeichner](#BKMK_Visual_Studio_2012_format_specifiers) werden die Formatbezeichner im neuen Debugmodul beschrieben.  
> -   [Formatbezeichner für das Interop-Debuggen mit C++/CLI](#BKMK_Format_specifiers_for_interop_debugging_and_C___edit_and_continue) werden die Formatbezeichner im älteren Debugmodul beschrieben.  
...
|s8|UTF-8-Zeichenfolge|\<Speicherort > "This is ein UTF-8 Tasse Kaffee Â˜•"|"This is ein UTF-8 Tasse Kaffee ☕"|
