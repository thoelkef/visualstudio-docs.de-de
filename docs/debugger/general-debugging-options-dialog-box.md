...
**Verwenden Sie die Vorgängerversion C# und VB-ausdrucksauswertungen**: der Debugger verwendet Visual Studio 2013 C#/VB-ausdrucksauswertungen anstelle der Visual Studio 2015 Roslyn-basierten ausdrucksauswertungen.    
