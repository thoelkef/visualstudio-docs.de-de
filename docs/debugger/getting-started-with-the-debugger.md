...
|         |         |
|---------|---------|
| ![Video ansehen](../install/media/video-icon.png "WatchVideo") | [In diesem Video](#video) Debuggen, die ähnliche Schritte anzeigt. |
...
## <a name="video"></a>Sehen Sie sich ein Video zum Debuggen
