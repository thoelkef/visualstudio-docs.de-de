---
title: 16bpp-Renderzielformat-Variante zu rendern | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
...
## <a name="example"></a>Beispiel  
 Die **16bpp-Renderzielformat** Variante für mit erstellte Renderziele reproduziert werden kann `CreateTexture2D` mithilfe von Code wie folgt:  
