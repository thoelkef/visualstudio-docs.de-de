...
>[!IMPORTANT]
>Sie können Erstellen von Code maps nur in [Visual Studio Enterprise-Edition](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017).
...
1. In einem Visual Studio Enterprise C#, Visual Basic, C++, JavaScript oder X++ Projekt, das Debuggen starten, indem Sie die Auswahl **Debuggen** > **Debuggen starten** oder durch Drücken **F5**.
