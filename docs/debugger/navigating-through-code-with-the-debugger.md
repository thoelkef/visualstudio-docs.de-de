---
title: Navigieren im Code, den Debugger in Visual Studio | Microsoft-Dokumentation
...
ms.locfileid: "49933767"
---
# <a name="navigate-code-with-the-visual-studio-debugger"></a>Navigieren Sie im Code mit Visual Studio-Debugger
Mit Befehlen und Tastenkombinationen zum Navigieren im Code im Debugger vertraut machen und veranlasst, die sie schneller und einfacher zu finden und beheben Sie Probleme in Ihrer app. Während Sie Code im Debugger navigieren, können Sie untersuchen Sie den Status Ihrer App oder erfahren Sie mehr über die Ausführungsablauf.  
...
-   **Ausführung bis Klick** 
    ...
    Um zu einem Zeitpunkt in Ihrem Code während der Unterbrechung im Debugger auszuführen, wählen die **Ausführung bis hier ausführen** grüner Pfeil (Sie finden das Symbol beim Zeigen auf eine einzige Zeile Code). Dadurch werden temporäre Haltepunkte festgelegt werden muss.
...
## <a name="BKMK_Restrict_stepping_to_Just_My_Code"></a>Nicht-benutzerseitiger Code in Einzelschritten ausführen  
