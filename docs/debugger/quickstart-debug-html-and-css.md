---
title: "Schnellstart: Debuggen von HTML und CSS | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  - "Debuggen, CSS"
  - "Debuggen, HTML"
  - "Debuggen, JavaScript [Windows Store-Apps]"
...
-   [Debuggen eines WebView\-Steuerelements](../debugger/debug-a-webview-control.md)  
 ...
 Informationen zu anderen JavaScript\-Debugfunktionen, wie z. B. zur Verwendung des JavaScript\-Konsolenfensters und zum Festlegen von Haltepunkten finden Sie unter [Schnellstart: Debuggen von JavaScript](../debugger/quickstart-debug-javascript-using-the-console.md) und [Debuggen von Apps in Visual Studio](../debugger/debug-store-apps-in-visual-studio.md).  
...
6.  Ersetzen Sie den Code in "default.js" durch folgenden Code:  
    ...
    ```  
     ...
     ![FlipView&#45;App mit erwarteten Ergebnissen](~/docs/debugger/media/js_dom_appfixed.png "JS\_DOM\_AppFixed")  
...
13. Öffnen Sie die CSS\-Regel für die Höhe. Beachten Sie, dass es eine Inlineformatvorlage gibt, die auf 100px festgelegt ist. Dies ist inkonsistent mit dem für die CSS\-Auswahl festgelegten `#fView` Höhenwert von 100 %. Da die `#fView`\-Auswahl durchgestrichenen Text enthält, hat die Inlineformatvorlage Vorrang vor diesem Format.  
     ...
     ![Registerkarte "Berechnet" des DOM Explorer](../debugger/media/js_dom_explorer_computed.png "JS\_DOM\_Explorer\_Computed")  
...
20. Wechseln Sie zur weiteren Untersuchung zu Visual Studio und wählen Sie die Registerkarte **Layout** aus, um einen Überblick über das Feldmodell des Elements zu erhalten.  
    ...
    -   Für den Windows Phone\-Emulator: 100 px \(Offset\) und 100 px \(Rand\).  
     ...
     ![Registerkarte "Layout" des DOM Explorer](../debugger/media/js_dom_explorer_layout.png "JS\_DOM\_Explorer\_Layout")  
...
3.  Klicken Sie auf der Debug\-Symbolleiste auf die Schaltfläche **Windows\-App aktualisieren** \(oder drücken Sie F4\). Die Schaltfläche sieht wie folgt aus: ![Schaltfläche "Windows&#45;App aktualisieren"](~/docs/debugger/media/js_refresh.png "JS\_Refresh").  
...
##  <a name="SelectingElements"></a> Auswählen von Elementen  
...
-   Mit dem `select`\-Befehl, der zu den [JavaScript\-Konsolenbefehle](../debugger/javascript-console-commands.md) gehört  
 ...
 ![Schaltfläche "Element auswählen" im DOM Explorer](../debugger/media/js_dom_select_element_button.png "JS\_DOM\_Select\_Element\_Button")  
 ...
 ![Webseitenanzeige mit hervorgehobener Schaltfläche](~/docs/debugger/media/js_dom_display_highlights_button.png "JS\_DOM\_Display\_Highlights\_Button")  
...
>  Im Windows Phone\-Emulator wird das Hervorheben von Elementen durch Zeigen mit dem Mauszeiger nur teilweise unterstützt.  
 ...
 Ein Beispiel für die Auswahl von Elementen mithilfe der Schaltfläche **Element auswählen** finden Sie unter [Debuggen von CSS\-Stilen mithilfe von DOM Explorer](../debugger/debug-css-styles-using-dom-explorer.md).  
...
-   [!INCLUDE[win8_appname_long](../debugger/includes/win8_appname_long_md.md)] und Windows Phone Store\-Apps mit JavaScript und HTML  
