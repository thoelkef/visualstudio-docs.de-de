...
---
# <a name="using-saved-intellitrace-data-c-visual-basic-c"></a>Verwenden gespeicherter IntelliTrace-C#Daten (, C++Visual Basic,)
...
- Eine ITRACE-Datei aus einer der folgenden Quellen:
    ...
    |**Source**|**Weitere Informationen finden Sie unter**|
    |----------------|-------------|
...
## <a name="Understand"></a> Verstehen des IntelliTrace-Protokolls
 Einige der folgenden Abschnitte in der itrace-Datei werden nur angezeigt, wenn Sie Daten aus einer bestimmten Quelle, z. b. von SharePoint-Anwendungen, gesammelt haben.

|**Bereich**|**Enthält**|**Sammelquelle**|
|-----------------|------------------|---------------------------|
|[Leistungsverletzungen](#Performance)|Leistungsereignisse mit Funktionsaufrufen, die den konfigurierten Schwellenwert überschreiten|Microsoft Monitoring Agent, entweder eigenständiger Collector oder mit System Center 2012 R2 Operations Manager für ASP.net-Web-Apps, die unter IIS gehostet werden.|
|[Ausnahmedaten](#ExceptionData)|Ausnahmen, einschließlich der vollständigen Aufrufliste für jede Ausnahme|Alle Quellen|
|[Analyse](#Analysis)|Nur für SharePoint 2010- und SharePoint 2013-Anwendungen. Diagnostizieren Sie IntelliTrace- und SharePoint-Ereignisse, wie z. B. Debugger-Ereignisse, ULS-Ereignisse, Ausnahmefehler und andere Daten, die der Microsoft Monitoring Agent aufgezeichnet hat.|Microsoft Monitoring Agent, entweder eigenständiger Collector oder mit System Center 2012 R2 Operations Manager|
...
|[Webanforderung](#Modules)|Webanforderungs Daten für Produktions-IIS-Webanwendungen und SharePoint 2010 und SharePoint 2013|Microsoft Monitoring Agent und der eigenständige Collector|
...
3. Wählen Sie **Ausnahme debuggen** aus, um das Debuggen an dem Punkt zu starten, an dem die Ausnahme aufgetreten ist.
    ...
    ![Nicht behandelte Ausnahmen &#45; im IntelliTrace-Protokoll](../debugger/media/sharepointunhandledexceptions_intellitrace.png "SharePointUnhandledExceptions_IntelliTrace")

   Eine exemplarische Vorgehensweise finden Sie unter Exemplarische Vorgehensweise [: Debuggen einer SharePoint-Anwendung mithilfe von IntelliTrace](../sharepoint/walkthrough-debugging-a-sharepoint-application-by-using-intellitrace.md). Informationen zu den Arten von Daten, die vom-Agent aufgezeichnet werden, finden Sie unter [IntelliTrace-Funktionen](../debugger/intellitrace-features.md).
...
#### <a name="guidance"></a>Empfehlungen
 [Testing for Continuous Delivery with Visual Studio 2012 - Chapter 6: A Testing Toolbox (Tests für fortlaufende Übermittlung mit Visual Studio 2012 – Kapitel 6: Eine Toolbox für Tests)](/previous-versions/msp-n-p/jj159337(v=pandp.10))
