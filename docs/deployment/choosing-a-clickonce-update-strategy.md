...
- [How ClickOnce performs application updates (Ausführen von Anwendungsupdates durch ClickOnce)](../deployment/how-clickonce-performs-application-updates.md)
