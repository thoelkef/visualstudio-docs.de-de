...
helpviewer_keywords: 
  - "PFX-Dateien"
  - "ClickOnce-Bereitstellung, Authenticode"
  - "Authenticode, ClickOnce"
  - "ClickOnce-Bereitstellung, Zertifikate"
...
-   Sie generieren Ihr eigenes Zertifikat mit MakeCert.exe, das im [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)] enthalten ist.  
...
### Wie die Verwendung von Zertifizierungsstellen Benutzern hilft  
 ...
 Weitere Informationen zum Generieren von selbst signierten Zertifikaten finden Sie unter [Makecert.exe \(Certificate Creation Tool\)](../Topic/Makecert.exe%20\(Certificate%20Creation%20Tool\).md).  
...
### Timestamps  
 ...
 Um einen Zeitstempel in einen Anwendungsserver einzuschließen, muss ein Timestampserver verfügbar sein. Weitere Informationen zum Auswählen eines Timestampservers finden Sie unter [Gewusst wie: Signieren von Anwendungs\- und Bereitstellungsmanifesten](../ide/how-to-sign-application-and-deployment-manifests.md).  
