...
Die folgende Tabelle beschreibt verschiedene Bereitstellungsszenarien und enthält Links zu weiteren Informationen für jedes Szenario.  

Eine Erläuterung der Optionen aus, um ein praktisches Beispiel Setup für eine Windows-app erstellen, finden Sie unter [universelle Windows-Plattform (UWP) Brücke Desktop](/windows/uwp/porting/desktop-to-uwp-root#convert).
...
| **Bereitstellen einer LightSwitch-Anwendung oder Dienst:** LightSwitch wird nicht mehr in Visual Studio 2017 unterstützt, können jedoch weiterhin bereitgestellt werden von Visual Studio 2015 und früher. | [Bereitstellen von LightSwitch-Anwendungen](http://msdn.microsoft.com/Library/4818d933-295c-4ecc-9148-7ad9ca28dcdb) |  
