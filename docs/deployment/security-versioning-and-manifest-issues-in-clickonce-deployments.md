...
Dieser Fehler kann auftreten, nur, wenn Sie bearbeiten die [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] Manifeste manuell; Sie sollten diesen Fehler nicht auftreten, wenn Sie die Bereitstellung mithilfe von Visual Studio generieren.
