---
title: "Exemplarische Vorgehensweise: Bedarfsgerechtes Herunterladen von Assemblys mit der API f&#252;r die ClickOnce-Bereitstellung unter Verwendung des Designers | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "Assemblys, Downloaden [ClickOnce]"
  - "Windows-Anwendungen, ClickOnce-Bereitstellungen"
  - "ClickOnce-Bereitstellung, Bedarfsabhängiges Herunterladen"
  - "Bedarfsabhängige Assemblys, ClickOnce"
...
5.  Fahren Sie nun mit der Veröffentlichung Ihrer Anwendung, wie in [How to: Publish a ClickOnce Application using the Publish Wizard](../deployment/how-to-publish-a-clickonce-application-using-the-publish-wizard.md) beschrieben, fort.  
...
1.  Erstellen Sie Ihre [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)]\-Manifeste, wie unter [Walkthrough: Manually Deploying a ClickOnce Application](../deployment/walkthrough-manually-deploying-a-clickonce-application.md) beschrieben.  
