...
|||
|-|-|
|![Suchfeld für Ressourcen](../designers/media/b1_1.png)|**Suchfeld** Verwenden Sie das Feld **Suchen** zum Filtern der Liste der Objekte.|
...
|![Hexadezimalen Farbwert](../designers/media/b1_15.png)|**Farbtonwert** Zeigt den hexadezimalen Wert der angezeigten Farbe an.|
