...
## Arbeiten mit der Bildbearbeitung  
...
### Arbeiten mit MIP\-Ebenen  
 Einige Bildformate, z. B. DirectDraw Surface \(.dds\), unterstützen MIP\-Ebenen für die Detailebene Texturraum.  Informationen zum Generieren von und Arbeiten mit MIP\-Ebenen finden Sie unter [Gewusst wie: Erstellen und Ändern von MIP\-Ebenen](../designers/how-to-create-and-modify-mip-levels.md)  
...
|------------|-------------------------|  
|In den **Auswahl**\-Modus umschalten|S|  
|In den **Zoom**\-Modus umschalten|Z|  
|In den **Schwenk**\-Modus umschalten|K|  
