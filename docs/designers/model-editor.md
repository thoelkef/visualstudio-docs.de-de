...
### <a name="create-and-import-3d-objects"></a>Erstellen und Importieren von 3D-Objekten
...
Klicken Sie auf der Symbolleiste **Model Editor** (Modell-Editor) auf **Erweitert**, **Szenenverwaltung**, **Importieren**, und geben Sie dann die Datei an, die Sie importieren möchten, um ein 3D-Objekt aus einer Datei zu importieren.
...
### <a name="modify-objects"></a>Ändern von Objekten
