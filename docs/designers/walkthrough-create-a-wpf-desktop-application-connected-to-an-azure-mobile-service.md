---
title: "Exemplarische Vorgehensweise: Erstellen einer WPF-Desktopanwendung, die mit einem Azure Mobile Service verbunden ist | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
manager: "ghogen"
---
# Exemplarische Vorgehensweise: Erstellen einer WPF-Desktopanwendung, die mit einem Azure Mobile Service verbunden ist
...
## Erstellen eines neuen Projekts und Hinzufügen von Verweisen  
...
4.  Geben Sie im Textfeld **Name**`WPFQuickStart` ein, und wählen Sie dann die Schaltfläche **OK** aus.  
...
#### So fügen Sie dem Windows Azure Mobile Services SDK einen Verweis hinzu  
  
1.  Öffnen Sie im **Projektmappen\-Explorer** das Kontextmenü für den Knoten **Verweise**, und wählen Sie **NuGet\-Pakete verwalten** aus.  
  
2.  Wählen Sie im **NuGet\-Paket\-Manager** das Feld **Suche** aus, und geben Sie `mobileservices` ein.  
...
2.  Geben Sie dem Ordner den Namen `Custom`.  
  
3.  Öffnen Sie das Kontextmenü des Ordners **Common**, und wählen Sie **Hinzufügen**, **Benutzersteuerelement** aus.  
  
4.  Wählen Sie im Dialogfeld **Neues Element hinzufügen** das Feld "Name" aus, und geben Sie `QuickStartTask` ein. Wählen Sie dann die Schaltfläche **Hinzufügen** aus.  
...
#### So erstellen und ändern Sie das Hauptfenster  
...
3.  Erweitern Sie im Fenster **Eigenschaften** den Kategorieknoten **Common**, und wählen Sie die Eigenschaft **Title** aus. Geben Sie dann `WPF Todo List` ein, und drücken Sie die **EINGABETASTE**.  
...
4.  Legen Sie im XAML\-Fenster den Wert des Elements **Height** auf `768` fest, und legen Sie den Wert der Eigenschaft **Width** auf `1280` fest.  
...
## Erstellen eines mobilen Services in Azure  
...
#### So erstellen Sie einen mobilen Service  
...
2.  Wählen Sie die Schaltfläche **NEU** aus, und wählen Sie im Popupdialogfenster nacheinander **COMPUTE**, **MOBILER SERVICE, ERSTELLEN** aus.  
...
2.  Geben Sie im Fenster **Neue Tabelle erstellen** im Textfeld **TABELLENNAME**`TodoItem` ein, und wählen Sie dann die Schaltfläche **Abgeschlossen** \(Häkchen\) aus.  
  
     Warten Sie, bis die Tabelle erstellt ist, und fahren Sie dann mit der letzten Vorgehensweise fort.  
  
#### So fügen Sie eine Deklaration für den mobilen Service hinzu  
...
3.  Fügen Sie folgende Deklaration der Klasse hinzu. Dadurch wird *YOUR\-SERVICE\_HERE* durch den Namen der URL für Ihren Service und *YOUR\-KEY\-HERE* durch den Anwendungsschlüssel ersetzt, den Sie in der vorherigen Vorgehensweise kopiert haben:  
...
2.  Geben Sie im Feld **TodoItem einfügen**`Do something` ein, und wählen Sie dann die Schaltfläche **Speichern** aus.  
  
3.  Geben Sie `Do something else` ein, und wählen Sie erneut die Schaltfläche **Speichern** aus.  
...
## Nächste Schritte  
 ...
 Sie können eine Benutzeroberfläche viel ansprechender gestalten, indem Sie dieser Farben, Formen, Grafiken und Animationen hinzufügen. Siehe [Designing XAML in Visual Studio and Blend for Visual Studio](../designers/designing-xaml-in-visual-studio.md).  
