---
title: "Arbeiten mit Texturen und Bildern | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
> [!NOTE]
>  Die Bildverarbeitung unterstützt keine Bilder mit geringer Farbtiefe, wie Symbole oder Cursor. Zum Erstellen oder Ändern dieses Typs Bilder können Sie den [Image Editor for Icons](/visual-cpp/windows/image-editor-for-icons) verwenden.  
...
|Titel|Beschreibung|  
|-----------|------------------|  
|[Grafik\-Editor](../designers/image-editor.md)|Beschreibt die Verwendung der Bildbearbeitung für die Arbeit mit Texturen und Bildern.|  
