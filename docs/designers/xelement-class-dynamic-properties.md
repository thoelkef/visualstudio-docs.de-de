---
title: "Dynamische Eigenschaften der &#39;XElement&#39;-Klasse | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
In diesem Abschnitt werden die dynamischen Eigenschaften der <xref:System.Xml.Linq.XElemen?displayProperty=fullName>[t](assetId:///t?qualifyHint=False&autoUpgrade=True)\-Klasse beschrieben.  
...
|[Elements](../designers/elements-xelement-dynamic-property.md)|Sucht nach einem Indexer, der zum Abrufen der untergeordneten Elemente des aktuellen Elements verwendet wird, die einem angegebenen erweiterten Namen entsprechen.|  
