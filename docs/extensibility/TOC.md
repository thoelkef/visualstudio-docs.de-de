...
# [Erstellen die erste Erweiterung: Hello World](extensibility-hello-world.md)
# [Neuigkeiten im Visual Studio 2017 SDK](what-s-new-in-the-visual-studio-2017-sdk.md)
## [Wichtige Änderungen bei der Erweiterbarkeit](breaking-changes-2017.md)
## [NGen-Unterstützung in VSIX v3](ngen-support.md)
## [Installieren außerhalb des Ordners für Erweiterungen](set-install-root.md)
## [Migrieren der Debugger-COM-Registrierung](migrate-debugger-com-registration.md)
## [Lightweight-Ladevorgang für Projektmappen](lightweight-solution-load-extension-impact.md)
## [Häufig gestellte Fragen](faq-2017.md)
# [Gewusst wie: Migrieren von Erweiterungsprojekten zu Visual Studio 2017](how-to-migrate-extensibility-projects-to-visual-studio-2017.md)
# [Vorgehensweise: Roundtrip-Erweiterungen für Visual Studio](how-to-roundtrip-VSIXs.md)
...
## [Aktualisieren von benutzerdefinierten Projekt- und Elementvorlagen für Visual Studio 2017](upgrading-custom-project-and-item-templates-for-visual-studio-2017.md)
...
## [Schemareferenz zum Visual Studio-Vorlagenmanifest](visual-studio-template-manifest-schema-reference.md)
...
# [Richtlinien zur Benutzerfreundlichkeit in Visual Studio](ux-guidelines/TOC.md)
...
## [Gewusst wie: Verwalten von mehreren Threads in verwaltetem Code](managing-multiple-threads-in-managed-code.md)
...
#### [VSIXLanguagePack-Element (Schema für das VSIX-Sprachpaket)](vsixlanguagepack-element-vsix-language-pack-schema.md)
##### [LocalizedName-Element (Schema für das VSIX-Sprachpaket)](localizedname-element-vsix-language-pack-schema.md)
##### [LocalizedDescription-Element (Schema für das VSIX-Sprachpaket)](localizeddescription-element-vsix-language-pack-schema.md)
##### [MoreInfoURL-Element (Schema für das VSIX-Sprachpaket)](moreinfourl-element-vsix-language-pack-schema.md)
##### [License-Element (Schema für das VSIX-Sprachpaket)](license-element-vsix-language-pack-schema.md)
## [Gewusst wie: Aktualisieren einer Visual Studio-Erweiterung](how-to-update-a-visual-studio-extension.md)
...
# [Im Visual Studio SDK](internals/TOC.md)
...
### [Bedingte Attribute des VSCT-XML-Schemas](vsct-xml-schema-conditional-attributes.md)
## [GUIDs und Konstanten im Visual Studio SDK](guids-and-constants-in-the-visual-studio-sdk.md)
...
#### [Befehlscodeenumerator](command-code-enumerator.md)
#### [Meldungsenumerator](message-enumerator.md)
#### [Dateistatuscode-Enumerator](file-status-code-enumerator.md)
#### [Verzeichnisstatuscode-Enumerator](directory-status-code-enumerator.md)
...
### [Glossar für das Quellcodeverwaltungs-Plug-In](source-control-plug-in-glossary.md)
...
## [Befehlszeilenschalter (Visual Studio SDK)](command-line-switches-visual-studio-sdk.md)
...
## [Glossar für das Visual Studio SDK](visual-studio-sdk-glossary.md)
...
## [Roslyn-Analyzer und codeabhängige Bibliothek für ImmutableArrays](roslyn-analyzers-and-code-aware-library-for-immutablearrays.md)
