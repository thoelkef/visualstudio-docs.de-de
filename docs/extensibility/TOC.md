...
# [Erstellen der ersten Erweiterung: Hello World](extensibility-hello-world.md)
...
# [Gewusst wie: Roundtrip-Erweiterungen für Visual Studio](how-to-roundtrip-VSIXs.md)
# [Sprachserverprotokoll](language-server-protocol.md)
##[Hinzufügen einer Erweiterung für das Sprachserverprotokoll](adding-an-lsp-extension.md)
#[Ordner öffnen](open-folder.md)
##[Arbeitsbereiche](workspaces.md)
##[Dateikontexte](workspace-file-contexts.md)
##[Indizieren](workspace-indexing.md)
##[Sprachdienste](workspace-language-services.md)
##[Erstellen](workspace-build.md)
...
### [Unterstützung von EditorConfig](supporting-editorconfig.md)
...
### [Schemareferenz für das VSIX-Sprachpaket 2.0](vsix-language-pack-schema-2-0-reference.md)
...
## [Finden von Visual Studio](locating-visual-studio.md)
