---
title: AsyncVoidMethodBuilder.m_objectIdForDebugger Feld | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Stellt die verzögert initialisierte Objekt, das vom Debugger verwendet wird, um die Identifizierung von diesem Generator dar.  
