...
#### Parameter  
 `ppPendingBP`  
 \[out\]  Gibt das [IDebugPendingBreakpoint2](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md)\-Objekt zurück, das den anstehenden Haltepunkt darstellt, der gebunden wird.  
