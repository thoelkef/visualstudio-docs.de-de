...
Ruft die ausstehenden Haltepunkt, der gebunden wird.  
...
#### <a name="parameters"></a>Parameter  
 `ppPendingBP`  
 [out] Gibt die [IDebugPendingBreakpoint2](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md) -Objekt, das die ausstehenden Haltepunkt gebunden wird.  
