...
Ruft die Klassen mit dem angegebenen Attribut an, die in der angegebenen Programmiersprache implementiert werden.  
...
#### <a name="parameters"></a>Parameter  
 ...
 `ppEnum`  
 [out] Gibt eine Enumeration von Attributklassen zurück.  
