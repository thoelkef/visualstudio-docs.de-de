...
Gibt den Namen zurück, der dem angegebenen Scheinangegebenen das Metadatenobjekt zugeordnet ist.  
...
#### Parameter  
 ...
 `dwToken`  
 \[in\]  Benannt werden Token.  
  
 `pbstrName`  
 \[out\]  Nennen Sie das das Token entspricht.  
