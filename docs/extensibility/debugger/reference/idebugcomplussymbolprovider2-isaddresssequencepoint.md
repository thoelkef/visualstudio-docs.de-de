...
Bestimmt, ob die angegebene Adresse Debuggen eines Sequenzpunkts verwendet wird.  
...
## Rückgabewert  
 Wenn die die Adresse eines Sequenzpunkts verwendet wird, gibt `S_OK`zurück. andernfalls gibt `S_FALSE`zurück.  
