...
## <a name="remarks"></a>Hinweise  
 Rufen Sie für einen benutzerfreundlichen Servernamen die [GetServerFriendlyName](../../../extensibility/debugger/reference/idebugcoreserver3-getserverfriendlyname.md) Methode.  
