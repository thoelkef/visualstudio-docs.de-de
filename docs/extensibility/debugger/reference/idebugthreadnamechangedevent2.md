...
Diese Schnittstelle wird vom Debugmodul (DE) an den Sitzungsdebug-Manager (SDM) gesendet, wenn sich ein Threadname im zu debuggenden Programm ändert.
