---
title: IEnumDebugAddresses::Weiter | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Array von [IDebugAddress-Elementen,](../../../extensibility/debugger/reference/idebugaddress.md) die ausgefüllt werden sollen.
