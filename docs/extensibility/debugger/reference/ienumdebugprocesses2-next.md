---
title: IEnumDebugProzesse2::Weiter | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Array von [IDebugProcess2-Elementen,](../../../extensibility/debugger/reference/idebugprocess2.md) die ausgefüllt werden sollen.
