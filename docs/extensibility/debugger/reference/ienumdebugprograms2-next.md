---
title: IEnumDebugPrograms2::Weiter | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Array von [IDebugProgram2-Elementen,](../../../extensibility/debugger/reference/idebugprogram2.md) die ausgefüllt werden sollen.
