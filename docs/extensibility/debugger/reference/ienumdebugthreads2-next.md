---
title: IEnumDebugThreads2::Weiter | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Array von [IDebugThread2-Elementen,](../../../extensibility/debugger/reference/idebugthread2.md) die ausgefüllt werden sollen.
