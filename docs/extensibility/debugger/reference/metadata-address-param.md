...
## <a name="terms"></a>Begriffe
 TokMethod die ID der Methode der Parameter gehört.

 TokParam die ID des Parameters.

 dwIndex der Index des Parameters in einer Liste von Parametern ab.
