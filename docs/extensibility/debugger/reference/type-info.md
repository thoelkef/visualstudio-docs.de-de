...
#### <a name="parameters"></a>Parameter
 DwKind ein Wert aus der [DwTYPE_KIND](../../../extensibility/debugger/reference/dwtype-kind.md) -Enumeration, der bestimmt, wie die Union zu interpretieren.
 ...
 nicht verwendete Type.Unused-Abstand.

 Geben Sie die Namen der Union.
