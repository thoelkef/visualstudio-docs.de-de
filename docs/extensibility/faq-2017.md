...
Weitere Informationen finden Sie in [Gewusst wie: Migrieren von Erweiterungsprojekte Visual Studio 2017 RC](how-to-migrate-extensibility-projects-to-visual-studio-2017.md). Es gibt außerdem ein hervorragenden Blogbeitrag, [ändert sich in Visual Studio-Setup](https://blogs.msdn.microsoft.com/heaths/2016/09/15/changes-to-visual-studio-15-setup).
