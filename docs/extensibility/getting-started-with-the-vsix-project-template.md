...
1. -Ordner befinden sich in der *{Visual Studio-Installationspfad} \Common7\IDE\ProjectTemplates* und <em>{Visual Studio-Installationspfad} \Common7\IDE\ItemTemplates} Verzeichnisse. Die Namen der oberen Ebene Abschnitte in der **neues Projekt</em>*  Dialogfeld stimmen die Namen der Vorlagenordner nicht genau überein. Wenn Unterschiede festgestellt werden, verwenden Sie den Namen des Vorlagenordners.  
