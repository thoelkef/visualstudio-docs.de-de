...
![VSSDK-Buildtools](~/extensibility/media/vssdk-build-tools.png)
...
* Wählen Sie **Voraussetzungen** Registerkarte, und drücken Sie **neu** Schaltfläche.
  ...
  ![VSIX-manifest-designer](~/extensibility/media/vsix-manifest-designer.png)

* Die **Hinzufügen neuer erforderliche** Fenster wird geöffnet.

  ![Fügen Sie die VSIX-Voraussetzung](~/extensibility/media/add-vsix-prerequisite.png)
...
* Aktualisieren Sie die Version aus, falls erforderlich.
  ...
  ![Roslyn erforderliche Komponente hinzufügen](~/extensibility/media/add-roslyn-prerequisite.png)
...
![Externes Programm starten](~/extensibility/media/start-external-program.png)
...
![VSIX-Installationsprogramm auf Visual Studio 2017](~/extensibility/media/vsixinstaller-vs-2017.png)
...
![Visual Studio ausgeführte Prozesse](~/extensibility/media/vs-running-processes.png)
...
![Vsixinstaller Voraussetzung nicht erfüllt.](~/extensibility/media/vsixinstaller-missing-prerequisite.png)
