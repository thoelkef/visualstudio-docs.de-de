...
1. Erstellen Sie ein VSIX-Projekt (**Datei**  > **Neues**  > **Projekt**  > **Visual C#**   > **extensiblity** 0**VSIX-Projekt**). Nennen Sie das Projekt **testasync**.
...
## <a name="add-a-service"></a>Dienst hinzufügen
