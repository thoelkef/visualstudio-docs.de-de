---
layout: LandingPage
title: Visual Studio-Erweiterbarkeit
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erweiterbarkeit der .NET-Compilerplattform (&quot;Roslyn&quot;)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen eines Software Development Kits</h3>
                    </div>
                </div>
            </div>
        </div>
