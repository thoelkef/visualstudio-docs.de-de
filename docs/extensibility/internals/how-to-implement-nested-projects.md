...
5.  Ruft die IDE die <xref:Microsoft.VisualStudio.Shell.Interop.IVsParentProject.OpenChildren> -Methode für jedes Projekt untergeordnetes Element des übergeordneten Projekts.
