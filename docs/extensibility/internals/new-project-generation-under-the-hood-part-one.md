...
## Das Dialogfeld Neues Projekt  
 ...
 ![Dialogfeld "Neues Projekt"](~/docs/extensibility/internals/media/newproject.gif "NewProject")  
...
#### Projekt Typ untergeordnete Knoten und .vstdir\-Dateien  
 ...
 ![Projekttypen](~/docs/extensibility/internals/media/projecttypes.png "ProjectTypes")  
  
 Der entsprechende ProjectTemplates Ordner sieht folgendermaßen aus:  
  
 ![Projektvorlagen](~/docs/extensibility/internals/media/projecttemplates.png "ProjectTemplates")  
