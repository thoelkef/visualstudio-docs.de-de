...
---
# Neue Projektgenerierung: Hinter den Kulissen Teil 2
...
### <a name="designers-and-references"></a>Designer und Verweise  
 ...
 Hier wird das \< ItemGroup> aus Simple.csproj, die die Projektverweisen erstellt:  
...
## <a name="see-also"></a>Siehe auch  
 [Neue Projektgenerierung: Hinter den Kulissen Teil 1](../../extensibility/internals/new-project-generation-under-the-hood-part-one.md)  
