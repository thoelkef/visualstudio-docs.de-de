...
ms.topic: "article"
helpviewer_keywords: 
  - "Erfassung Source Control-Pakete"
  - "Steuerelement Quellpakete, Registrierung"
...
manager: "ghogen"
---
# Registrierung und Auswahl (Source Control VSPackage)
...
|`HKEY_LOCAL_MACHINE\   SOFTWARE\     Microsoft\       VisualStudio\         X.Y\           SourceControlProviders\             {ID_SccProvider}\`|(Standard) = Rg_sz: \< Name des Pakets><br /><br /> Dienst = Rg_sz: {SID_SccPkgService}|  
|`HKEY_LOCAL_MACHINE\   SOFTWARE\     Microsoft\       VisualStudio\         X.Y\           SourceControlProviders\             {ID_SccProvider}\               Name\`|(Standard) = Rg_sz: #\< Ressourcen-ID für den lokalisierten Namen><br /><br /> Paket = Rg_sz: {ID_Package}|  
