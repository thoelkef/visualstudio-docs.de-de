---
title: LocationFieldMRUPrefix-Element (Visual Studio-Vorlagen) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-general
...
Gibt die zuletzt verwendeten (MRU) Pfade in der **neues Projekt** und **neues Element hinzufügen** (Dialogfeld).  
...
## <a name="remarks"></a>Hinweise  
 Dieses Element sollte nur über Vorlagen verwendet werden die [!INCLUDE[vsipprvsip](../extensibility/includes/vsipprvsip_md.md)].  
