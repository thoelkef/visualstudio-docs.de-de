...
|VsDbgCmdUsed.vsct|Befehlstabelle für den Debugger.|  
 ...
 Weitere Informationen finden Sie unter [XML-Befehl-Tabelle entwerfen (. VSCT)-Dateien](../extensibility/internals/designing-xml-command-table-dot-vsct-files.md) und [VSCT-XML-Schemareferenz](../extensibility/vsct-xml-schema-reference.md).  
