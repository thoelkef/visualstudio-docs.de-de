---
title: Paket-GUIDs der Visual Studio-Funktionen | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Die folgenden GUIDs können in der Datei .pkgundef der isolierte Shell-Anwendung Sie bestimmte Pakete aus der Anwendung ausgeschlossen.  
  
## <a name="package-guids"></a>Paket-GUIDs  
  
|Funktionsbereich|Unformatierte Paketname|Paket-GUID|  
|------------------|----------------------|------------------|  
|Core-IDE|Rückgängig: Paket|{1D76B2E0-F11B-11D2-AFC3-00105A9991EF}|  
||Visual Studio-Umgebung-Paket|{DA9FB551-C724-11d0-AE1F-00A0C90FFFC3}|  
||Visual Studio-Befehle Definition-Paket|{44E07B02-29A5-11D3-B882-00C04F79F802}|  
...
||Visual Studio-Projektmappe Build-Paket|{282BD676-8B5B-11D0-8A34-00A0C91E2ACD}|  
...
|Hilfe|Visual Studio Help Package|{4A791146-19E4-11D3-B86B-00C04F79F802}|  
|Aufgabenliste, Fehlerliste|ErrorListPackage|{4A9B7E50-AA16-11D0-A8C5-00A0C921A4D2}|  
|Gliederung der Klasse|Class Outline Package|{21AF45B0-FFA5 -&11;D&0;-G63F-00A0C922E851}|  
|Installer für Werkzeugkasten-Steuerelemente|Toolbox-Steuerelemente Installer-Paket|{2C298B35-07DA-45F1-96A3-BE55D91C8d7A}|  
...
|Webbrowser|Visual Studio Web Browser Package|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||Web Application Project Factory für die Ansicht im Webbrowser-Funktionen|{349C5851-65DF-11DA-9384-00065B846F21}|  
|Binär-Editor|Visual Studio Binary Editor Package|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
...
|Datenbanktools|Visual Database Tools Package|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
||Datenbanktool-Designer für Visual Studio|{EF828E39-70F5-4b8e-A3A0-4C0ECD28A69A}|  
||Daten-Designer für Visual Studio|{D6C919AA-1217-41E2-a13B-9B92E1866305}|  
...
|SourceSafe-Unterstützung|Visual SourceSafe Provider Package|{AA8EB8CD-7A51-11D0-92C3-00A0C9138C45}|  
...
|Codeausschnitte|Visual Studio Code Snippets Package|{0B680757-2C29-4531-80FA-535A5178AA98}|  
|Verwaltete Projekt sprachunterstützung|Enumerator für Visual Studio-Komponente|{588205E0-66e0-11D3-8600-00C04F6123B3}|  
||Visual Studio Settings and Project Designers Package|{67909B06-91E9-4F3E-AB50-495046BE9A9A}|  
|Exportieren Sie Vorlage...|Export Template Package|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 Einige Pakete sollten niemals entfernt werden, da viele andere Features Abhängigkeiten ergreifen. Beispielsweise sollte die aufgelisteten unter "Core-IDE" nie entfernt werden.  
  
 Einige Features werden nicht vollständig entfernt. Beispielsweise ist kein Paket, das nicht registriert werden kann, um entfernen **Klassenansicht** und seine zugehörigen Menüs, Optionen und Dienste. Die **Klassenansicht** Fenster erfolgt über die Visual Studio-Umgebung-Paket, die auch andere wichtige IDE-Features bereitstellt. Entfernen wollten **Klassenansicht**, müsste auch entfernen **suchen und Ersetzen**, der Umgebung **Optionen** Seiten, die **Befehlsfenster**, und die **Ausgabe** Fenster.
