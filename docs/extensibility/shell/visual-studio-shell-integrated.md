...
|Daten|-   **Server-Explorer** (vereinfacht: nur Daten). Siehe Hinweis 1.<br />-   **Datenquellen** Fenster<br />-Sämtliche Datensteuerelemente<br />-XML-Editor<br />-Daten zu binden, um lokale Datenquelle (. MDF-Datei oder. MDB)<br />-Data-Bind Objekt<br />-Daten binden, Webdienst<br />-Daten zu binden, um den lokalen Datenbankserver<br />-Daten zu binden, um remote-Datenbankserver<br />-DDL Tools für die Remotedaten<br />-   **Server-Explorer** Erweiterbarkeit ([!INCLUDE[vsipsdk](../includes/vsipsdk_md.md)] Beispiele)|  
