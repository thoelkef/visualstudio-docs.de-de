...
|Farbmuster|Hex|RGB|  
|------------|---------|---------|  
|![Farbmuster 71 b 252](../../extensibility/ux-guidelines/media/0711_71b252.png "0711_71B252")|# 71 B 252|113,178,82|  
...
#### <a name="disjoint-and-region-selections"></a>Zusammenhanglose und Region  
 ...
 ![Zusammenhanglose und Region Selektoren](../../extensibility/ux-guidelines/media/0713-07_disjointregionselectors.png "0713-07_DisjointRegionSelectors")  
...
|**Sekundäre Auswahl**|In der Größe veränderbaren|![Sekundäre Auswahl mit Handles zur Größenänderung](../../extensibility/ux-guidelines/media/0713-17_secondaryresize.png "0713-17_SecondaryResize")|![Sekundäre Auswahl mit Handles zur Größenänderung &#40;vergrößert&#41;](../../extensibility/ux-guidelines/media/0713-18_secondaryresizezoom.png "0713-18_SecondaryResizeZoom")|  
...
|**Aktive Benutzeroberfläche**|Standard|![Benutzeroberfläche im aktiven Status](../../extensibility/ux-guidelines/media/0713-23_uiactive.png "0713-23_UIActive")|![Benutzeroberfläche im aktiven Status &#40;vergrößert&#41;](../../extensibility/ux-guidelines/media/0713-24_uiactivezoom.png "0713-24_UIActiveZoom")|  
...
|Object|Auswahl|  
|------------|---------------|  
|Liste|Zusammenhängende|Immer unterstützt (wenn die Mehrfachauswahl zulässig ist).|  
|Liste|Zusammenhanglose|Immer unterstützt (wenn die Mehrfachauswahl zulässig ist).|  
|Liste|Region|Die Unterstützung ist optional. Durch Ziehen der Maus in den Leerraum des Texts Liste initiiert.|  
...
#### <a name="gestures"></a>Gesten  
 Bewegungen bieten Benutzern eine Verknüpfung mit Befehlen, die andernfalls möglicherweise eine kompliziertere Interaktion erfordern. Finden Sie in der Windows-Richtlinien unter [gebräuchlicher Gesten für Desktop-Anwendungen](/windows/desktop/wintouch/windows-touch-gestures-overview), und befolgen Sie diese Anleitung für die meisten Gesten, einschließlich einfache Gesten wie Schwenken und zoomen.