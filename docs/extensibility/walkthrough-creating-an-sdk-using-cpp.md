...
4.  In **Projektmappen-Explorer**, öffnen Sie das Kontextmenü für **"Source.Extension.vsixmanifest"**, und wählen Sie dann **Code anzeigen**.  
...
8.  Verwenden Sie diese XML-Daten um den Inhalt der Datei zu ersetzen:  
...
11. In **Datei-Explorer**, \NativeMath\NativeMath.h, kopieren und dann im **Projektmappen-Explorer**in der **NativeMathVSIX** Projekt, fügen Sie ihn in die \DesignTime\ CommonConfiguration\Neutral\Include\-Ordner.  
...
12. Erstellen Sie eine Textdatei mit dem Namen NativeMathSDK.props, und fügen Sie den folgenden Inhalt darin, im Ordner "\DesignTime\Debug\x86\":  
  
    [!code-xml[CreatingAnSDKUsingCpp#7](../extensibility/codesnippet/XML/walkthrough-creating-an-sdk-using-cpp_7.xml)]  
  
13. Wählen Sie in der Menüleiste **Ansicht**, **Weitere Fenster**, **Fenster "Eigenschaften"** (Tastatur: Drücken Sie die F4-Taste).  
...
19. Wählen Sie die **installieren** Schaltfläche, warten Sie, bis die Installation abgeschlossen wurde, und starten Sie Visual Studio.  
...
4.  Auf der **allgemeine Eigenschaften**, **Framework und Verweise** Eigenschaftenseite in der Liste der Verweistypen, erweitern Sie **Windows**, und wählen Sie dann **Erweiterungen** . Wählen Sie im Detailbereich die **Native mathematische SDK** Erweiterung, und wählen Sie dann die **neuen Verweis hinzufügen** Schaltfläche.  
  
5.  In der **Verweis hinzufügen** wählen Sie im Dialogfeld die **Native mathematische SDK** Kontrollkästchen, und wählen Sie dann die **OK** Schaltfläche.  
...
7.  In **Projektmappen-Explorer**, öffnen Sie "MainPage.xaml" hinzu, und klicken Sie dann den folgenden XAML-Code verwenden, um seinen Inhalt zu ersetzen:  
  
     [!code-xml[CreatingAnSDKUsingCppDemoApp#1](../extensibility/codesnippet/Xaml/walkthrough-creating-an-sdk-using-cpp_8.xaml)]  
  
8.  Aktualisieren Sie "MainPage.Xaml.h", um diesen Code entsprechen:  
  
     [!code-cpp[CreatingAnSDKUsingCppDemoApp#2](../extensibility/codesnippet/CPP/walkthrough-creating-an-sdk-using-cpp_9.h)]  
  
9. Aktualisieren Sie "MainPage.Xaml.cpp", um diesen Code entsprechen:  
