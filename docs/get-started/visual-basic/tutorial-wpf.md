...
1. Klicken Sie im Dialogfeld **Neues Projekt** auf **Installiert** > **Visual Basic** > **Windows-Desktop**, und wählen Sie anschließend die Vorlage **WPF-App (.NET Framework)** aus. Nennen Sie das Projekt **HelloWPFApp**.
