...
|*\Snippets*|Der Codeausschnittordner. Enthält die Ausschnitte für die Sprache.|  
 ...
 In Windows wird *%userprofile%* in den Pfad *C:\Benutzer\\*\<Benutzername> aufgelöst*.* Wenn der Erweiterungsordner auf Ihrem System nicht vorhanden ist, müssen Sie ihn erstellen. Wenn der Ordner bereits vorhanden ist, ist er verborgen.  
