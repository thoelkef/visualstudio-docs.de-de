...
Design, Visualisierung und Umgestaltung von Klassen und anderen Typen in Ihrem Code mit dem Klassen-Designer in Visual Studio. Verwenden Sie Klassendiagramme zum Erstellen und Bearbeiten von Klassen in Ihrem C#-, Visual Basic- oder C++-Projekt, um Ihre Projektstruktur besser zu verstehen oder den Code umzustrukturieren.  
