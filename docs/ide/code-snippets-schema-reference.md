...
Gruppiert [CodeSnippet-Elemente](../ide/code-snippets-schema-reference.md#codesnippet). Das `CodeSnippets`-Element ist das Stammelement des XML-Schemas des Codeausschnitts.
