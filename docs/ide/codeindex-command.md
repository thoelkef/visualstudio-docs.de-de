---
title: "CodeIndex-Befehl | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "CodeIndex -Befehl [Team Foundation Server]"
  - "Befehlszeilentools [Team Foundation Server]"
  - "TFSConfig"
 ...
 **Erforderliche Berechtigungen**  
 ...
 Zum Verwenden des **CodeIndex**\-Befehls müssen Sie Mitglied der Sicherheitsgruppe **Team Foundation\-Administratoren** sein.  Informationen finden Sie unter [Permission reference for Team Foundation Server](../Topic/Permission%20reference%20for%20Team%20Foundation%20Server.md).  
  
> [!NOTE]
>  Sie müssen auch dann ein Fenster für die Eingabeaufforderung mit erhöhten Rechten öffnen, wenn Sie sich mit Administratoranmeldeinformationen anmelden, um diesen Befehl auszuführen.  Sie müssen diesen Befehl außerdem auf der Anwendungsebene für Team Foundation ausführen.  
...
|------------------|----------------------|  
|`CollectionName`|Gibt den Namen der Teamprojektauflistung an.  Wenn der Name Leerzeichen enthält, setzen Sie ihn in Anführungszeichen, z. B. "Fabrikam\-Website".|  
...
## Siehe auch  
 [Managing server configuration with TFSConfig](http://msdn.microsoft.com/de-de/94424190-3b6b-4f33-a6b6-5807f4225b62)   
 [Command\-line tools for TFS](http://msdn.microsoft.com/de-de/be8c997a-b97b-4e59-97f5-04db0a601a6c)