...
![EditorConfig-Hierarchie](~/docs/ide/media/vside_editorconfig_hierarchy.png)
...
![Text-Editor-Tabstoppeinstellung](~/docs/ide/media/vside_editorconfig_tabsetting.png)
...
![Code vor der Verwendung von EditorConfig](~/docs/ide/media/vside_editorconfig_before.png)
...
![Projekt mit hinzugefügter EDITORCONFIG-Datei](~/docs/ide/media/vside_editorconfig_addconfig.png)

Wenn Sie jetzt die TAB-TASTE drücken, erhalten Sie Tabstoppzeichen anstelle von Leerzeichen.

![Die TAB-TASTE fügt Tabstoppzeichen hinzu](~/docs/ide/media/vside_editorconfig_tab.png)
