---
title: "Erstellen von Anwendungen in bidirektionalen Sprachen | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Arabische Sprache, Erstellen von Anwendungen"
  - "Bidirektionale Sprachenunterstützung, Informationen über die Unterstützung bidirektionaler Sprachen"
  - "Anzeige hebräischer Zeichen, Erstellen von Anwendungen"
...
manager: "ghogen"
---
# Erstellen von Anwendungen in bidirektionalen Sprachen
...
## Visual Studio\-Funktionen, die vollständig unterstützt werden  
...
-   Code und normaler Text.  Im Code\-Editor, der gleichzeitig der Text\-Editor ist, können Sie mithilfe von Arabisch oder Hebräisch Klassen, Funktionen, Variablen, Eigenschaften, Zeichenfolgenliterale, Attribute usw. benennen.  Allerdings unterstützt der Editor keine Lesefolge von rechts nach links; der Text beginnt immer am linken Rand.  
    ...
    > [!TIP]
    >  Es wird empfohlen, Zeichenfolgenliterale in Ressourcendateien abzulegen und sie nicht fest in Programmen zu codieren.  Weitere Informationen finden Sie unter [Walkthrough: Localizing Windows Forms](http://msdn.microsoft.com/de-de/9a96220d-a19b-4de0-9f48-01e5d82679e5).  
...
## Siehe auch  
 [Bidirektionale Unterstützung für Windows Forms\-Anwendungen](../Topic/Bi-Directional%20Support%20for%20Windows%20Forms%20Applications.md)   
