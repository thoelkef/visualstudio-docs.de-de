---
title: Installation von Dotfuscator Community Edition (CE)
ms.date: 06/22/2017
ms.devlang: dotnet
...
4. Schließen Sie alle Instanzen der Visual Studio-IDE. <br/> <br/> ![Klicken auf Installieren](media/install_from_vs_345.png) <br/> <br/>
