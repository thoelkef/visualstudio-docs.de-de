...
![Gehe zu allen](~/docs/ide/media/gotoall.png)
...
* Geben Sie ein Fragezeichen (?) ein, um weitere Hilfe anzufordern.
  ![Gehe zu allen – Hilfe](~/docs/ide/media/gotoall_help.png)
...
:----: | ---- | -------- | ---
#      | ![Zeichensymbol](~/docs/ide/media/gotoall_symbolicon.png) | STRG+1, STRG+S | Suchen von übereinstimmenden Symbolen
f      | ![Dateisymbol](~/docs/ide/media/gotoall_fileicon.png)     | STRG+1, STRG+F | Übereinstimmende Dateinamen suchen
m      | ![Membersymbol](~/docs/ide/media/gotoall_membericon.png) | STRG+1, STRG+M | Übereinstimmende Elemente suchen
t      | ![Typsymbol](~/docs/ide/media/gotoall_typeicon.png)     | STRG+1, STRG+T | Übereinstimmende Typen suchen
:      | ![Zeilensymbol](~/docs/ide/media/gotoall_lineicon.png)     | Strg+G         | Zu der eingegebenen Zeilennummer gehen
...
Symbol | Beschreibung
---- | ---
![Aktuelles Dokument](~/docs/ide/media/gotoall_currentdocument.png) | Nur im aktuellen Dokument suchen
![Externe Dokumente](~/docs/ide/media/gotoall_external.png) | In externen Dokumenten suchen, zusätzlich zu den unter Projekt/Projektmappe gespeicherten

### <a name="settings"></a>Einstellungen
Klicken auf das Zahnradsymbol ![Zahnradsymbol](~/docs/ide/media/gotoall_gear.png) unten rechts ermöglicht Ihnen, die Funktionsweise diese Features zu ändern.
