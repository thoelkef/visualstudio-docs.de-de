---
title: "Gewusst wie: Signieren von Anwendungs- und Bereitstellungsmanifesten | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
helpviewer_keywords: 
  ...
  - "ClickOnce-Bereitstellung [Visual Studio], Signieren von Assemblys"
  - "Codesignierung [Visual Studio], Authenticode"
  - "Bereitstellungsmanifeste [Visual Studio]"
  - "Schlüsseldateien [Visual Studio]"
...
Wenn Sie eine Anwendung mit der ClickOnce\-Bereitstellung veröffentlichen möchten, müssen Anwendungs\- und Bereitstellungsmanifeste mit einem öffentlichen\/privaten Schlüsselpaar und unter Verwendung von Authenticode signiert werden.  Sie können die Manifeste mit einem Zertifikat aus dem Windows\-Zertifikatspeicher oder einer Schlüsseldatei signieren.  
 ...
 Weitere Informationen zur ClickOnce\-Bereitstellung finden Sie unter [ClickOnce Security and Deployment](../deployment/clickonce-security-and-deployment.md).  
 ...
 Informationen über das Erstellen von Schlüsseldateien finden Sie unter [Gewusst wie: Erstellen eines öffentlichen\/privaten Schlüsselpaars](../Topic/How%20to:%20Create%20a%20Public-Private%20Key%20Pair.md).  
