---
title: 'Vorgehensweise: Angeben von Buildereignissen (C#) | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-general
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Pre-build event/Post-build event command line dialog box (Dialogfelder „Befehlszeile für Präbuildereignis“ bzw. „Befehlszeile für Postbuildereignis“)](../ide/reference/pre-build-event-post-build-event-command-line-dialog-box.md)   
