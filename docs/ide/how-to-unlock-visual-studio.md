...
2.  Geben Sie die Anmeldeinformationen für ein Microsoft-Konto oder ein Geschäfts- bzw. Schulkonto ein. Visual Studio sucht nach einem Visual Studio- oder Visual Studio Team Services-Abonnement, das mit Ihrem Konto verknüpft ist.  
