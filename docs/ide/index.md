...
titleSuffix: ''
description: Erfahren Sie, wie Visual Studio Ihnen mit einer Vielzahl von Programmiersprachen beim Entwickeln von Apps hilft.
ms.date: 01/01/2018
layout: LandingPage
author: gewarren
ms.author: gewarren
...
ms.locfileid: "53060024"
---
# <a name="visual-studio-documentation"></a>Visual Studio-Dokumentation

Erfahren Sie, wie Visual Studio Ihnen mit einer Vielzahl von Programmiersprachen beim Entwickeln von Apps hilft.
Lernprogramme, Videos und andere Dokumentation veranschaulichen, wie Sie Code und Apps mit Visual Studio erstellen können.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Erfahren Sie, wie Sie Visual Studio installieren und einrichten</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Erhalten Sie eine Übersicht über Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Virtual Studio 2017 in der Microsoft Virtual Academy</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Machen Sie sich mit der IDE (integrierte Entwicklungsumgebung) vertraut</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erfahren Sie mehr über Projekte und Projektmappen</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Verwenden des Code-Editors</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Personalisieren Sie Design und Textfarben</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen Sie eine Web-App mit C#</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen Sie eine Konsolenanwendung mit Visual Basic</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen Sie eine Konsolenanwendung mit C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen Sie eine Web-App mit Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen Sie eine Web-App mit Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>Debuggen</span></a></div>