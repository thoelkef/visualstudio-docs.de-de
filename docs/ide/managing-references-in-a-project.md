---
title: "Verwalten von Verweisen in einem Projekt | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
helpviewer_keywords: 
  - "Visual C#-Projekte, Verweise"
  - "Verweisen auf Objekte, Projektverweise"
  - "Externe Komponentenverweise"
  - "Verweisen auf Namespaces"
  - "Visual Basic-Projekte, Verweise"
  - "Verweisen auf Komponenten, externe Komponenten"
  - "Webverweise, Projektverweistypen"
  - "Namespaces [Visual Studio], Verweis auf"
  - "COM-Komponenten, Verweis auf"
  - "Objekte [Visual Studio], Verweis auf"
...
Bevor Sie Code schreiben können, der sich auf eine externe Komponente oder einen verbundenen Dienst bezieht, müssen Sie zunächst einen Verweis auf diese Komponente im Projekt einrichten. Ein Verweis ist im Prinzip ein Eintrag in einer Projektdatei, der Informationen beinhaltet, die von Visual Studio zum Auffinden der Komponente oder des Diensts benötigt.  
 ...
 Um einen Verweis hinzuzufügen, klicken Sie im Projektmappen\-Explorer mit der rechten Maustaste auf den Knoten „Verweise“, und klicken Sie dann auf **Verweis hinzufügen**. Weitere Informationen finden Sie unter [Gewusst wie: Hinzufügen und Entfernen von Verweisen mit dem Verweis\-Manager](../ide/how-to-add-or-remove-references-by-using-the-reference-manager.md).  
  
 ![Verweis in Visual C&#43;&#43; hinzufügen](../ide/media/vs2015_cpp_add_reference.png "vs2015\_cpp\_add\_reference")  
...
## Siehe auch  
 ...
 [Programmieren mit Assemblys](../Topic/Programming%20with%20Assemblies.md)   
