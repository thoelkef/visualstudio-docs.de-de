...
![„Visual Studio-Leistung verwalten“ – ein Popup, das meldet, dass eine Erweiterung Visual Studio verlangsamt](~/docs/ide/media/vside_perfdialog_popup.PNG)
...
![„Visual Studio-Leistung verwalten“ – Ansicht der Erweiterungen](~/docs/ide/media/vside_perfdialog_extensions.PNG)
...
![„Visual Studio-Leistung verwalten“ – Ansicht des Toolfensters](~/docs/ide/media/vside_perfdialog_toolwindows.PNG)
...
![Dialogfeld „Extras“ | „Optionen“](~/docs/ide/media/VSIDE_LightweightSolutionLoad.png)
...
![Projektmappen-Explorer](~/docs/ide/media/VSIDE_LSL Solution Setting.png)
...
![Popupfenster](~/docs/ide/media/VSIDE_LSL Popup.png)
