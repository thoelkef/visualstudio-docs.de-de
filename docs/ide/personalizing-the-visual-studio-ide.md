...
## <a name="start-page"></a>Startseite  
 Informationen zum Erstellen einer benutzerdefinierten Startseite für Sie und Ihr Team finden Sie [Anpassen der Startseite](../ide/customizing-the-start-page-for-visual-studio.md).

## <a name="environment-color-themes"></a>Umgebungsfarbschemas  
 Um das Farbschema in Hell, Dunkel oder Blau zu ändern, geben Sie in **Schnellstart** den Begriff „Umgebung“ ein, wählen Sie **Umgebung > Allgemein**, und ändern Sie die Option **Farbschema**.

Um die Optionen für die farbliche Kennzeichnung im Editor zu ändern, geben Sie in **Schnellstart** den Begriff „Umgebung“ ein, und wählen Sie **Umgebung > Schriftarten und Farben** aus. Weitere Informationen finden Sie unter [Gewusst wie: Ändern von Schriftarten und Farben](../ide/how-to-change-fonts-and-colors-in-visual-studio.md).  
