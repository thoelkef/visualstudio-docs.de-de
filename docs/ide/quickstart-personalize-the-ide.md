...
1. Wählen Sie unter **Umgebung** die Kategorie **Schriftarten und Farben** aus.
   ...
   Beachten Sie, dass der Text unter **Einstellungen anzeigen für** die Angabe **Text-Editor** enthält &mdash; dies ist so gewünscht. Sie können die Dropdownliste erweitern, um eine umfassende Liste mit Optionen anzuzeigen, die zum Ändern der Schriftarten und Farben für Text verfügbar sind.
