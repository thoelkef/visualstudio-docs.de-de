 ...
 **Kennworthash lokal &speichern, um Offlineanmeldung zu ermöglichen**  
 Gibt an, ob ein verschlüsseltes Formular des Benutzerkennworts lokal zwischengespeichert wird, damit sich der Benutzer auch anmelden kann, wenn sich die Anwendung im Offlinemodus befindet. Diese Option ist standardmäßig ausgewählt.
