---
title: Umgestalten eines Felds zu einer Eigenschaft in C# | Microsoft-Dokumentation
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="encapsulate-a-field-in-c"></a>Kapseln eines Felds in C# #
...
1. Markieren Sie den Namen des zu kapselnden Felds, oder platzieren Sie den Textcursor in den Namen:
   ...
   ![Markierter Code](media/encapsulate-highlight-cs.png)
...
1. Führen Sie dann eine der folgenden Aktionen aus:
   ...
   **Feld kapseln (Feld jedoch weiterhin verwenden)** | Kapselt das Feld mit einer Eigenschaft, lässt aber alle Verwendungen des Felds unverändert.
   ...
   ![Kapseln der Eigenschaft – Ergebnis](media/encapsulate-result-cs.png)
