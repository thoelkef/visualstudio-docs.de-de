---
title: Extrahieren einer Schnittstelle in Visual Basic | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
1. Markieren Sie den Namen der Klasse, für die die Aktion ausgeführt wird, oder platzieren Sie den Textcursor einfach an eine beliebige Stelle im Klassennamen.
   ...
   ![Markierter Code](media/extractinterface-highlight-vb.png)
...
1. Geben Sie im angezeigten Dialogfeld **Schnittstelle extrahieren** die erforderlichen Informationen ein: ![Schnittstelle extrahieren](media/extractinterface-dialog-vb.png)
   | Feld | description |
   | --- | --- |
...
1. Klicken Sie auf **OK**.
   ...
   ![Resultierende Klasse](media/extractinterface-class-vb.png)
   ![Resultierende Schnittstelle](media/extractinterface-interface-vb.png)
