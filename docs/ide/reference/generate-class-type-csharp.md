---
title: "Generieren einer Klasse oder eines Typs – Codegenerierung (C#) | Microsoft-Dokumentation"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-a-class-or-type-in-c"></a>Generieren einer Klasse oder eines Typs in C# #
...
1. Platzieren Sie den Cursor in die Zeile mit einer roten Wellenlinie, die darauf hinweist, dass Sie eine noch nicht vorhandene Klasse verwendet haben.
   ...
   ![Markierter Code](media/class-highlight-cs.png)
...
1. Die Klasse bzw. Struktur wird automatisch mit dem aus der Verwendung abgeleiteten Konstruktor erstellt.
   ...
   ![Ergebnis der Aktion zum Generieren einer Klasse](media/class-result-cs.png)
