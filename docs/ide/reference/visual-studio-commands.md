---
title: "Visual Studio-Befehle | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
```  
 ...
 Für viele Befehle sind Aliase verfügbar. Eine Liste der Aliase für Befehle finden Sie unter [Visual Studio\-Befehlsaliase](../../ide/reference/visual-studio-command-aliases.md).  
...
|[Suchen in Dateien](../../ide/reference/find-in-files-command.md)|Durchsucht Dateien mit einer Teilmenge der unter [Suchen in Dateien](../../ide/find-in-files.md) verfügbaren Optionen|  
...
|[In Dateien ersetzen](../../ide/reference/replace-in-files-command.md)|Ersetzt Text in Dateien mithilfe einer Teilmenge der Optionen, die unter [In Dateien ersetzen](../../ide/replace-in-files.md) verfügbar sind|  
