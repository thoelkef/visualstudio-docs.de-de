...
2.  Fügen Sie nach dem Kommentar "Fill in the subtraction problem" folgenden Code hinzu.  
     ...
     ![QuickInfo im IntelliSense-Fenster](../ide/media/express_overloads.png "Express_Überladungen")  
QuickInfo im IntelliSense-Fenster  
     ...
     ![Überladung der Next()-Methode in IntelliSense](../ide/media/express_nextoverload.png "Express_NextÜberladung")  
...
5.  Speichern Sie den Code, und führen Sie ihn aus.  
     ...
     ![Mathetest mit Subtraktion](../ide/media/express_addsubtract.png "Express_SummierenSubstrahieren")  
