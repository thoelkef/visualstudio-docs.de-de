...
### <a name="tour-your-solution"></a>Kennenlernen der Projektmappe
 ...
 2. Öffnen Sie im Ordner **Controller** die Datei *HomeController.cs*.
 ...
 3. Sehen Sie sich den Inhalt von *HomeController.cs* an.
...
2. Visual Studio startet ein Browserfenster. Klicken Sie auf **About** (Info).
...
3. Lassen Sie das Browserfenster geöffnet, und kehren Sie zu Visual Studio zurück. Öffnen Sie *Controllers/HomeController.cs*, wenn es nicht bereits geöffnet ist.
...
4. Legen Sie in der ersten Zeile der Methode **About** einen Haltepunkt fest. Klicken Sie dazu auf den Rand, oder setzen Sie den Cursor in die Zeile, und drücken Sie **F9**.
...
5. Kehren Sie zum Browser zurück, und aktualisieren Sie die Seite **About**. Dadurch wird der Haltepunkt in Visual Studio ausgelöst.

6. Zeigen Sie in Visual Studio auf den Member **ViewData**, um dessen Daten anzuzeigen.
...
7. Entfernen Sie den Anwendungshaltepunkt mit derselben Methode, mit der Sie ihn hinzugefügt haben.

8. Öffnen Sie *Views/Home/About.cshtml*.

   ![Klicken Sie im Projektmappen-Explorer auf „About.cshtml“.](../ide/media/csharp-aspnet-solution-explorer-view-about.png)

9. Ändern Sie den Text **additional** in **changed**, und speichern Sie die Datei.

   ![Text „additional“ in „changed“ ändern](../ide/media/csharp-aspnet-about-cshtml-code-change.png)

10. Kehren Sie zum Browserfenster zurück, um den aktualisierten Text zu prüfen. (Aktualisieren Sie den Browser, wenn der neue Text nicht angezeigt wird.)
