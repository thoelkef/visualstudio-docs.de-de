---
title: "Visual C++-Codeausschnitte | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
## Verwenden eines Codeausschnitts zum Umschließen von ausgewähltem Code  
...
## Wo finde ich eine vollständige Liste der C\+\+\-Codeausschnitte?  
...
## "for" im Vergleich zu"foreach" im Vergleich zu"forr" im Vergleich zu "rfor"  
...
```  
 ...
 Der **rfor**\-Codeausschnitt stellt eine [bereichsbasierte](/visual-cpp/cpp/range-based-for-statement-cpp) "for"\-Schleife \(Link\) bereit:  
...
## Der Destruktor\-Ausschnitt \(~\)  
 Der Destruktor\-Ausschnitt \(**~**\) zeigt unterschiedliche Verhalten in unterschiedlichen Kontexten.  Wenn Sie diesen Ausschnitt innerhalb einer Klasse einfügen, stellt er einen Destruktor für diese Klasse bereit.  Betrachten Sie beispielsweise den folgenden Code:  
