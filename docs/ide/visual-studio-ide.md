...
ms.locfileid: "34691159"
---
# <a name="visual-studio-ide-overview"></a>Übersicht über die Visual Studio-IDE

Die Visual Studio-IDE ist eine kreative Startplattform, die Sie verwenden können, um Code anzuzeigen und zu bearbeiten und Apps zu debuggen, zu erstellen und zu veröffentlichen.
...
Im Folgenden werden weitere gängige Produktivitätsfeatures in Visual Studio vorgestellt:
...
- Über die Kontextmenüoption [Gehe zu Definition](../ide/go-to-and-peek-definition.md) gelangen Sie direkt an die Stelle, an der die Funktion oder das Objekt definiert ist. Durch einen Klick mit der rechten Maustaste im Editor sind auch andere Navigationsbefehle verfügbar.
...
1. Im Dialogfeld **Neues Projekt** werden mehrere *Projektvorlagen* angezeigt. Eine Vorlage enthält die grundlegenden Dateien und Einstellungen, die für einen bestimmten Projekttyp erforderlich sind. Wählen Sie unterhalb von **Visual C#**die Kategorie**.NET Core** aus, und wählen Sie dann die Vorlage **Konsolen-App (.NET Core)**. Geben Sie **HelloWorld** im Textfeld **Name** ein, und klicken Sie auf **OK**.
  ...
  ![.NET Core-App-Vorlage](../ide/media/overview-new-project-dialog.png)
   ...
   Visual Studio erstellt daraufhin das Projekt. Die Vorlage erstellt eine einfache „Hello World“-Anwendung, mit der die <xref:System.Console.WriteLine?displayProperty=nameWithType>-Methode aufgerufen wird, um die Literalzeichenfolge „Hello World!“ im Konsolenfenster anzuzeigen.
...
Sie können die IDE einschließlich des Standardfarbdesigns personalisieren. So ändern Sie das Design in **Dunkel**:
