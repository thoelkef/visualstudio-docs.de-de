...
#### <a name="create-the-wpf-project"></a>Erstellen des WPF-Projekts

1.  Erstellen Sie ein neues Projekt. Klicken Sie in der Menüleiste auf **Datei** > **Neu** > **Projekt**.

     ![Wählen Sie in der Menüleiste „Datei“, „Neu“, „Projekt“ aus](../ide/media/exploreide-filenewproject.png "ExploreIDE-FileNewProject")

2.  Wählen Sie die Visual Basic- oder Visual C# WPF-Anwendungsvorlage aus, indem Sie z.B. zunächst im linken Bereich **Installiert** > **Visual C#** > **Klassischer Windows-Desktop** und dann im mittleren Bereich **WPF-App (.NET Framework)** auswählen.  Geben Sie dem Projekt am unteren Rand des Dialogfelds **Neues Projekt** den Namen `HelloWPFApp`.
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>Bereinigen von Projektmappendateien und Erstellen einer Releaseversion
