...
<div id="main" class="v2">
                        ...
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    ...
                                    <p>Erfahren Sie, wie Sie Visual Studio installieren und einrichten.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Erste Schritte mit Visual Studio</h3>
                                    <p>Entwickeln Sie jede App für jede Plattform.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Neuerungen in Visual Studio</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1>Visual Studio-Dokumentation</h1>
        <ul class="pivots">
            <li>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="get-started/visual-studio-ide.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_overview.svg" alt="Guided tour icon" />Einführung beginnen</a></li>
                                                    <li><a class="barLink" href="get-started/tutorial-open-project-from-repo.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_pull-request.svg" alt="Repo icon" />Öffnen von Code aus einem Repository</a></li>
                                                    <li><a class="barLink" href="ide/index-writing-code.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_code-edit.svg" alt="Pencil icon" />Schreiben und bearbeiten von Code</a></li>
                                                    <li><a class="barLink" href="ide/compiling-and-building-in-visual-studio.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_build.svg" alt="Crane icon" />Erstellen Ihres Codes</a></li>
                                                    <li><a class="barLink" href="debugger/debugger-feature-tour.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_debug.svg" alt="Debug icon" />Debuggen Ihres Codes</a></li>
                                                    <li><a class="barLink" href="test/getting-started-with-unit-testing.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_test.svg" alt="Science flask icon" />Testen Ihres Codes</a></li>
                                                    <li><a class="barLink" href="data-tools/create-a-sql-database-by-using-a-designer.md"><img height="60" width="60" src="https://docs.microsoft.com/media/common/i_generic-database.svg" alt="Database icon" />Zugriff auf Daten lokal oder in der Cloud</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
Web-App mit ASP.NET Core</a>
            ...
            <li>
                <a href="#features">Tasks (Aufgaben)</a>
                <ul id="features">
                    <li>
                        <a href="#features1"> </a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwicklung</h3>
                                                    <p>Schreiben und verwalten Sie Ihren Code mit dem Code-Editor.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Build</h3>
                                                    <p>Kompilieren und erstellen Sie Ihren Quellcode.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Debug</h3>
                                                    <p>Untersuchen und beheben Sie Fehler in Ihrem Code.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Test</h3>
                                                    <p>Organisieren Sie Ihre Testverfahren.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erweitern</h3>
                                                    <p>Fügen Sie eigene Funktionen zur Visual Studio-IDE hinzu, um Ihre Entwicklungserfahrung zu verbessern.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Teilen, bearbeiten und debuggen Sie Code in einer Umgebung für die Zusammenarbeit in Echtzeit. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwickeln mit Containern</h3>
                                                    <p>Verwenden Sie Container, um modulare Komponenten zu isolieren und die Skalierbarkeit zu verbessern.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <a href="/dotnet/fsharp/">
                                                    <h3>F#</h3>
                                                    <p>Eine moderne, funktionale Programmiersprache mit objektorientierten Funktionen für die .NET-Plattform, mit einem Fokus darauf, die funktionale Programmierung für jede Aufgabe einfacher zu machen.</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <a href="/visualstudio/javascript/">
                                                    <h3>JavaScript</h3>
                                                    <p>Eine einfache, plattformübergreifende Skriptsprache, die häufig verwendet wird, um Webseiten interaktiver zu gestalten.</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <a href="http://www.typescriptlang.org/docs/tutorial.html">
                                                    <h3>TypeScript</h3>
                                                    <p>Eine Obermenge von JavaScript, die das einfache JavaScript kompiliert und es Ihnen ermöglicht, einen skalierbareren Code zu erstellen.</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <a href="/visualstudio/rtvs/">
                                                    <h3>R</h3>
                                                    <p>(nur Visual Studio 2017) Eine erweiterbare Programmiersprache, die normalerweise für statistische Berechnungen und Grafiken verwendet wird.</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <ul id="workloads">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Node.js</h3>
                                                    <p>Erstellen Sie skalierbare Netzwerkanwendungen mithilfe von Node.js, einer asynchronen, ereignisgesteuerten JavaScript-Laufzeit.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="card">
                                        <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                            ...
                                            <p>Sprachen und Tools zum Erstellen von Data Science-Anwendungen (einschließlich Python und F# oder R in Visual Studio 2017).</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <li>
                        ...
                        <ul id="windows" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Entwickeln Sie mithilfe von Visual Studio Apps und Spiele für jedes Gerät unter Windows.</p>
                                </div>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="mobile" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Erstellen Sie native oder hybride mobile Apps für Android, iOS und Windows.</p>
                                </div>
                            </li>
                            <li>
                                <a href="/xamarin/">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Spieleentwicklung mit Unity</h3>
                                                    <p>Erstellen Sie 2D- und 3D-Spiele mit Unity, einer leistungsfähigen plattformübergreifenden Entwicklungsumgebung.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Andere Toolsets</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwicklung von Visual Studio-Erweiterungen</h3>
                                                    <p>Erstellen Sie Add-Ons, die Visual Studio erweitern, z.B. Befehle, Code-Analyzer und Toolfenster.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Linux-Entwicklung mit C++</h3>
                                                    <p>Erstellen und debuggen Sie Anwendungen, die in einer Linux-Umgebung ausgeführt werden.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Plattformübergreifende .NET Core-Entwicklung</h3>
                                                    <p>Plattformübergreifende Anwendungsentwicklungen mit .NET Core, ASP.NET Core, HTML, JavaScript und Containerentwicklungstools.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
            ...
            <li>
                <a href="ide/talk-to-us.md"> Problemberichte </a>
            </li>
            <li>
                <a href="https://developercommunity.visualstudio.com/spaces/8/index.html">Entwicklercommunity</a>
            </li>
        </ul>
    </div>
</div>
