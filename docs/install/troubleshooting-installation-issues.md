...
![Sie können zur Schaltfläche „Feedback geben“ navigieren, um das Feedbacktool zu öffnen](~/docs/install/media/report-a-problem.png)
...
![Navigieren Sie zur Schaltfläche „Neues Problem melden“, und befolgen Sie dann die Anweisungen](~/docs/install/media/problem-report-details.png)
