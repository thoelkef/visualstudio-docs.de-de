...
1. Wenn Updates vorhanden sind, wird ein Benachrichtigungssymbol in Visual Studio angezeigt.

  ![Aktualisieren von Visual Studio 2017 mithilfe des Benachrichtigungshubs](~/docs/install/media/notification-flag.png "Das Benachrichtigungsflag in Visual Studio")

  Klicken oder tippen Sie auf das Benachrichtigungssymbol zum Öffnen des **Benachrichtigungshubs**.

  ![Aktualisieren von Visual Studio 2017 mithilfe des Benachrichtigungshub](~/docs/install/media/notifications-hub.png "Der Benachrichtigungshub in Visual Studio")
...
2. Klicken oder tippen Sie auf **"Visual Studio Update" is available** („Visual Studio-Update“ steht zur Verfügung), womit das Dialogfeld **Erweiterungen und Updates** geöffnet wird.
  ...
  ![Aktualisieren von Visual Studio 2017 mithilfe des Benachrichtigungshub](~/docs/install/media/notifications-hub-select.png "Der Benachrichtigungshub in Visual Studio")

3. Klicken oder tippen Sie im Dialgofeld **Erweiterungen und Aktualisierungen** auf die Schaltfläche **Update**.

  ![Aktualisieren von Visual Studio 2017 mithilfe des Benachrichtigungshubs](~/docs/install/media/notifications-extensions-and-updates.png "Das Dialogfeld „Erweiterungen und Updates“ in Visual Studio")
...
1.    Öffnen Sie den Installer. Möglicherweise müssen Sie den Installer aktualisieren, bevor Sie fortfahren. Ist dies der Fall, werden Sie dazu aufgefordert.
 >[!NOTE]
 > Auf einem Computer unter Windows 10, finden Sie den Installer unter dem Buchstaben **V** als **Installer für Visual Studio** oder unter dem Buchstaben **M** als **Microsoft Visual Studio-Installer**.
...
3.    Wenn ein Update verfügbar ist, sehen Sie eine Schaltfläche **Update**. (Es kann einige Sekunden dauern, bis der Installer bestimmen kann, ob ein Update verfügbar ist.)
  ...
  Klicken oder tippen Sie auf die **Update**-Schaltfläche, um die Updates zu installieren.
     ...
     ![Aktualisieren von Visual Studio 2017 mithilfe des Visual Studio-Installers](~/docs/install/media/update-visual-studio.png "Aktualisieren von Visual Studio 2017 mithilfe des Installers für Visual Studio")
