...
-   **Inklusive Größe \(Bytes\)** schließt die Größen von referenzierten Objekten ein.  
 ...
 Sie können das Instanzensymbol \(![Das Instanzsymbol in der Spalte Objekttyp](~/profiling/media/dbg_mma_instancesicon.png "DBG\_MMA\_InstancesIcon")\) in der Spalte **Objekttyp** auswählen und eine Liste der Instanzen des Typs anzeigen.  
