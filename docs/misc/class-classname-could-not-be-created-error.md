...
Bei der Initialisierung einer Klasse ist ein Fehler aufgetreten. Eine mögliche Ursache ist eine beschädigte [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)]\-Installation.  
...
2.  Installieren Sie [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] neu und kompilieren Sie das Programm anschließend erneut.  
