...
Dieser Fehler tritt in der Regel aufgrund einer beschädigten Datei aus. Sie müssen [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] möglicherweise neu installieren.  
