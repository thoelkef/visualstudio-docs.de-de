...
Der Konstantenwert 'wert' kann nicht in einen 'typ' konvertiert werden. \(verwenden Sie die unchecked\-Syntax zum Überschreiben\)  
 ...
 Es wurde versucht, einer Variablen einen Wert zuzuweisen, deren Typ den Wert nicht speichern kann. Weitere Informationen finden Sie unter [Typen](/dotnet/csharp/programming-guide/types/index).  
