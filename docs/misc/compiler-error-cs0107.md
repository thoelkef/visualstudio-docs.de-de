...
Mehr als ein Schutzmodifizierer.  
 ...
 Für einen Klassenmember ist nur ein Zugriffsmodifizierer \([public](/dotnet/csharp/language-reference/keywords/public), [private](/dotnet/csharp/language-reference/keywords/private), [protected](/dotnet/csharp/language-reference/keywords/protected) oder [internal](/dotnet/csharp/language-reference/keywords/internal)\) zulässig, mit Ausnahme von **internal protected**.  
