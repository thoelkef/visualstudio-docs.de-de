...
Der Ausdruck, der 'Variable' zugewiesen wird, muss konstant sein.  
 ...
 Eine [const](/dotnet/csharp/language-reference/keywords/const)\-Variable kann keinen Ausdruck als ihren Wert übernehmen, der nicht konstant ist. Weitere Informationen finden Sie unter [Konstanten](/dotnet/csharp/programming-guide/classes-and-structs/constants).  
