...
Die Bezeichnung 'Bezeichnung' ist ein Duplikat.  
 ...
 Eine Bezeichnung mit demselben Namen ist zweimal aufgetreten. Weitere Informationen finden Sie unter [goto](/dotnet/csharp/language-reference/keywords/goto).  
