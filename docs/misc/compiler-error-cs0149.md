...
Methodenname erwartet.  
 ...
 Geben Sie beim Erstellen eines [Delegaten](/dotnet/csharp/language-reference/keywords/delegate) eine Methode an. Weitere Informationen finden Sie unter [Delegaten](/dotnet/csharp/programming-guide/delegates/index).  
