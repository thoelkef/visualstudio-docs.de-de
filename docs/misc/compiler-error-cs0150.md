...
Konstantenwert erwartet.  
 ...
 Eine Variable wurde gefunden, obwohl eine Konstante erwartet wurde. Weitere Informationen finden Sie unter [switch](/dotnet/csharp/language-reference/keywords/switch).  
