...
Die Bezeichnung 'label' ist im Bereich der goto\-Anweisung nicht vorhanden.  
 ...
 Die Bezeichnung, auf die die [goto](/dotnet/csharp/language-reference/keywords/goto)\-Anweisung verweist, konnte im Bereich der `goto`\-Anweisung nicht gefunden werden.  
