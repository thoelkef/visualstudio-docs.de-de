...
„type“ ist kein Verweistyp, wie er für die lock\-Anweisung erforderlich ist.  
 ...
 Die [lock](/dotnet/csharp/language-reference/keywords/lock-statement)\-Anweisung kann nur Verweistypen auswerten. Weitere Informationen finden Sie unter [Threadsynchronisierung](../Topic/Thread%20Synchronization%20\(C%23%20and%20Visual%20Basic\).md) und [Verweistypen](/dotnet/csharp/language-reference/keywords/reference-types).  
