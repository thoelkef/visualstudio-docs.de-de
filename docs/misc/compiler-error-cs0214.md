...
Zeiger und Puffer fester Größe können nur in einem unsicheren Kontext verwendet werden.  
 ...
 Zeiger können nur mit dem [unsafe](/dotnet/csharp/language-reference/keywords/unsafe)\-Schlüsselwort verwendet werden. Weitere Informationen finden Sie unter [Unsicherer Code und Zeiger](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
