...
"is" und "as" sind keine gültigen Zeigertypen.  
 ...
 Die [is](/dotnet/csharp/language-reference/keywords/is)\- und [as](/dotnet/csharp/language-reference/keywords/as)\-Schlüsselwörter sind für Zeigertypen nicht gültig. Weitere Informationen finden Sie unter [Unsicherer Code und Zeiger](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
