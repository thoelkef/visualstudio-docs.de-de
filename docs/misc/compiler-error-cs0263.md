...
Partielle Deklarationen von 'typ' dürfen keine unterschiedlichen Basisklassen angeben.  
 ...
 Wenn ein Typ in partiellen Deklarationen definiert wird, geben Sie in jeder der partiellen Deklarationen die gleichen Basistypen an. Weitere Informationen finden Sie unter [Partielle Klassen und Methoden](/dotnet/csharp/programming-guide/classes-and-structs/partial-classes-and-methods).  
