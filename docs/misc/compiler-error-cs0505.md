...
'Member1': Überschreiben nicht möglich; 'Member2' ist keine Funktion.  
 ...
 Eine Klassendeklaration hat versucht, eine Nichtmethode in einer Basisklasse zu überschreiben. Bei Überschreibungen muss der Membertyp übereinstimmen. Wenn eine Methode mit demselben Namen wie für eine Methode in einer Basisklasse benötigt wird, verwenden Sie [new](/dotnet/csharp/language-reference/keywords/new) \(und nicht [override](/dotnet/csharp/language-reference/keywords/override)\) für die Deklaration der Methode in der Basisklasse.  
