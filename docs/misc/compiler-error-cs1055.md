...
add\- oder remove\-Accessor erwartet.  
 ...
 Wenn Ihr [event](/dotnet/csharp/language-reference/keywords/event)\-Element nicht als Feld deklariert ist, muss sowohl die **add**\- als auch die **remove**\-Accessorfunktion definiert werden.  
