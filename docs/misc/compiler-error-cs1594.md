...
Der Delegat 'Delegat' enthält einige ungültige Argumente.  
 ...
 Der Typ eines Arguments, das an einen [Delegataufruf](/dotnet/csharp/language-reference/keywords/delegate) übergeben wurde, stimmt nicht mit dem Typ des Parameters in der Delegatdeklaration überein.  
