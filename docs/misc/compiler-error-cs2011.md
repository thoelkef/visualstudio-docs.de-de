...
Fehler beim Öffnen der Antwortdatei „file“  
 ...
 Weitere Informationen zu Antwortdateien finden Sie unter [@ \(Antwortdatei festlegen\)](/dotnet/csharp/language-reference/compiler-options/response-file-compiler-option).