...
Leerer Schalterblock.  
 ...
 Der Compiler hat einen [switch](/dotnet/csharp/language-reference/keywords/switch)\-Block ohne **case**\- oder **default**\-Anweisung erkannt. Ein `switch`\-Block muss mindestens eine **case**\- oder **default**\-Anweisung aufweisen.  
