...
Ungültiger Wert für '\/define'; 'Bezeichner' ist kein gültiger Bezeichner.  
 ...
 Diese Warnung tritt auf, wenn der in der [\/define](/dotnet/csharp/language-reference/compiler-options/define-compiler-option)\-Option verwendete Wert ungültige Zeichen aufweist.  
