...
Der [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]\-Compiler kann eine seiner intern geschriebenen Dateien nicht erfolgreich interpretieren.  
...
2.  Wenn der Fehler erneut auftritt, installieren Sie den [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]\-Compiler neu.  
