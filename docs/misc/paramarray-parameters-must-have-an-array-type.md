...
2.  Wenn der Fehler erneut auftritt, speichern Sie Ihre Arbeit, und starten Sie [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] erneut.  
  
3.  Wenn der Fehler weiterhin besteht, installieren Sie [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] neu.  
