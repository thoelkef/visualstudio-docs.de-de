...
1.  Stellen Sie sicher, dass die Datei, die Sie in die `Picture`\-Eigenschaft laden möchten, eine gültige, von [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] unterstützte Grafikdatei ist.  
