...
Das durch den [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]\-Compiler aufgerufene ALink\-Tool meldet einen Fehler beim Erstellen der Assembly. Eine mögliche Ursache ist eine signierte Assembly, die auf eine unsignierte Assembly verweist.  
