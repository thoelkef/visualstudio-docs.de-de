...
Eine Prozedur wird mit Parametern oder einem Rückgabetyp deklariert, die von [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] nicht dargestellt werden können.  
