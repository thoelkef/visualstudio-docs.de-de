...
Wenn Dateien mit dem [My.Computer.Network Object](/dotnet/visual-basic/language-reference/objects/my-computer-network-object) hochgeladen und heruntergeladen werden, müssen Sie einen `connectionTimeout`\-Wert angeben, der größer ist als `0`.  
