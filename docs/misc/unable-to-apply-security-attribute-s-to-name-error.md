...
3.  Wenn der Fehler weiterhin besteht, speichern Sie Ihre Arbeit, und starten Sie [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] erneut.  
  
4.  Wenn der Fehler erneut auftritt, installieren Sie [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] neu.  
