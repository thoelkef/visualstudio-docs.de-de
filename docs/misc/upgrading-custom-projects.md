...
ms.topic: "article"
helpviewer_keywords: 
  - "Aktualisieren von Projektsystemen"
  - "Projekte [Visual Studio SDK], aktualisieren"
  - "Projektsystemupgrades [Visual Studio]"
