...
3. Öffnen Sie das Kontextmenü des Code Elements, und wählen Sie **Bearbeiten**  >  **Add**  >  **generischen Link**hinzufügen aus.
...
2. Wählen Sie auf der Symbolleiste das dritte Symbol aus, und **Erstellen Sie einen neuen Kommentar Knoten mit einem neuen Link zum ausgewählten Knoten**.
     ...
     Öffnen Sie das Kontextmenü für das Code Element, **Edit**und wählen Sie  >  **neuen Kommentar**bearbeiten aus.

3. Geben Sie Ihre Kommentare ein. Drücken Sie **UMSCHALT**Taste, um eine neue Zeile einzugeben  +  **Enter**.

#### <a name="add-a-comment-to-the-map-itself"></a>Hinzufügen eines Kommentars zur Übersicht

1. Öffnen Sie das Kontextmenü für die Karte, **Edit**und wählen Sie  >  **neuen Kommentar**bearbeiten aus.

2. Geben Sie Ihre Kommentare ein. Drücken Sie **UMSCHALT**Taste, um eine neue Zeile einzugeben  +  **Enter**.
...
2. Drücken Sie **F2**, oder öffnen Sie das Kontextmenü, und wählen Sie **Edit**  >  **Umbenennen**bearbeiten aus.

3. Wenn das Eingabefeld in der Übersicht angezeigt wird, benennen Sie das Codeelement oder den Link um.

**OR**

1. Öffnen Sie das Kontextmenü, **Edit**und wählen Sie  >  **Eigenschaften**bearbeiten aus.
...
- Ändern Sie die Hintergrundfarbe des Elements, oder löschen Sie das nach Verfolgungs Flag, **Edit**indem Sie  >  **andere Flag-Farben**bearbeiten auswählen.
