...
|Ändern Sie die Größe der Übersicht, und passen Sie sie auf die Fenstergröße an.|Wählen Sie **mit Zoom anpassen** aus der **Zoom** Liste auf der Symbolleiste der Codeübersicht.<br /><br /> - oder -<br /><br /> Klicken Sie auf die **Zoom zum Einpassen** Symbol ![Zoom-Symbol auf der Symbolleiste der Map](../modeling/media/almcodemapzoomicon.png) auf der Symbolleiste der Codeübersicht. Tastatur: Drücken Sie **STRG + 0** (null).|
|Suchen Sie anhand des Namens einen Knoten in der Übersicht. **Tipp:** dies funktioniert nur für Elemente auf der Karte. Um Elemente in der Projektmappe jedoch nicht in der Übersicht suchen möchten, finden sie in **Projektmappen-Explorer**, und ziehen sie dann auf der Karte. (Ziehen Sie die Auswahl, oder auf die **Projektmappen-Explorer** -Symbolleiste klicken Sie auf **auf Code Map anzeigen**).|1.  Wählen Sie die **finden** Symbol ![Suchsymbol auf zuordnungssymbolleiste](../modeling/media/almcodemapfindicon.png) auf der Symbolleiste der Codeübersicht (Tastatur: Drücken Sie die **STRG + F**) das Suchfeld in der oberen rechten Ecke der Karte angezeigt.<br />2.  Geben Sie den Elementnamen ein und drücken Sie **zurückgeben** oder klicken Sie auf das Symbol "Bildschirmlupe". Das erste Element, das dem Suchbegriff übereinstimmt, wird in der Übersicht hervorgehoben.<br />3.  Öffnen Sie die Dropdownliste, und wählen Sie eine Suchoption aus, um Ihre Suche anzupassen. Die Optionen sind **Weitersuchen**, **Vorheriges suchen**, und **Alles markieren**. Klicken Sie auf die entsprechende Schaltfläche neben dem Textfeld „Suchen“.<br />     ![Die Optionen Drop Search&#45;-Liste](../modeling/media/almcodemapssearchdropdown.png)<br />     Verwenden Sie alternativ die Tastatur: Drücken Sie die **F3** auf den nächsten übereinstimmenden Knoten auszuwählen oder **UMSCHALT + F3** auf den vorherigen übereinstimmenden Knoten auszuwählen.<br />4.  Wählen Sie eine der Optionen aus, die angeben, wie Suchbegriffe behandelt werden, indem Sie auf die Symbole unten dem Textfeld „Suchen“ klicken.<br />     ![Übereinstimmungsoptionen für Suche](../modeling/media/almcodemapssearchmatchicons.png)<br />     Die Optionen sind (von links nach rechts) für die Übereinstimmung unter Berücksichtigung der Groß-/Kleinschreibung, für die Übereinstimmung mit ganzem Wort, für die Verwendung der normalen .NET-Ausdruckssyntax und für das automatische Erweitern von Gruppen, um Übereinstimmungen für eingeschlossene Elemente anzuzeigen. **Wichtig:** können Sie im Suchfeld verwenden, um Übereinstimmungen in reduzierten Gruppen zu finden, nur dann, wenn diese Gruppen zuvor erweitert wurden. Wählen Sie diese Option unter dem Suchfeld aus, um diese Übereinstimmungen zu suchen und ihre übergeordneten Gruppen automatisch zu erweitern.|
