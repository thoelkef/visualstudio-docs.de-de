...
5.  Orientieren Sie sich beim Auswählen des zu ändernden Stils an der folgenden Tabelle:  
    ...
    |-----------------------|----------------|  
    |Hintergrundfarbe:|**Im Hintergrund**|  
    |Umrissfarbe|**Strich**|  
