...
## <a name="to-edit-the-project-file"></a>So bearbeiten Sie die Projektdatei  
 ...
 Wenn Sie die Bearbeitung abgeschlossen haben, wählen Sie **neu laden**.  
...
##  <a name="a-nameparametersa-pass-build-context-data-into-the-templates"></a><a name="parameters"></a>Übergeben der buildkontextdaten in die Vorlagen  
...
```  
 ...
 Legen Sie in einer Textvorlage `hostspecific` in der template-Direktive fest. Verwenden der [Parameter](../modeling/t4-parameter-directive.md) Direktive, um Werte abzurufen:  
...
```  
 ...
 In einem Direktivenprozessor können Sie <xref:Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost.ResolveParameterValue%2A>:</xref:Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost.ResolveParameterValue%2A> aufrufen  
...
##  <a name="a-namemsbuilda-using-project-properties-in-assembly-and-include-directives"></a><a name="msbuild"></a>Verwenden von Projekteigenschaften in der Assembly- und Includedirektive  
 ...
 **Warum sollten Vorlagen im Buildserver transformieren? Ich haben bereits Vorlagen in Visual Studio transformiert, bevor ich meinen Code eingecheckt.**  
 ...
 **Was sind andere Optionen gibt es für die Transformation von Textvorlagen?**  
  
-   Die [TextTransform (Hilfsprogramm)](../modeling/generating-files-with-the-texttransform-utility.md) in Befehlsskripts verwendet werden kann. In den meisten Fällen ist es einfacher, MSBuild zu verwenden.  
  
-   [Aufrufen von Texttransformation in einer VS-Erweiterung](../modeling/invoking-text-transformation-in-a-vs-extension.md)  
  
-   [Zur Entwurfszeit Textvorlagen](../modeling/design-time-code-generation-by-using-t4-text-templates.md) werden von Visual Studio transformiert.  
...
## <a name="read-more"></a>Weitere Informationen  
 ...
 [Oleg Sych: Grundlegendes zur T4: MSBuild-Integration](http://www.olegsych.com/2010/04/understanding-t4-msbuild-integration/)
