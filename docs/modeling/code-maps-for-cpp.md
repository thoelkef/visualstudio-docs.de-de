---
title: Anzeigen von Abhängigkeiten zwischen C++-Quelldateien und Headerdateien
ms.date: 05/16/2018
ms.topic: conceptual
author: gewarren
ms.author: gewarren
...
Wenn Sie eine Projektmappe öffnen, die Visual C++-Projekte enthält, könnte die Aktualisierung der IntelliSense-Datenbank etwas Zeit beanspruchen. Während dieser Zeit können Sie möglicherweise nicht zum Erstellen von Code Maps für Headerdateien (*h* oder `#include`) Dateien, bis die Aktualisierung die IntelliSense-Datenbank abgeschlossen ist. Sie können den Status der Aktualisierung in der Statusleiste von Visual Studio überwachen.

- Wählen Sie zum Anzeigen der Abhängigkeiten zwischen allen Quelldateien und Headerdateien in der Projektmappe **Architektur** > **Diagramm für Includedateien generieren**.
