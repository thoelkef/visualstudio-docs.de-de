...
|**Thema**|**Aufgabe**|  
|---------------|--------------|  
|[Visualisieren von Code](../modeling/visualize-code.md)|Erstellen Sie Code Maps und Abhängigkeitsdiagramme zum besseren Verständnis von unbekanntem Code.|  
