...
|Weitergeben von Änderungen an Ressourcen wie andere Visual Studio-Erweiterungen außerhalb des Speichers.|Finden Sie unter [Ereignishandler propagieren Änderungen außerhalb des Modells](../modeling/event-handlers-propagate-changes-outside-the-model.md).|
