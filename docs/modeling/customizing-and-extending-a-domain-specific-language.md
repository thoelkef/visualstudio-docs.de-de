...
|Enable Elemente ziehen und Ablegen in diesem Diagramm andere DSLs und Windows|Finden Sie unter [Vorgehensweise: Hinzufügen eines Drag & Drop-Handlers](../modeling/how-to-add-a-drag-and-drop-handler.md)|
