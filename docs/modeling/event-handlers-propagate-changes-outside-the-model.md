...
## <a name="use-events-to-make-undoable-adjustments-in-the-store"></a>Mit Ereignissen können rückgängig gemacht werden Anpassungen in den Speicher ein
