...
|Vererbungs Modifizierer|Beschreibt die Art der Vererbung der Quell Code Klasse, die vom Anschluss ( `none` `abstract` oder) generiert wird `sealed` .|none|
