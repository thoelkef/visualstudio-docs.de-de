...
> [!IMPORTANT]
> Wenn Sie die ebenenvalidierung mit Team Foundation Server ausführen möchten, müssen Sie auch die gleiche Version von Visual Studio auf dem Buildserver installieren.
