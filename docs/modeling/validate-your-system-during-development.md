...
|**Kategorie**|**Links**|  
|------------------|---------------|  
|**Videos**|![Link zu Video](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: Doug sieben: Verstehen von Code und Systementwurf mit Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkId=216100)<br /><br /> ![Link zu Video](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: Entwerfen einer Anwendung mit einem Abhängigkeitsdiagramm](http://go.microsoft.com/fwlink/?LinkID=201117)<br /><br /> ![Link zu Video](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN-Reihe: Vorgehensweise beim Überprüfen von Code mit Abhängigkeitsdiagramme](http://go.microsoft.com/fwlink/?LinkID=214405)|  
