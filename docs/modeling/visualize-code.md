---
title: Visualisieren von Code | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   Architektur des Systems zu beschreiben und behalten den Code konsistent mit dem Entwurf, Abhängigkeit Diagramme erstellen, und Überprüfen von Code für diese Diagramme.  
