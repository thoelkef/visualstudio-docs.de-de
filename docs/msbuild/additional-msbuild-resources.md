...
## Communityforen  
 In Foren können Sie mit anderen Entwicklern sowie mit Microsoft\-Mitarbeitern interagieren.  Wenn ein Fehler aufgetreten ist, für den Sie keine Lösung finden, können Sie eine entsprechende Frage in einem Forum veröffentlichen.  Darüber hinaus können Sie Newsgroups nach Beiträgen durchsuchen, die von anderen Benutzern zum selben Problem veröffentlicht wurden.  Sie können über die Website [MSDN\-Foren](http://go.microsoft.com/fwlink/?LinkId=48931) auf das Forum zu Visual Studio und MSBuild zugreifen.  
  
 Auf der Website [Channel 9 MSBuild](http://channel9.msdn.com/) können Sie auf [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)]\-Communityressourcen zugreifen.  
  
## Produktsupport  
 Wenn nach Konsultation der anderen Ressourcen noch Fragen offen sind, können Sie sich auf der Website für [Microsoft\-Hilfe und \-Support](http://go.microsoft.com/fwlink/?linkid=1782) an den Microsoft\-Produktsupport wenden.  Weitere Informationen zum Produktsupport in Ihrer Nähe finden Sie unter [Sprechen Sie mit uns](../ide/talk-to-us.md).  
