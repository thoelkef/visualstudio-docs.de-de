...
Ruft den Pfad zum [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)] ab  
...
## <a name="example"></a>Beispiel  
 Im folgenden Beispiel wird mit der Aufgabe `GetFrameworkSdkPath` der Pfad zum [!INCLUDE[winsdkshort](../debugger/debug-interface-access/includes/winsdkshort_md.md)] in der `SdkPath`-Eigenschaft gespeichert.  
