...
![Windows-Heap-Zuordnung](~/docs/profiling/media/heap-example-windows-heap.png)
...
![Aktivieren der Heap-Profilerstellung](~/docs/profiling/media/heap-enable-heap.png)
...
![Heap-Auswahl](~/docs/profiling/media/heap-example-custom-heap.png)
...
![NT-Heap mit Tracker](~/docs/profiling/media/heap-example-windows-heap.png)
