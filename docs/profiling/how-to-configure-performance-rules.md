---
title: "Gewusst wie: Konfigurieren der Leistungsregeln der Profilerstellungstools | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
manager: "ghogen"
---
# Gewusst wie: Konfigurieren der Leistungsregeln der Profilerstellungstools
...
### So konfigurieren Sie Leistungswarnungen des Profilers  
  
1.  Klicken Sie im Menü **Extras** auf **Optionen**.  
  
2.  Erweitern Sie **Leistungstools**, und klicken Sie dann auf **Regeln**.  
  
3.  Um eine Warnung zu aktivieren oder zu deaktivieren, aktivieren oder deaktivieren Sie das Kontrollkästchen neben der Warn\-**ID** und dem Namen.  
