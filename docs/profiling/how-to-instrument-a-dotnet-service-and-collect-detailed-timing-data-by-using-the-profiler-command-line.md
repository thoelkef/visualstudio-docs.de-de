...
Dieser Artikel beschreibt, wie Sie verwenden Visual Studio-Profilerstellungstools-Befehlszeilentools zum Instrumentieren eines .NET Framework-Diensts und Sammeln ausführlicher Zeitsteuerungsdaten.
...
Um ausführliche Zeitsteuerungsdaten aus einer .NET Framework-Dienst mit der instrumentierungsmethode zu erfassen, verwenden Sie die [VSInstr.exe](../profiling/vsinstr.md) Tool, um eine instrumentierte Version der Komponente generieren. Sie ersetzen dann die nicht instrumentierte Version des Diensts durch die instrumentierte Version und stellen dabei sicher, dass der Dienst für den manuellen Start konfiguriert ist. Mit [VSPerfCLREnv.cmd](../profiling/vsperfclrenv.md) können Sie die globalen Umgebungsvariablen für die Profilerstellung initialisieren und den Hostcomputer neu starten. Starten Sie dann den Profiler.
