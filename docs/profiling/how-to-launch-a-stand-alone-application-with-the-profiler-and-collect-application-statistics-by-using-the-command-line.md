---
title: "Gewusst wie: Starten einer eigenst&#228;ndigen Anwendung mit dem Profiler und Sammeln von Anwendungsstatistiken &#252;ber die Befehlszeile | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "ghogen"
---
# Gewusst wie: Starten einer eigenst&#228;ndigen Anwendung mit dem Profiler und Sammeln von Anwendungsstatistiken &#252;ber die Befehlszeile
...
## Starten der Anwendung mit dem Profiler  
 ...
 Sie können auch die **\/globaloff**\-Option hinzufügen, um die Datensammlung beim Starten der Zielanwendung anzuhalten.  Dann starten Sie die Datensammlung mit **\/globalon**.  
...
3.  Starten Sie die Zielanwendung.  Geben Sie Folgendes ein:**VSPerfCmd \/launch:**`appName` \[`Options`\] \[`Sample Event`\]  
  
     Die folgenden Optionen können mit der **\/launch**\-Option kombiniert werden.  
