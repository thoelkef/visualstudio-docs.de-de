...
![Fenster „Diagnosetools“](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Diagnosetools")
...
![Zusammenfassungsansicht der Diagnosetools](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Zusammenfassung der Diagnosetools")
...
![Aktivieren der CPU-Auslastung in den Diagnosetools](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Diagnosetools: Aktivieren der CPU-Auslastung")
...
![Ansicht CPU-Auslastung in den Diagnosetools](~/docs/profiling/media/prof-tour-cpu-usage.png "CPU-Auslastung in den Diagnosetools")
...
![Diagnosetools-Schmetterlingsansicht mit Aufrufer/Aufgerufenem](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Diagnosetools-Ansicht mit Aufrufer/Aufgerufenem")

## <a name="analyze-memory-usage"></a>Analysieren der Speicherauslastung

Mit dem Fenster „Diagnosetools“ können Sie auch die Speicherauslastung in Ihrer App bewerten. Beispielsweise können Sie die Anzahl und Größe der Objekte auf dem Heap anzeigen. Ausführlichere Anweisungen zum Analysieren von Speicher finden Sie unter [Speicherauslastung](../profiling/memory-usage.md).
...
![Ereignisansicht in den Diagnosetools](~/docs/profiling/media/prof-tour-events.png "Anzeigen von Ereignissen in den Diagnosetools")
...
![Profilerstellungstour PerfTips](~/docs/profiling/media/prof-tour-perf-tips.png "Profilerstellungstour PerfTips")
...
![Anzeigen von Ereignissen der Benutzeroberflächenanalyse in den Diagnosetools](~/docs/profiling/media/prof-tour-ui-analysis.png "Anzeigen von Ereignissen der Benutzeroberflächenanalyse in den Diagnosetools")
...
![Leistungsprofiler](~/docs/profiling/media/prof-tour-performance-profiler.png "Leistungsprofiler")
...
![Profilerstellungstool „Anwendungszeitachse“](~/docs/profiling/media/prof-tour-application-timeline.gif "Profilerstellungstool „Anwendungszeitachse“")
...
![Profilerstellungstool „GPU-Nutzung“](~/docs/profiling/media/prof-tour-gpu-usage.png "Dialogfeld „GPU-Nutzung“")
...
![Profilerstellungstool „Netzwerkverwendung“](~/docs/profiling/media/prof-tour-network-usage.png "Dialogfeld „Netzwerkverwendung“")

Wählen Sie einen Vorgang in der Ansicht „Zusammenfassung“ aus, um mehr Details anzuzeigen.

![Ausführliche Informationen im Tool „Netzwerkverwendung“](~/docs/profiling/media/prof-tour-network-usage-details.png "Dialogfeld mit Details zur Netzwerkverwendung")
...
![Tool „Leistungs-Explorer“](~/docs/profiling/media/prof-tour-performance-explorer.png "Leistungs-Explorer")
