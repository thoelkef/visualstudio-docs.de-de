...
Die `StopProfile`\-Funktion legt den Indikator für die angegebene Profilebene auf 0 \(OFF\) fest.  
...
## Beispiel  
 Das folgende Beispiel veranschaulicht die StopProfile\-Methode.  Im Beispiel wird davon ausgegangen, dass ein Aufruf der StartProfile\-Methode für denselben durch [PROFILE\_CURRENTID](../profiling/profile-currentid.md) identifizierten Prozess oder Thread erfolgt ist.  
