...
Die Profilerstellungsmethode *Instrumentation* von [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] zeichnet detaillierte Informationen zur zeitlichen Steuerung für die Funktionsaufrufe, Zeilen und Anweisungen in der profilierten Anwendung auf.  
