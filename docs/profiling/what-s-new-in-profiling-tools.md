...
![Diagnosetools-Registerkarte Zusammenfassung](~/docs/profiling/media/DiagToolsSummaryTab-2.png "DiagToolsZusammenfassungRegisterkarte")
...
![Diagnosetools Ansicht Aufrufer/Aufgerufener](~/docs/profiling/media/DiagToolsCallerCallee.png "DiagToolsAufrufer/Aufgerufener")
