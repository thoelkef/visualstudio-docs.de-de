...
![PyLint-Befehl im Kontextmenü für Python-Projekte](~/docs/python/media/code-pylint-command.png)
...
![PyLint-Fehlerliste](~/docs/python/media/code-pylint-error-list.png)
