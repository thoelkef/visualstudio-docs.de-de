...
![Aktivieren von Websockets im Azure-Portal](~/docs/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Debuggen einer Azure App Service-Website](~/docs/python/media/azure-remote-debugging-attached.png)
...
![Azure-Remotedebuggen – Informationsseite zum Proxy](~/docs/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Ermitteln des Debuggerendpunkts in einer Azure App Service-Instanz](~/docs/python/media/azure-remote-debugging-secret.png)
...
![Verwenden des Dialogfelds „An den Prozess anhängen“ zum Anfügen an eine Azure-Website](~/docs/python/media/azure-remote-debugging-manual-attach.png)
