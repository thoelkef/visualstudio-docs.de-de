...
![Aktivieren von Websockets im Azure-Portal](~/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Debuggen einer Azure App Service-Website](~/python/media/azure-remote-debugging-attached.png)
...
![Azure-Remotedebuggen – Informationsseite zum Proxy](~/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Ermitteln des Debuggerendpunkts in einer Azure App Service-Instanz](~/python/media/azure-remote-debugging-secret.png)
...
![Verwenden des Dialogfelds „An den Prozess anhängen“ zum Anfügen an eine Azure-Website](~/python/media/azure-remote-debugging-manual-attach.png)
