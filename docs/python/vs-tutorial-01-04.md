---
title: Arbeiten mit Python in Visual Studio, Schritt 4 | Microsoft-Dokumentation
ms.custom: 
ms.date: 09/26/2017
ms.reviewer: 
ms.suite: 
...
**Vorheriger Schritt: [Verwenden des interaktiven REPL-Fensters](vs-tutorial-01-03.md)**
