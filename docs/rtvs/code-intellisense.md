...
![IntelliSense, das eine Funktionssignatur zeigt](~/docs/rtvs/media/intellisense-function-signature.png) 
...
![IntelliSense-Menü für automatische Vervollständigung](~/docs/rtvs/media/intellisense-auto-complete-menu.png)
...
![IntelliSense-Vorschläge für Objektmember](~/docs/rtvs/media/intellisense-auto-complete-r-objects.png)
...
![IntelliSense-Signaturhilfe für eine Funktion](~/docs/rtvs/media/intellisense-function-signature.png)
...
![IntelliSense für benutzerdefinierte Funktionen](~/docs/rtvs/media/intellisense-same-file-functions.png)

![IntelliSense Parameterabschluss für benutzerdefinierte Funktionen](~/docs/rtvs/media/intellisense-parameter-completion.png)

IntelliSense gilt auch für Variablen in der gleichen Datei und der aktuellen Sitzung:

![IntelliSense Variablenabschluss](~/docs/rtvs/media/intellisense-variable-completion.png)
...
![Smarttags für R im Editor](~/docs/rtvs/media/intellisense-smart-tags.png)
