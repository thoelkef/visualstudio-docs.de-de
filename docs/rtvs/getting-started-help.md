...
![Hilfefenster in Visual Studio](~/rtvs/media/help-window.png)
...
![Die Suchergebnisse der Hilfe](~/rtvs/media/help-search1.png)
...
![Suchergebnisse der Hilfe über das Eingabefeld](~/rtvs/media/help-search2.png)
...
- Führen Sie einen Rechtsklick auf einen Suchbegriff (z.B. eine Funktion) aus, und wählen Sie den Befehl **Hilfe zu** aus, oder drücken Sie alternativ F1, um die Hilfe für diese Funktion aufzurufen. Sie können **Hilfe zu** auch für jede Auswahl aufrufen.
    ...
    ![Aufrufen der Hilfe über ein Kontextmenü, das mit einem Rechtsklick aufgerufen wird](~/rtvs/media/help-right-click.png)
...
![Websuchergebnisse in Visual Studio](~/rtvs/media/help-web-search-results.png)
...
![Ändern der Option „Zeichenfolge der F1-Websuche“](~/rtvs/media/options-dialog.png)
