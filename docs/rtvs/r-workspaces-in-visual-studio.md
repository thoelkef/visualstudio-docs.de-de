...
Mit Remotearbeitsbereichen können Sie auf einem Remotecomputer eine Verbindung zu einer R-Sitzung herstellen. (Informationen zum Konfigurieren eines Computers dafür finden Sie unter [Setting up remote workspaces (Einrichten von Remotearbeitsbereichen)](setting-up-remote-r-workspaces.md).)
