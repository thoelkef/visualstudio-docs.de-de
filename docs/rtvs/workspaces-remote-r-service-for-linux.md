---
title: Einrichten von Remote R Service unter Linux | Microsoft-Dokumentation
ms.custom: 
ms.date: 12/04/2017
ms.reviewer: 
ms.suite: 
...
Remote R Service für Linux ist derzeit als Paket des Typs „rtvs-daemon“ verfügbar. Unterstützung des Daemons wurde für Ubuntu 16.04, 16.10 LTS Desktop und Server sowie das Windows-Subsystem für Linux mit Ubuntu getestet. Der Großteil dieses Themas besteht aus Anweisungen zum Einrichten von Remote R Service für diese verschiedenen Systeme.
...
1. Befolgen Sie die WSL-Installationsanweisungen für entweder [Windows 10](https://msdn.microsoft.com/commandline/wsl/install-win10) oder [Windows Server](https://msdn.microsoft.com/en-us/commandline/wsl/install-on-server).
