...
|![Foren](../sharepoint/media/vs-icon-forums.gif "Foren")|**Foren**<br /><br /> -   [SharePoint-Entwicklung mit Visual Studio](http://social.msdn.microsoft.com/Forums/vssharepointdevelopment/threads)<br />-   [SharePoint 2010](http://social.msdn.microsoft.com/Forums/category/sharepoint2010,sharepoint/)|  
|![Training](../sharepoint/media/vs-icon-training.gif "Training")|**Blogs**<br /><br /> -   [Blog zu Visual Studio SharePoint-Entwicklung](http://blogs.msdn.com/b/vssharepointtoolsblog/)|  
|![Wie führe ich? Videos](../sharepoint/media/vs-icon-howdoivideos.gif "durchführen? Videos")|**Wie führe ich? Videos**<br /><br /> -   [Wie erstelle ich visuelle Webparts für SharePoint 2010 in Visual Studio 2010?](http://msdn.microsoft.com/vstudio/ff623014.aspx)<br />-   [Anleitung: Erstellen von Inhaltstypen für SharePoint 2010 in Visual Studio 2010](http://msdn.microsoft.com/vstudio/ff623016.aspx)<br />-   [Anleitung: Erstellen von Websitedefinitionen für SharePoint 2010 in Visual Studio 2010](http://msdn.microsoft.com/vstudio/ff623012.aspx)<br />-   [Anleitung: Erstellen eines Business Data Connectivity-Modells für SharePoint 2010 unter Verwendung von Visual Studio 2010](http://msdn.microsoft.com/vstudio/ff623022.aspx)|  
