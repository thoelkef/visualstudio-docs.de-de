...
## <a name="create-deployment-configurations"></a>Erstellen von Bereitstellungskonfigurationen
...
## <a name="run-code-when-a-sharepoint-solution-is-deployed-or-retracted"></a>Führen Sie Code aus, wenn eine SharePoint-Lösung bereitgestellt oder zurückgezogen wird
...
## <a name="run-command-line-operations-before-or-after-a-project-is-deployed"></a>Führen Sie über die Befehlszeile Vorgänge aus, bevor oder nachdem ein Projekt bereitgestellt wird
