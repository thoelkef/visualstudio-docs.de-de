---
title: "Vorgehensweise: Erstellen von SharePoint-Lösungen | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
1.  Entscheiden Sie, ob Sie eine Debug- oder ein Releasebuild erstellt werden. Weitere Informationen finden Sie unter [Debuggerprojekteinstellungen](/visualstudio/debugger/debugger-project-settings).  
