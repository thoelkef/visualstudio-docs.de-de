---
title: "Importieren von Elementen aus einer vorhandenen SharePoint-Website"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "SharePoint-Entwicklung in Visual Studio, Importieren von WSP-Dateien"
...
## Unterstützte SharePoint\-Projektmappen \(SharePoint\-Lösungen\)  
...
### Was sind Funktionen \(Features\)?  
 ...
 Weitere Informationen zu Funktionen finden Sie unter [Developing SharePoint Solutions](../sharepoint/developing-sharepoint-solutions.md) und [Verwenden von Features](http://go.microsoft.com/fwlink/?LinkID=147704).  
