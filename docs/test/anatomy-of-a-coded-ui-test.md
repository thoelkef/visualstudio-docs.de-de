...
## Inhalt eines Tests der programmierten UI  
 Wenn Sie einen Test der programmierten UI erstellen, erstellt der **Coded UI\-Test\-Generator** eine Zuordnung der getesteten Benutzeroberfläche \(UI\) sowie die Testmethoden, Parameter und Assertionen für alle Tests.  Zudem wird eine Klassendatei für jeden Test erstellt.  
...
###  <a name="UIMapDesignerFile"></a> UIMap.Designer.cs  
 Diese Datei enthält Code, der beim Erstellen eines Tests automatisch vom **Coded UI\-Test\-Generator** erstellt wird.  Diese Datei wird jedes Mal neu erstellt, wenn ein Test geändert wird. In dieser Datei kann daher kein Code hinzugefügt oder geändert werden.  
...
#### UIMap\-Klasse  
 In dieser Klasse können Sie benutzerdefinierten Code erstellen, um die Funktion der <xref:Microsoft.VisualStudio.TestTools.UITest.Common.UIMap.UIMap>\-Klasse zu erweitern.  Der in dieser Datei erstellte Code wird nicht bei jeder Änderung eines Tests vom **Coded UI\-Test\-Generator** erneut generiert.  
...
###  <a name="CodedUITestCS"></a> "CodedUITest1.cs"  
 Diese Datei wird vom **Coded UI\-Test\-Generator** generiert, aber nicht bei jeder Änderung des Tests neu erstellt. Der Code in dieser Datei kann daher geändert werden.  Der Name der Datei wird auf Grundlage des Namens generiert, den Sie beim Erstellen für den Test angegeben haben.  
