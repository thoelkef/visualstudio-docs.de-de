---
title: "Codegenerierung, Kompilierung und Benennungskonventionen in Microsoft Fakes | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
|Statischer **Konstruktor**|`.cctor`|`StaticConstructor`|  
|**Accessor** mit einem Methodennamen, der aus zwei durch "\_" getrennten Teilen besteht \(z. B. Eigenschaftengetter\)|*kind\_name* \(kommt häufig vor, wird aber durch ECMA nicht erzwungen\)|*NameKind*, in dem beide Teile groß geschrieben und vertauscht werden|  
