...
### <a name="logger-run-settings"></a>Protokollierungslaufeinstellungen
...
Der Abschnitt `LoggerRunSettings` definiert eine oder mehrere Protokollierungen, die für den Testlauf verwendet werden. Die häufigsten Protokollierungen sind Console, TRX und HTML. 
