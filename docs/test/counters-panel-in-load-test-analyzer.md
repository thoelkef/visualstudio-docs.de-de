---
title: Indikatorenfenster für die Analyse von Auslastungstests in Visual Studio
ms.date: 10/19/2016
ms.topic: conceptual
helpviewer_keywords:
...
Im **Indikatorenfenster** wird eine strukturierte Ansicht aller Leistungsindikatoren angezeigt, die während des Auslastungstests erfasst wurden. Sie können das **Indikatorenfenster** ein- oder ausblenden, indem Sie auf der Symbolleiste **Auslastungstest-Analyzer** auf **Indikatorenfenster anzeigen** klicken.
