---
title: "Testtools, -szenarios und -funktionen für Entwickler | Microsoft-Dokumentation"
ms.custom: 
ms.date: 05/02/2017
ms.reviewer: 
ms.suite: 
...
**Szenarios und Funktionen**:

* [Verhindern von Regressionen und Erreichen von Code Coverage mit IntelliTest](#intellitest)
* [Testen der Benutzeroberfläche mit programmierter UI und Selenium](#ui-testing)
* [Effektive Unittest mit Code Coverage von Visual Studio](#unit-testing)
* [Unittests mit jeden Framework mithilfe des leistungsstarken Test-Explorers](#test-explorer)
...
Verbessern Sie die Abdeckung und vermeiden Sie Regressionen mit IntelliTest.
Mit IntelliTest wird der Aufwand zum Erstellen und Verwalten von Unittests für neuen oder vorhandenen Code drastisch verringert. 
...
Sie können Benutzeroberflächentests für eine Vielzahl von Technologien automatisieren, so z.B. für XAML-basierte Windows Store-Apps, Browser-Apps und SharePoint-Apps.
...
* [Testen von Windows Store-Apps mit Tests der programmierten UI](test-windows-store-8-1-apps-with-coded-ui-tests.md)
...
* [Schreiben von Unittests für C/C++](writing-unit-tests-for-c-cpp-with-the-microsoft-unit-testing-framework-for-cpp.md)
