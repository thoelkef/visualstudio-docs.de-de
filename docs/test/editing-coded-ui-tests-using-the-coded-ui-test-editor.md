---
title: Bearbeiten von Tests der programmierten UI in Visual Studio
ms.date: 11/04/2016
...
Möglicherweise verwenden Sie eine Version von Visual Studio Enterprise, die älter als 2012 ist. Der Editor für Tests der programmierten UI stand auch in Visual Studio 2010 Feature Pack 2 mit einem MSDN-Abonnement zur Verfügung. Weitere Informationen finden Sie unter [Microsoft Visual Studio 2010 Feature Pack 2](http://go.microsoft.com/fwlink/?LinkID=204119).
...
- Wenn das Fenster „Eigenschaften“ nicht angezeigt wird, halten Sie **ALT** gedrückt und drücken Sie die **EINGABETASTE**, oder drücken Sie alternativ **F4**.

- Wählen Sie **Rückgängig** aus dem Menü **Bearbeiten** aus, oder drücken Sie STRG+Z, wenn Sie die an den Eigenschaften vorgenommenen Änderungen rückgängig machen möchten.

- Mit der Schaltfläche **Suchen** in der Symbolleiste des Editors für Tests der programmierten UI können Sie das Tool zum Suchen und Ersetzen in Visual Studio öffnen. Anschließend können Sie mit dem Steuerelement „Suchen“ nach einer UI-Aktion im Editor für Tests der programmierten UI suchen. Sie können z.B. die Option „Auf die Schaltfläche ‚Anmelden‘ klicken“ suchen. Dies kann bei umfangreichen Tests hilfreich sein. Beachten Sie, dass Sie die Ersetzungsfunktion nicht im Tool zum Suchen und Ersetzen im Editor für Tests der programmierten UI verwenden können. Weitere Informationen finden Sie unter „Steuerelement ‚Suchen‘“ in [Finding and Replacing Text](../ide/finding-and-replacing-text.md).

- Manchmal kann die Darstellung der Position der Steuerelemente in der Benutzeroberfläche der getesteten Anwendung schwierig sein. Zu den Funktionen des Editors für Tests der programmierten UI zählen die Möglichkeiten zum Auswählen eines Steuerelements, das in der UI-Steuerelementzuordnung aufgeführt ist, und zum Anzeigen der Position in der getesteten Anwendung. Weitere Information finden Sie unter [Suchen eines UI-Steuerelements in der getesteten Anwendung](#CodedUITestEditor_LocateUIControl) im weiteren Verlauf dieses Themas.

- Möglicherweise müssen Sie das Containersteuerelement erweitern, das das zu bearbeitende Steuerelement enthält. Weitere Informationen finden Sie unter [Suchen eines Steuerelements und seiner Nachfolgerelemente](#CodedUITestEditor_LocateDecendants) im weiteren Verlauf dieses Themas.
...
- Wenn Sie die Aufteilung rückgängig machen möchten, wählen Sie **Rückgängig** im Menü **Bearbeiten** aus, oder drücken Sie STRG+Z.

- Sie können die neue Methode umbenennen. Wählen Sie sie im Bereich „UI-Aktionen“, und wählen Sie die Schaltfläche **Umbenennen** in der Symbolleiste des Editors für Tests der programmierten UI.
