...
## <a name="move-a-test-method-to-the-uimap-file-to-facilitate-customization"></a>Eine Testmethode in die UIMap-Datei verschieben, um Anpassungen zu vereinfachen
