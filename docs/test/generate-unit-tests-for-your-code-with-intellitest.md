---
title: "Generieren von Komponententests f&#252;r Code mit IntelliTest | Microsoft Docs"
ms.custom: ""
ms.date: "2015-10-05"
ms.reviewer: ""
ms.suite: ""
...
## Erste Schritte mit IntelliTest  
...
2.  Klicken Sie mit der rechten Maustaste auf eine Methode im Code, und wählen Sie **IntelliTest ausführen**, um Komponententests für den Code in der Methode zu generieren.  
     ...
     ![Klicken Sie mit der rechten Maustaste in Ihrer Methode zum Generieren der Komponententests](../test/media/runpex.png "RunPEX")  
...
1.  Wählen Sie die Datenzeilen aus, die Sie mit dem parametrisierten Komponententest in einem Testprojekt speichern möchten.  
     ...
     ![Wählen Sie "Tests" aus, klicken Sie mit der rechten Maustaste, und wählen Sie "Speichern" aus](../test/media/savepextests.png "SavePEXTests")  
