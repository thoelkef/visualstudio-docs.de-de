---
title: 'Gewusst wie: Löschen von Auslastungstestergebnissen aus einem Repository'
ms.date: 10/19/2016
ms.topic: conceptual
helpviewer_keywords:
- results, load test
