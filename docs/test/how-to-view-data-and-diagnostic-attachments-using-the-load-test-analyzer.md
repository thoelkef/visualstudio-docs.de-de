...
ms.locfileid: "39382463"
---
# <a name="how-to-view-data-and-diagnostic-attachments-using-the-load-test-analyzer"></a>Vorgehensweise: Anzeigen von Daten- und Diagnoseanlagen im Auslastungstest-Analyzer
...
Ein weiteres Beispiel ist ein Auslastungstest, dessen Testeinstellung den Adapter "IntelliTrace" enthält. Über den Adapter „IntelliTrace“ können Sie die Seite **IntelliTrace-Zusammenfassung** öffnen.

![IntelliTrace-Zusammenfassung](../test/media/load_intellitrace.png)

Weitere Informationen finden Sie unter [Erfassen von Diagnoseinformationen mithilfe von Testeinstellungen](../test/collect-diagnostic-information-using-test-settings.md) und [Sammeln von IntelliTrace-Daten](../test/how-to-collect-intellitrace-data-to-help-debug-difficult-issues.md).
