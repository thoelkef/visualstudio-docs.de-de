...
## <a name="including-or-excluding-tests-not-working"></a>Ein- oder Ausschließen von Tests funktioniert nicht
...
Sie haben mehrere Möglichkeiten, um ausführlichere Protokolle zu erfassen:
