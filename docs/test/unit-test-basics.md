...
|||  
|-|-|  
|![Gruppenschaltfläche „Test-Explorer“](~/docs/test/media/ute_groupby_btn.png "UTE_GroupBy_btn")|Wählen Sie die Schaltfläche **Gruppieren nach** aus, um die Tests nach Kategorie zu gruppieren.|  
