---
title: "Ausf&#252;hren von Komponententests f&#252;r vorhandene C++-Anwendungen mit dem Test-Explorer | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
## Entscheiden, wie der Code getestet werden soll  
 Öffnen Sie das vorhandene C\+\+\-Projekt. Schauen Sie es sich genau an, um zu entscheiden, wie Sie die Komponententests hinzufügen möchten.  Eventuell möchten Sie Modellierungstools verwenden, die Ihnen dabei helfen, Abhängigkeiten im Code aufzufinden und zu verstehen, wie diese Teile interagieren.  Weitere Informationen finden Sie unter [Visualize code](../modeling/visualize-code.md).  
...
1.  Ändern Sie die Produktcodeprojekteigenschaften, um die Header und Bibliotheksdateien einzuschließen, die für die Komponententests erforderlich sind.  
...
2.  Fügen Sie den Komponententestcodedateien Testklassen und \-methoden hinzu.  Zum Beispiel:  
 ...
 Weitere Informationen finden Sie unter [Unit testing native code with Test Explorer](http://msdn.microsoft.com/de-de/8a09d6d8-3613-49d8-9ffe-11375ac4736c).  
...
2.  Wählen Sie im Test\-Explorer **Alle ausführen** aus.  
 ...
 Weitere Informationen finden Sie unter [Schnellstart: Testgesteuerte Entwicklung mit dem Test\-Explorer](../test/quick-start-test-driven-development-with-test-explorer.md).