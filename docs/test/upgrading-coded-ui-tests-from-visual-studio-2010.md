---
title: "Upgrade der Tests der codierten UI von Visual Studio 2010 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
> [!NOTE]
>  Visual Studio enthält mehr als ein Typ des Testprojekts. Wenn Sie einen neuen Test der programmierten UI erstellen, wird er in einem Projekttyp für den Test der programmierten UI erstellt. Weitere Informationen finden Sie unter [Upgrade der Tests von früheren Visual Studio\-Versionen](http://msdn.microsoft.com/de-de/e9c8b7f6-bd72-448e-8edb-d090dcc5cf52).  
...
##  <a name="UpgradingCodedUIFromVS2010_Update"></a> Visual Studio 2010 SP1 Update  
 Ein Update für [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1 mit Kompatibilitätsunterstützung für Visual Studio 2012 und Windows 8 steht als Download im [Microsoft Download Center](http://www.microsoft.com/download/details.aspx?id=34677) und als Visual Studio\-Update bereit.  
  
 Nach dem Anwenden des Updates werden die folgenden [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1\-Toolfeatures für den Test der programmierten UI für Windows 8 verbessert:  
...
-   **Codeabdeckung:** Unfähigkeit eine durch Visual Studio 2012 in [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)] SP1 erstellte Codeabdeckungsdatei \(.coverage\) zu öffnen.  
  
-   **Isolierte Testartefakte:** Ihr Team verfügt über ein Testartefakt, das in TFS 2010 \(Team Foundation Server\) einem ungültigen Benutzer zugewiesen ist. Dies ist beispielsweise der Fall, wenn ein Benutzer das Unternehmen verlassen hat, diesem jedoch weiterhin ein Testfall zugewiesen ist. Sie aktualisieren TFS 2010 auf TFS 2012. Sie verwenden [!INCLUDE[TCMext](../modeling/includes/tcmext_md.md)] 2010, um eine Verbindung zum aktualisierten TFS\-Server herzustellen. Sie können das Testartefakt mithilfe von [!INCLUDE[TCMext](../modeling/includes/tcmext_md.md)] 2010 anderen TFS\-Benutzern nicht zuweisen.  
...
## Siehe auch  
 ...
 [Upgrade der Tests von früheren Visual Studio\-Versionen](http://msdn.microsoft.com/de-de/e9c8b7f6-bd72-448e-8edb-d090dcc5cf52)   
