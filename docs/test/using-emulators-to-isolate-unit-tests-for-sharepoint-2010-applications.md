...
## <a name="using-testinitialize-and-testcleanup-attributes-to-create-a-dual-use-test-class"></a>Verwenden der Attribute "TestInitialize" und "TestCleanup" zur Erstellung einer zweifach verwendbaren Testklasse
