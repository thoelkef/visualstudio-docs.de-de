---
title: "Exemplarische Vorgehensweise: Erstellen und Ausf&#252;hren von Komponententests f&#252;r verwalteten Code | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
helpviewer_keywords: 
  ...
  - "Komponententests, Dokumenterstellung"
...
> [!NOTE]
>  Informationen zum Ausführen von Tests über die Befehlszeile finden Sie unter [Exemplarische Vorgehensweise: Verwenden des Befehlszeilen\-Testprogramms](../Topic/Walkthrough:%20using%20the%20command-line%20test%20utility.md).  
  
## Vorbereitungsmaßnahmen  
  
-   Das Projekt "Bank". Siehe [Beispielprojekt zum Erstellen von Komponententests](../test/sample-project-for-creating-unit-tests.md).  
  
##  <a name="BKMK_Prepare_the_walkthrough"></a> Die exemplarische Vorgehensweise vorbereiten  
...
6.  Kopieren Sie den Quellcode aus [Beispielprojekt zum Erstellen von Komponententests](../test/sample-project-for-creating-unit-tests.md).  
  
7.  Ersetzen Sie den ursprünglichen Inhalt von Class1.cs mit dem Code aus [Beispielprojekt zum Erstellen von Komponententests](../test/sample-project-for-creating-unit-tests.md).  
 ...
 **Voraussetzung**: Führen Sie die im Verfahren "[Die exemplarische Vorgehensweise vorbereiten](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md#BKMK_Prepare_the_walkthrough)" angegebenen Schritte aus.  
  
#### So erstellen Sie ein Komponententestprojekt  
 ...
 **Analysieren der Testergebnisse**  
 ...
 Das Testergebnis enthält eine Meldung mit der Fehlerbeschreibung. Für die `AreEquals`\-Methode wird in der Meldung angezeigt, was erwartet wurde \(Parameter **Erwartet\<*XXX*\>**\) und was tatsächlich gefunden wurde \(Parameter **Tatsächlich\<*YYY*\>**\). Erwartet wurde, dass das neue Guthaben geringer ist als das Startguthaben. Stattdessen hat es sich um den Betrag der Abbuchung vergrößert.  
