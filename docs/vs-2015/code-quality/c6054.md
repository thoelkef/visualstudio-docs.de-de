...
Warnung C6054: Zeichenfolge \<variable> darf nicht mit 0 (null) beendet werden.  
...
```  
 ...
 Um diese Warnung zu korrigieren, müssen Sie `wcArray` vor dem Aufrufen der Funktion NULL beenden, `func()` wie im folgenden Beispielcode gezeigt:  
