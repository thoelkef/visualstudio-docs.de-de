...
```  
 ...
 Ein vollständiges Beispiel zum Erstellen der Sicherheitsbeschreibung finden Sie unter [Erstellen einer Sicherheitsbeschreibung für ein neues Objekt in C++](https://msdn.microsoft.com/library/aa446595.aspx). Weitere Informationen finden Sie unter [Creating a DACL](https://msdn.microsoft.com/library/ms717798.aspx).
