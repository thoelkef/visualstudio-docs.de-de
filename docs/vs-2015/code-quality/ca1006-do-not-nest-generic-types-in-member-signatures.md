...
Die neueste Version dieses Themas finden Sie unter [CA1006: generische Typen in Membersignaturen nicht schachteln](https://docs.microsoft.com/visualstudio/code-quality/ca1006-do-not-nest-generic-types-in-member-signatures).
