---
title: 'CA1010: Auflistungen müssen generische Schnittstelle implementieren | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 2018-06-30
...
Die neueste Version dieses Themas finden Sie unter [CA1010: Auflistungen müssen eine generische Schnittstelle implementieren](https://docs.microsoft.com/visualstudio/code-quality/ca1010-collections-should-implement-generic-interface).
