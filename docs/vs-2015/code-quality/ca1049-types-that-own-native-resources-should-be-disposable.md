---
title: 'CA1049: Typen, die systemeigene Ressourcen besitzen, sollten gelöscht werden | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 2018-06-30
...
Die neueste Version dieses Themas finden Sie unter [CA1049: Typen, deren Besitzer Sie sind, sollten systemeigene Ressourcen gelöscht werden](https://docs.microsoft.com/visualstudio/code-quality/ca1049-types-that-own-native-resources-should-be-disposable).
