...
Die neueste Version dieses Themas finden Sie unter [CA1055: URI zurückgegeben Werte sollten keine Zeichenfolgen sein](https://docs.microsoft.com/visualstudio/code-quality/ca1055-uri-return-values-should-not-be-strings).
