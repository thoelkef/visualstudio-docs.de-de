...
|Element|Wert|
|-|-|
|TypName|MovePInvokesToNativeMethodsClass|
|CheckId|CA1060|
...
## <a name="rule-description"></a>Beschreibung der Regel
 Platt Form Aufruf Methoden, wie z. b. solche, die mit dem-Attribut gekennzeichnet sind <xref:System.Runtime.InteropServices.DllImportAttribute?displayProperty=fullName> , oder Methoden, die mit dem- `Declare` Schlüsselwort in definiert werden [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] , greifen auf nicht verwalteten Code zu. Diese Methoden sollten einer der folgenden Klassen unterliegen:
