---
title: 'CA1063: Implementieren IDisposable korrekt | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47589128"
---
# <a name="ca1063-implement-idisposable-correctly"></a>CA1063: IDisposable korrekt implementieren
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [CA1063: Implementieren von IDisposable korrekt](https://docs.microsoft.com/visualstudio/code-quality/ca1063-implement-idisposable-correctly).
