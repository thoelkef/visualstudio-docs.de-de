...
ms.locfileid: "47589289"
---
# <a name="ca1305-specify-iformatprovider"></a>CA1305: IFormatProvider angeben
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [CA1305: IFormatProvider angeben](https://docs.microsoft.com/visualstudio/code-quality/ca1305-specify-iformatprovider).
...
## <a name="see-also"></a>Siehe auch
 [NIB: Verwenden der CultureInfo-Klasse](http://msdn.microsoft.com/en-us/d4329e34-64c3-4d1e-8c73-5b0ee626ba7a)
