...
Die neueste Version dieses Themas finden Sie unter [CA1403: Typen mit automatischem Layout sollten nicht COM sichtbar sein](https://docs.microsoft.com/visualstudio/code-quality/ca1403-auto-layout-types-should-not-be-com-visible).
