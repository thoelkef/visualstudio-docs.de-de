...
Die neueste Version dieses Themas finden Sie unter [CA1712: Enum-Werte mit Typnamen nicht Präfix](https://docs.microsoft.com/visualstudio/code-quality/ca1712-do-not-prefix-enum-values-with-type-name).
