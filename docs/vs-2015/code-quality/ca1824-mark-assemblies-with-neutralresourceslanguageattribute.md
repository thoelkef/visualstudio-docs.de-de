...
Die neueste Version dieses Themas finden Sie unter [CA1824: Assemblys mit NeutralResourcesLanguageAttribute markieren](https://docs.microsoft.com/visualstudio/code-quality/ca1824-mark-assemblies-with-neutralresourceslanguageattribute).
