...
Die neueste Version dieses Themas finden Sie unter [CA2006: SafeHandle verwenden, um systemeigene Ressourcen zu kapseln](https://docs.microsoft.com/visualstudio/code-quality/ca2006-use-safehandle-to-encapsulate-native-resources).
