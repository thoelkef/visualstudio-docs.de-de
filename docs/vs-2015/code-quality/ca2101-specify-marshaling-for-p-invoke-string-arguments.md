...
Die neueste Version dieses Themas finden Sie unter [CA2101: Marshalling für P / Invoke-Zeichenfolgenargumente Geben Sie](https://docs.microsoft.com/visualstudio/code-quality/ca2101-specify-marshaling-for-p-invoke-string-arguments).
