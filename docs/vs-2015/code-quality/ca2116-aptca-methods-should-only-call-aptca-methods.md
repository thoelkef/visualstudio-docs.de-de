...
Die neueste Version dieses Themas finden Sie unter [CA2116: APTCA-Methoden sollten nur APTCA-Methoden aufrufen](https://docs.microsoft.com/visualstudio/code-quality/ca2116-aptca-methods-should-only-call-aptca-methods).
