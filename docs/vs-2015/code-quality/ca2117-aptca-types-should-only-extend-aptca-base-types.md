...
Die neueste Version dieses Themas finden Sie unter [CA2117: APTCA-Typen sollten nur APTCA-Basistypen erweitern](https://docs.microsoft.com/visualstudio/code-quality/ca2117-aptca-types-should-only-extend-aptca-base-types).
