...
Die neueste Version dieses Themas finden Sie unter [CA2122: Methoden mit Linkaufrufen nicht indirekt verfügbar machen](https://docs.microsoft.com/visualstudio/code-quality/ca2122-do-not-indirectly-expose-methods-with-link-demands).
