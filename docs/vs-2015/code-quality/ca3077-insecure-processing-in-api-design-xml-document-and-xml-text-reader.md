...
- Verwenden Sie  <xref:System.Xml.XmlSecureResolver>instead von XmlResolver, um die Ressourcen einzuschränken, auf die der XmlTextReader zugreifen kann.
