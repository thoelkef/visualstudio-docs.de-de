...
|----------|------------------------|  
|**Erstellen Sie und verwenden Sie die Check-in-Richtlinien:** Sie erstellen die Check-in-Richtlinien mit den Teamprojekteinstellungen von [!INCLUDE[esprscc](../includes/esprscc-md.md)].|[Festlegen und Erzwingen von Quality Gates](https://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  
...
|Aufgabe|Unterstützender Inhalt|  
|----------|------------------------|  
|**Richten Sie Ihre Entwicklungsumgebung:** Bevor Sie können Code erstellen oder ändern, müssen Sie richten Sie Ihre Entwicklung und testumgebungen mit dem entsprechenden Quellcode. Wenn Sie Datenbanken verwenden, benötigen Sie außerdem Zugriff auf die Offlinedarstellung der Datenbanken.|[Einrichten von Entwicklungsumgebungen](https://msdn.microsoft.com/7b686610-d379-4ca0-9608-73ef0e576e3a)|  
