...
ms.locfileid: "47524039"
---
# <a name="globalization-warnings"></a>Globalisierungswarnungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Globalisierungswarnungen](https://docs.microsoft.com/visualstudio/code-quality/globalization-warnings).  
