...
ms.locfileid: "47512146"
---
# <a name="native-minimum-rules-rule-set"></a>Regelsatz für systemeigene Mindestregeln
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Regelsatz für systemeigene Mindestregeln](https://docs.microsoft.com/visualstudio/code-quality/native-minimum-rules-rule-set).  
