...
ms.locfileid: "47524263"
---
# <a name="native-recommended-rules-rule-set"></a>Regelsatz für systemeigene empfohlene Regeln
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Regelsatz für systemeigene empfohlene Regeln](https://docs.microsoft.com/visualstudio/code-quality/native-recommended-rules-rule-set).  
