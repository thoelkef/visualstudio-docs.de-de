...
ms.locfileid: "47515052"
---
# <a name="quick-start-code-analysis-for-cc"></a>Schnellstart: Codeanalyse für C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schnellstart: Codeanalyse für C/C++-](https://docs.microsoft.com/visualstudio/code-quality/quick-start-code-analysis-for-c-cpp).  
