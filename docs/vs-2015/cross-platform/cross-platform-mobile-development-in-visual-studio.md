...
Die neueste Version dieses Themas finden Sie unter [Cross-Platform Mobile Development in Visual Studio](https://docs.microsoft.com/visualstudio/cross-platform/cross-platform-mobile-development-in-visual-studio).  
