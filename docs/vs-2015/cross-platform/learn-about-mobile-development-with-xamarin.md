...
Die neueste Version dieses Themas finden Sie unter [erfahren Sie mehr über die mobile Entwicklung mit Xamarin](https://docs.microsoft.com/visualstudio/cross-platform/learn-about-mobile-development-with-xamarin).  
