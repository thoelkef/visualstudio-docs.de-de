...
Die neueste Version dieses Themas finden Sie unter [Systemanforderungen für Visual Studio-Emulator für Android](https://docs.microsoft.com/visualstudio/cross-platform/system-requirements-for-the-visual-studio-emulator-for-android).  
