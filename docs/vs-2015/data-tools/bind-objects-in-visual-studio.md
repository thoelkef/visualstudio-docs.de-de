...
> [!NOTE]
>  Um besser zu verstehen, und geben den Kontext für die Beispiele auf dieser Seite, wird empfohlen, dass Sie folgende Aufgaben auszuführen: [Exemplarische Vorgehensweise: Herstellen einer Verbindung mit Daten in Objekten (Windows Forms)](http://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05). Diese exemplarische Vorgehensweise erstellt, die hier besprochenen Objekte.  
