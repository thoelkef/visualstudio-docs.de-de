---
title: Binden von Windows Forms-Steuerelementen an Daten in Visual Studio | Microsoft-Dokumentation
ms.custom: ''
ms.date: 2018-06-30
...
Die neueste Version dieses Themas finden Sie unter [Binden von Windows Forms-Steuerelementen an Daten in Visual Studio](https://docs.microsoft.com/visualstudio/data-tools/bind-windows-forms-controls-to-data-in-visual-studio).  
