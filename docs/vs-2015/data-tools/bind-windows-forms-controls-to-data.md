...
ms.locfileid: "47512712"
---
# <a name="bind-windows-forms-controls-to-data"></a>Binden von Windows Forms-Steuerelementen an Daten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Binden von Windows Forms-Steuerelementen an Daten](https://docs.microsoft.com/visualstudio/data-tools/bind-windows-forms-controls-to-data).  
