---
title: Datasettools in Visual Studio | Microsoft-Dokumentation
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47509406"
---
# <a name="dataset-tools-in-visual-studio"></a>Datasettools in Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [datasettools in Visual Studio](https://docs.microsoft.com/visualstudio/data-tools/dataset-tools-in-visual-studio).  
