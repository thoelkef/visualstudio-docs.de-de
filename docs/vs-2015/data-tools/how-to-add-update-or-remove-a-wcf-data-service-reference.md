...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: hinzufügen, aktualisieren oder Entfernen eines WCF-Datendienstverweises](https://docs.microsoft.com/visualstudio/data-tools/how-to-add-update-or-remove-a-wcf-data-service-reference).  
