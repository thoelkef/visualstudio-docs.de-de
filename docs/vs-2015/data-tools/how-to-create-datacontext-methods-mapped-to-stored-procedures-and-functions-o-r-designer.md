...
## <a name="creating-datacontext-methods"></a>Erstellen von DataContext-Methoden
 Sie können <xref:System.Data.Linq.DataContext> Methoden erstellen, indem Sie gespeicherte Prozeduren oder Funktionen von **Server-Explorer/Datenbank-Explorer** auf die [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] ziehen.
