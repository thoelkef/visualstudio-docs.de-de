...
Mindestens eines der Elemente, die aus **Server-Explorer** /**Datenbank-Explorer** auf die [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] gezogen wurden, enthält einen Datentyp, der vom [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] nicht unterstützt wird (z. b. [CLR-benutzerdefinierte Typen](https://msdn.microsoft.com/library/9f70e0b0-3a0d-4eb1-b914-07a5d0c167c2)).
