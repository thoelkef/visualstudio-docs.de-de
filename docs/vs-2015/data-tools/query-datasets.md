...
ms.locfileid: "47514903"
---
# <a name="query-datasets"></a>Abfragedatasets
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Abfragedatasets](https://docs.microsoft.com/visualstudio/data-tools/query-datasets).  
