...
ms.locfileid: "47509394"
---
# <a name="save-a-dataset-as-xml"></a>Speichern eines Datasets als XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Speichern eines Datasets als XML](https://docs.microsoft.com/visualstudio/data-tools/save-a-dataset-as-xml).  
