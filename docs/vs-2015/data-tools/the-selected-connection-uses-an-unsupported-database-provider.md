...
Die neueste Version dieses Themas finden Sie unter [die ausgewählte Verbindung nutzt einen nicht unterstützten Datenbankanbieter](https://docs.microsoft.com/visualstudio/data-tools/the-selected-connection-uses-an-unsupported-database-provider).  
