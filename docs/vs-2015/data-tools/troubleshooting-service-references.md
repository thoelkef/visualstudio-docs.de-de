...
Die neueste Version dieses Themas finden Sie unter [Problembehandlung bei Dienstverweisen](https://docs.microsoft.com/visualstudio/data-tools/troubleshooting-service-references).
