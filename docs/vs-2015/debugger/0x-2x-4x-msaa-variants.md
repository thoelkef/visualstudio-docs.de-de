...
ms.locfileid: "47524877"
---
# <a name="0x2x4x-msaa-variants"></a>0x/2x/4x-MSAA-Varianten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [0 x-2 x-4 X-MSAA-Varianten](https://docs.microsoft.com/visualstudio/debugger/graphics/0x-2x-4x-msaa-variants).  
