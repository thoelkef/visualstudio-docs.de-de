...
ms.locfileid: "47515406"
---
# <a name="com-server-and-container-debugging"></a>Debuggen von COM-Servern und -Containern
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Debuggen COM-Servern und-Containern](https://docs.microsoft.com/visualstudio/debugger/com-server-and-container-debugging).  
