...
Die neueste Version dieses Themas finden Sie unter [Erstellen benutzerdefinierter Ansichten von verwalteten Objekten](https://docs.microsoft.com/visualstudio/debugger/create-custom-views-of-dot-managed-objects).  
