...
ms.locfileid: "47516336"
---
# <a name="function-debug-interface-access-sdk"></a>Funktion (Debug Interface Access SDK)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Funktion (Debug Interface Access SDK)](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/function-debug-interface-access-sdk).  
