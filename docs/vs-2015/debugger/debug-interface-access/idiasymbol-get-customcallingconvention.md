...
#### <a name="parameters"></a>Parameter  
 `pFlag`  
 vorgenommen Gibt zurück `TRUE` , wenn die Funktion über eine benutzerdefinierte Aufruf Konvention verfügt; andernfalls wird zurückgegeben `FALSE` , die Funktion verfügt über eine bekannte Aufruf Konvention.  
