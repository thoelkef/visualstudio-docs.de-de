...
#### <a name="parameters"></a>Parameter  
 `pRetVal`  
 vorgenommen Gibt zurück, `TRUE` Wenn für den benutzerdefinierten Datentyp Zuweisungs Operatoren definiert sind; andernfalls wird zurückgegeben `FALSE` .  
