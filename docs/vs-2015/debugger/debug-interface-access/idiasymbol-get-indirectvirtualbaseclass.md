...
#### <a name="parameters"></a>Parameter  
 `pRetVal`  
 vorgenommen Gibt zurück, `TRUE` Wenn der benutzerdefinierte Datentyp eine indirekte virtuelle Basisklasse ist; andernfalls wird zurückgegeben `FALSE` .  
