...
#### <a name="parameters"></a>Parameter  
 `pFlag`  
 vorgenommen Gibt zurück, `TRUE` Wenn die Funktion über eine Return from Interrupt-Anweisung verfügt; andernfalls wird zurückgegeben `FALSE` .  
