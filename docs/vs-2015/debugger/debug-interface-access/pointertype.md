...
ms.locfileid: "47524657"
---
# <a name="pointertype"></a>PointerType
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [PointerType](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/pointertype).  
