 ...
 **Nach folgenden Quelldateien nicht suchen**  
 Geben Sie hier die Namen aller Quelldateien ein, die vom Debugger nicht gelesen werden sollen. Wird eine dieser Dateien vom Debugger in einem der oben angegebenen Verzeichnisse gefunden, wird diese ignoriert. Wenn die **Quellcode suchen** Dialogfeld angezeigt wird, während Sie Debuggen und Sie auf **Abbrechen**, die Datei, die Sie gesucht wird, damit der Debugger nicht länger wird nach dieser Datei sucht dieser Liste hinzugefügt.  
