...
|[Schnellstart: Debuggen von JavaScript](../debugger/quickstart-debug-javascript-using-the-console.md)|Debuggen von JavaScript mithilfe der Konsole zeigt, wie Sie eine JavaScript-App mithilfe von [JavaScript-Konsolen Befehlen](../debugger/javascript-console-commands.md)interaktiv Debuggen.|
...
|[Auslösen von Anhalten-, Fortsetzen- und Hintergrundereignissen (für Windows Store)](../debugger/how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)|Der Debugger deaktiviert Ereignisse der Prozesslebensdauer-Verwaltung (Windows Process Lifetime Management, PLM), die Apps anhalten, fortsetzen und beenden. Sie können diese Ereignisse über die Symbolleiste des Debuggers auslösen.<br /><br /> Hintergrundaufgaben ermöglichen es Ihnen, wichtige Vorgänge auch dann auszuführen, wenn Ihre App angehalten wurde. Der Debugger ermöglicht es Ihnen, diese Hintergrundaufgaben zu starten und zu debuggen.|
