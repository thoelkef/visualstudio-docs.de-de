...
ms.locfileid: "47512620"
---
# <a name="debugger-project-settings"></a>Debuggerprojekteinstellungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Debuggerprojekteinstellungen](https://docs.microsoft.com/visualstudio/debugger/debugger-project-settings).  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Listet Eigenschaften verfügbar sind, in der **Eigenschaftenseiten** im Dialogfeld für [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] Projekte.  
