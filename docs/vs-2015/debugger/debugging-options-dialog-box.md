...
ms.locfileid: "47523724"
---
# <a name="debugging-options-dialog-box"></a>Debuggen, Dialogfeld "Optionen"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Debugging, Options Dialog Box](https://docs.microsoft.com/visualstudio/debugger/debugging-options-dialog-box).  
  
Die **Debuggen** Ordner in der **Optionen** Dialogfeld auf die **Tools** , bietet die folgenden Seiten, die Sie zum Festlegen der Debuggeroptionen ermöglichen Tooloptionen.  
