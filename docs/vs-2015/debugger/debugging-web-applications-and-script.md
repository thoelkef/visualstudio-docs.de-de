...
ms.locfileid: "47511924"
---
# <a name="debugging-web-applications-and-script"></a>Debuggen von Webanwendungen und Skripts
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Debuggen von Webanwendungen und Skripts](https://docs.microsoft.com/visualstudio/debugger/debugging-web-applications-and-script).  
