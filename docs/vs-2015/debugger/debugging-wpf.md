...
ms.locfileid: "58961687"
---
# <a name="debugging-wpf"></a>Debuggen von WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

[!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] bietet zusätzliche Features, die das Debuggen von WPF-Anwendungen vereinfachen.  
...
|[Vorgehensweise: Anzeigen von WPF-Ablaufverfolgungsinformationen](../debugger/how-to-display-wpf-trace-information.md)|[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] kann Debugablaufverfolgungs-Informationen in WPF-Anwendungen empfangen und diese Informationen im **Ausgabefenster** anzeigen. In diesem Thema wird beschrieben, wie die Anzeige der WPF-Ablaufverfolgungsinformationen aktiviert und angepasst wird.|  
