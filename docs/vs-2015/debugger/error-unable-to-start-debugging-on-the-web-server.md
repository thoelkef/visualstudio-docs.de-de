...
Die neueste Version dieses Themas finden Sie unter [Fehler: Debuggen starten, auf dem Webserver nicht](https://docs.microsoft.com/visualstudio/debugger/error-unable-to-start-debugging-on-the-web-server).  
