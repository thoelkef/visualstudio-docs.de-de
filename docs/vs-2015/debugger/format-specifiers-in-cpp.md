...
ms.locfileid: "47523893"
---
# <a name="format-specifiers-in-c"></a>Formatbezeichner in C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Formatbezeichner in C++](https://docs.microsoft.com/visualstudio/debugger/format-specifiers-in-cpp).  
