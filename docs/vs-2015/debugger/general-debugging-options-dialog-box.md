...
- Sie möchten „Bearbeiten und Fortfahren“ für C++-Projekte beim Debuggen im gemischten Modus aktivieren.  
  ...
  **Diagnosetools beim Debuggen aktivieren**  
  Das Fenster **Diagnosetools** wird während des Debuggens angezeigt. Weitere Informationen finden Sie unter [profilerstellung im Debugger integrierten](/visualstudio/profiling/running-profiling-tools-with-or-without-the-debugger).  
