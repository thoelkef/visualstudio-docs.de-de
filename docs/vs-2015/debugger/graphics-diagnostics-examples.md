...
ms.locfileid: "47512735"
---
# <a name="graphics-diagnostics-examples"></a>Grafikdiagnosebeispiele
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Grafikdiagnosebeispiele](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-diagnostics-examples).  
...
## <a name="debugging-compute-shaders"></a>Debugging von Compute-Shadern  
 ...
 Ein Szenario, das veranschaulicht, wie eine Simulationsproblem Debuggen, die durch einen Fehler im Compute-Shader verursacht wird, finden Sie unter [Exemplarische Vorgehensweise: Verwenden der Grafikdiagnose zum Debuggen eines Compute-Shaders](../debugger/walkthrough-using-graphics-diagnostics-to-debug-a-compute-shader.md).
