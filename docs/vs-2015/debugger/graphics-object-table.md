...
ms.locfileid: "47522678"
---
# <a name="graphics-object-table"></a>Grafikobjekttabelle
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Grafikobjekttabelle](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-object-table).  
