...
|----------|--------------------------|  
|![Symbol für Fehler beim Tiefentest.](../debugger/media/vsg-hist-icon-failed-depth.png "vsg_hist_icon_failed_depth")|Das Pixel wurde ausgeschlossen, weil der Tiefentest fehlgeschlagen ist.|  
|![Symbol für Fehler beim Scherentest.](../debugger/media/vsg-hist-icon-failed-scissor.png "vsg_hist_icon_failed_scissor")|Das Pixel wurde ausgeschlossen, weil der Scherentest fehlgeschlagen ist.|  
|![Symbol für Fehler beim Schablonentest.](../debugger/media/vsg-hist-icon-failed-stencil.png "vsg_hist_icon_failed_stencil")|Das Pixel wurde ausgeschlossen, weil der Schablonentest fehlgeschlagen ist.|  
...
## <a name="see-also"></a>Weitere Informationen  
 [Exemplarische Vorgehensweise: fehlende Objekte aufgrund des Gerätestatus](../debugger/walkthrough-missing-objects-due-to-device-state.md)   
