...
Die neueste Version dieses Themas finden Sie unter [How to: Debug a Partial Trust Application](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-a-partial-trust-application).  
