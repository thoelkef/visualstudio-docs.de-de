...
ms.locfileid: "47515855"
---
# <a name="how-to-open-messages-view-from-find-window"></a>Gewusst wie: Öffnen der Meldungsansicht aus "Fenster suchen"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Öffnen der Meldungsansicht aus "Fenster Suchen"](https://docs.microsoft.com/visualstudio/debugger/how-to-open-messages-view-from-find-window).  
