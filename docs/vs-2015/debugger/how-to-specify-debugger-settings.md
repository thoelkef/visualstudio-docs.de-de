...
ms.locfileid: "47523878"
---
# <a name="how-to-specify-debugger-settings"></a>Gewusst wie: Angeben von Debuggereinstellungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Angeben von Debuggereinstellungen](https://docs.microsoft.com/visualstudio/debugger/how-to-specify-debugger-settings).  
