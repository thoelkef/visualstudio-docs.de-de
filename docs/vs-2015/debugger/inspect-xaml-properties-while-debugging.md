...
|Windows Store- und Windows Phone 8.1-Apps|Windows 10 und höher mit dem [Windows 10 SDK](https://dev.windows.com/downloads/windows-10-sdk)|  
...
```  
 ...
 Nun schauen wir uns die Eigenschaften von einem der Listenfeldelemente an. Wählen Sie das erste Listenfeldelement in **Visuelle Echtzeitstruktur** aus, und klicken Sie auf das Symbol **Eigenschaften anzeigen** auf der Symbolleiste. Der **Live-Eigenschaften-Explorer** wird angezeigt. Beachten Sie, dass das Feld " **Content** " den Wert "item1" hat und das **Hintergrund** Feld **#FFFFFFE0** (hellgelb) ist. Wechseln Sie zurück zu **Visuelle Echtzeitstruktur**, und wählen Sie das zweite Listenfeldelement aus. Der **Live Property Explorer** sollte anzeigen, dass das Feld " **Content** " den Wert "item2" hat, und das **Hintergrund** Feld ist **#FFD3D3D3** (hellgrau).  
  
 Die tatsächliche Struktur der XAML weist eine Menge Elemente auf, an denen Sie möglicherweise nicht direkt interessiert sind. Wenn Sie sich darüber hinaus nicht gut mit dem Code auskennen, ist die Navigation in der Struktur zum Suchen des gewünschten Elements möglicherweise kompliziert. Die **visuelle** echt Zeitstruktur bietet eine Reihe von Möglichkeiten, mit denen Sie die Benutzeroberfläche der Anwendung verwenden können, um das Element zu finden, das Sie untersuchen möchten.  
...
4. Öffnen Sie in der zweiten Instanz von Visual Studio die **visuelle** echt Zeitstruktur (**Debug/Windows/Live Visual Tree**). Es sollten die **TestXaml**-Benutzeroberflächenelemente angezeigt werden, und Sie sollten sie bearbeiten können, während Sie die Anwendung direkt debuggen.
