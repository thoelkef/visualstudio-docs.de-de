...
## <a name="ChooseEvents"></a>Wählen Sie die Ereignisse aus, die IntelliTrace aufzeichnet.  
...
## <a name="GoingFurther"></a>IntelliTrace-Ereignisse und-Aufrufinformationen erfassen  
