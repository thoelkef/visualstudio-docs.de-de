...
- Skript, das ausgeführt wird, indem eine Zeichenfolge an die `setTimeout` `setImmediate` Funktionen, oder übergeben wird, `setInterval` wird als **unrelatedcode**klassifiziert.  
