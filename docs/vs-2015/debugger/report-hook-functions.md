...
ms.locfileid: "47515866"
---
# <a name="report-hook-functions"></a>Hookfunktionen für Berichte
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Hookfunktionen](https://docs.microsoft.com/visualstudio/debugger/report-hook-functions).  
