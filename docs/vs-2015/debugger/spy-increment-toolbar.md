...
ms.locfileid: "47524851"
---
# <a name="spy-toolbar"></a>Spy++-Symbolleiste
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Spy++-Symbolleiste](https://docs.microsoft.com/visualstudio/debugger/spy-increment-toolbar).  
