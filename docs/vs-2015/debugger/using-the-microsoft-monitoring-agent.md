...
1.  Stellen Sie Folgendes sicher:  
    ...
    -   Ihre Webserver ausgeführt wird [unterstützten Versionen von Internet Information Services (IIS)](http://technet.microsoft.com/library/dn465154.aspx).  
