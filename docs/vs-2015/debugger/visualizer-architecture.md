...
ms.locfileid: "47515769"
---
# <a name="visualizer-architecture"></a>Schnellansichtarchitektur
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schnellansichtarchitektur](https://docs.microsoft.com/visualstudio/debugger/visualizer-architecture).  
