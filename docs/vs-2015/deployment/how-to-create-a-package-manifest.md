...
ms.locfileid: "47521383"
---
# <a name="how-to-create-a-package-manifest"></a>Gewusst wie: Erstellen eines Paketmanifests
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen eines Paketmanifests](https://docs.microsoft.com/visualstudio/deployment/how-to-create-a-package-manifest).  
