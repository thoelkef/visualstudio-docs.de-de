...
## <a name="example"></a>Beispiel  
 Im folgenden Codebeispiel werden Pakete für das Verteil [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] Bare Paket und seine Abhängigkeiten definiert, z. b. die Windows Installer.  
