...
ms.locfileid: "47511696"
---
# <a name="ltpackagefilesgt-element-bootstrapper"></a>&lt;"PackageFiles"&gt; -Element (Bootstrapper)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [ &lt;"PackageFiles"&gt; -Element (Bootstrapper)](https://docs.microsoft.com/visualstudio/deployment/packagefiles-element-bootstrapper).  
