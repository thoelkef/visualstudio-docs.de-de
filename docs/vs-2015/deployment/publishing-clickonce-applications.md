...
ms.locfileid: "47511933"
---
# <a name="publishing-clickonce-applications"></a>Veröffentlichen von ClickOnce-Anwendungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Veröffentlichen von ClickOnce-Anwendungen](https://docs.microsoft.com/visualstudio/deployment/publishing-clickonce-applications).  
