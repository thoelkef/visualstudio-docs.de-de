...
## <a name="code-access-security-policies"></a>Richtlinien der Codezugriffssicherheit  
 ...
 Weitere Informationen zur Code Zugriffssicherheit und zu ClickOnce finden Sie unter [Code Zugriffssicherheit für ClickOnce-Anwendungen](../deployment/code-access-security-for-clickonce-applications.md).  
...
## <a name="passing-arguments"></a>Übergeben von Argumenten  
 ...
 Abfragezeichenfolgenargumente werden standardmäßig deaktiviert. Um sie zu aktivieren, muss das `trustUrlParameters` -Attribut im Bereitstellungsmanifest der Anwendung festgelegt werden. Dieser Wert kann von [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] und von MageUI.exe aus festgelegt werden. Ausführliche Schritte zum Aktivieren der Übergabe von Abfrage Zeichenfolgen finden Sie unter Gewusst [wie: Abrufen von Abfrage Zeichenfolgen-Informationen in einer Online-ClickOnce-Anwendung](../deployment/how-to-retrieve-query-string-information-in-an-online-clickonce-application.md).  
