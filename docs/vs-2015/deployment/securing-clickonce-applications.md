...
ms.locfileid: "47524376"
---
# <a name="securing-clickonce-applications"></a>Sichern von ClickOnce-Anwendungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Sichern von ClickOnce-Anwendungen](https://docs.microsoft.com/visualstudio/deployment/securing-clickonce-applications).  
...
## <a name="passing-arguments"></a>Übergeben von Argumenten  
 Ein weiterer Sicherheitsaspekt muss berücksichtigt werden, wenn Sie Argumente in eine [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]-Anwendung übergeben müssen. [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] ermöglicht Entwicklern, die für Anwendungen über das Internet eine Abfragezeichenfolge bereitzustellen. Die Abfragezeichenfolge besteht aus einer Reihe von Name/Wert-Paaren am Ende der URL, mit der die Anwendung gestartet wird:  
...
> [!NOTE]
>  Abfragezeichenfolgenargumente sind die einzige Möglichkeit, Argumente beim Starten an eine [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]-Anwendung zu übergeben. Sie können keine Argumente übergeben eine [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] Anwendung über die Befehlszeile.  
