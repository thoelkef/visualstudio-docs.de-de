...
ms.locfileid: "47515490"
---
# <a name="constant-nodes"></a>Konstante Knoten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Konstante Knoten](https://docs.microsoft.com/visualstudio/designers/constant-nodes).  
