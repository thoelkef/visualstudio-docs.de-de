...
Die neueste Version dieses Themas finden Sie unter [Erstellen einer Benutzeroberfläche mit XAML-Designer in Visual Studio](https://docs.microsoft.com/visualstudio/designers/creating-a-ui-by-using-xaml-designer-in-visual-studio).  
...
## <a name="authoring-views"></a>Erstellungsansichten  
 ...
 ![Designansicht des XAML-Designers](../designers/media/xaml-editor-design-view.png "xaml_editor_design_view")  
...
## <a name="properties-window"></a>Eigenschaftenfenster  
 ...
 ![Fenster Eigenschaften](../designers/media/xaml-editor-prop-window.png "xaml_editor_prop_window")  
