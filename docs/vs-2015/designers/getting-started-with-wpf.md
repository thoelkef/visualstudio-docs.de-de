...
ms.locfileid: "47524521"
---
# <a name="getting-started-with-wpf"></a>Erste Schritte mit WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [erste Schritte mit WPF](https://docs.microsoft.com/visualstudio/designers/getting-started-with-wpf).  
