...
ms.locfileid: "47513790"
---
# <a name="how-to-create-a-basic-lambert-shader"></a>Gewusst wie: Erstellen eines Lambert-Shaders
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen eines Lambert-Shaders](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-lambert-shader).  
