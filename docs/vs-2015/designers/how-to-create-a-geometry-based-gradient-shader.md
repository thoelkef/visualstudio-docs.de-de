...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: erstellen ein Geometriebasierten Farbverlauf-Shaders](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-geometry-based-gradient-shader).  
