...
ms.locfileid: "47524932"
---
# <a name="introduction-to-wpf"></a>Einführung in WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Einführung in WPF](https://docs.microsoft.com/visualstudio/designers/introduction-to-wpf).  
