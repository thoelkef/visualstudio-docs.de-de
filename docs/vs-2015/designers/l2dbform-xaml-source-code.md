...
ms.locfileid: "47509651"
---
# <a name="l2dbformxaml-source-code"></a>L2DBForm.xaml-Quellcode
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [L2DBForm.xaml-Quellcode](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-source-code).  
