...
ms.locfileid: "47524662"
---
# <a name="working-with-shaders"></a>Arbeiten mit Shaders
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [arbeiten mit Shaders](https://docs.microsoft.com/visualstudio/designers/working-with-shaders).  
