...
# [Vorgehensweise: Migrieren von Erweiterbarkeitsprojekten zu Visual Studio 2015](how-to-migrate-extensibility-projects-to-visual-studio-2015.md)
...
### [Exemplarische Vorgehensweise: Verknüpfen eines Inhaltstyps mit einer Erweiterung](walkthrough-linking-a-content-type-to-a-file-name-extension.md)
...
### [Exemplarische Vorgehensweise: Erstellen von Randsteuerelementen für eine Ansicht, Befehlen und Einstellungen (Spaltenführungslinien)](walkthrough-creating-a-view-adornment-commands-and-settings-column-guides.md)
### [Exemplarische Vorgehensweise: Hervorheben von Text](walkthrough-highlighting-text.md)
...
### [Exemplarische Vorgehensweise: Anzeigen von Anweisungsvervollständigungen](walkthrough-displaying-statement-completion.md)
...
#### [Vorgehensweise: Anfügen von Ansichten zu Dokumentdaten](how-to-attach-views-to-document-data.md)
...
#### [Vorgehensweise: Öffnen von projektspezifischen Editoren](how-to-open-project-specific-editors.md)
#### [Vorgehensweise: Öffnen von Standard-Editoren](how-to-open-standard-editors.md)
#### [Vorgehensweise: Öffnen von Editoren für geöffnete Dokumente](how-to-open-editors-for-open-documents.md)
...
## [Vorgehensweise: Verwenden von Assistenten mit Projektvorlagen](how-to-use-wizards-with-project-templates.md)
...
## [Vorgehensweise: Verwenden des Aktivitätsprotokolls](how-to-use-the-activity-log.md)
# [Verwenden und Bereitstellen von Diensten](using-and-providing-services.md)
## [Vorgehensweise: Abrufen eines Diensts](how-to-get-a-service.md)
## [Vorgehensweise: Bereitstellen eines Diensts](how-to-provide-a-service.md)
## [Vorgehensweise: Bereitstellen eines asynchronen Visual Studio-Diensts](how-to-provide-an-asynchronous-visual-studio-service.md)
## [Vorgehensweise: Problembehandlung bei Diensten](how-to-troubleshoot-services.md)
...
## [Vorgehensweise: Verwenden von AsyncPackage zum Laden von VSPackages im Hintergrund](how-to-use-asyncpackage-to-load-vspackages-in-the-background.md)
## [Vorgehensweise: Verwenden des regelbasierten Benutzeroberflächenkontexts für Visual Studio-Erweiterungen](how-to-use-rule-based-ui-context-for-visual-studio-extensions.md)
...
## [Vorgehensweise: Hinzufügen einer Abhängigkeit zu einem VSIX-Paket](how-to-add-a-dependency-to-a-vsix-package.md)
...
### [Vorgehensweise: Erstellen eines Atom-Feeds für einen privaten Katalog](how-to-create-an-atom-feed-for-a-private-gallery.md)
### [Vorgehensweise: Verwalten eines privaten Katalogs mithilfe von Registrierungseinstellungen](how-to-manage-a-private-gallery-by-using-registry-settings.md)
...
### [Vorgehensweise: Registrieren von Editor-Dateitypen](how-to-register-editor-file-types.md)
### [Exemplarische Vorgehensweise: Erstellen eines Core-Editors und Registrieren eines Editor-Dateityps](walkthrough-creating-a-core-editor-and-registering-an-editor-file-type.md)
...
### [Vorgehensweise: Deaktivieren von Kompatibilitätswarnungen für Quellcodeverwaltungs-Plug-ins](how-to-turn-off-compatibility-warnings-for-source-control-plug-ins.md)
