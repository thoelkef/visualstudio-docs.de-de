...
ms.locfileid: "47520551"
---
# <a name="adding-command-line-switches"></a>Hinzufügen von Befehlszeilenschaltern
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Befehlszeilenoptionen hinzufügen](https://docs.microsoft.com/visualstudio/extensibility/adding-command-line-switches).  
