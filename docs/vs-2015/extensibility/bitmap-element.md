...
ms.locfileid: "47511108"
---
# <a name="bitmap-element"></a>Bitmap-Element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Bitmapelement](https://docs.microsoft.com/visualstudio/extensibility/bitmap-element).  
