...
ms.locfileid: "47515065"
---
# <a name="buildprojectonload-visual-studio-templates"></a>BuildProjectOnLoad (Visual Studio-Vorlagen)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [BuildProjectOnLoad (Visual Studio-Vorlagen)](https://docs.microsoft.com/visualstudio/extensibility/buildprojectonload-visual-studio-templates).  
