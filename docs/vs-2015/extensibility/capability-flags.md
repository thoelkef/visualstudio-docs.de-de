...
ms.locfileid: "47516152"
---
# <a name="capability-flags"></a>Funktionsflags
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Capability Flags](https://docs.microsoft.com/visualstudio/extensibility/capability-flags).  
