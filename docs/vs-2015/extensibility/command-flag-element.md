...
ms.locfileid: "47521393"
---
# <a name="command-flag-element"></a>CommandFlag-Element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Commandflag-Element](https://docs.microsoft.com/visualstudio/extensibility/command-flag-element).  
