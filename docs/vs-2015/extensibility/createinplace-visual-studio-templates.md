...
ms.locfileid: "47522874"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (Visual Studio-Vorlagen)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [CreateInPlace (Visual Studio-Vorlagen)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
