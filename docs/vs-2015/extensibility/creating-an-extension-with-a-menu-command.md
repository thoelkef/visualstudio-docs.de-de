...
ms.locfileid: "47523527"
---
# <a name="creating-an-extension-with-a-menu-command"></a>Erstellen einer Erweiterung mit einem Menübefehl
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Erstellen einer Erweiterung mit einem Menübefehl](https://docs.microsoft.com/visualstudio/extensibility/creating-an-extension-with-a-menu-command).  
