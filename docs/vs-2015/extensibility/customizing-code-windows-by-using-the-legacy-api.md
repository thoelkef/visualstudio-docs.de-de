...
ms.locfileid: "47521700"
---
# <a name="customizing-code-windows-by-using-the-legacy-api"></a>Anpassen von Windows von Code mithilfe der Legacy-API
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Anpassen von Code Windows mit der Legacy-API](https://docs.microsoft.com/visualstudio/extensibility/customizing-code-windows-by-using-the-legacy-api).  
