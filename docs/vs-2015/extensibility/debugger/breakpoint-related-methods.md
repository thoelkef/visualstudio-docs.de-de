...
ms.locfileid: "47522143"
---
# <a name="breakpoint-related-methods"></a>Auf Haltepunkte bezogene Methoden
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Breakpoint-Related Methoden](https://docs.microsoft.com/visualstudio/extensibility/debugger/breakpoint-related-methods).  
