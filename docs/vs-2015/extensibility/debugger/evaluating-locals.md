...
ms.locfileid: "47513657"
---
# <a name="evaluating-locals"></a>Auswerten von lokalen Elementen
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [auswerten "lokal"](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
