...
ms.locfileid: "47523746"
---
# <a name="event-descriptions"></a>Ereignisbeschreibungen
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Ereignisbeschreibungen](https://docs.microsoft.com/visualstudio/extensibility/debugger/event-descriptions).  
