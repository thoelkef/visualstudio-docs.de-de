...
ms.locfileid: "47510405"
---
# <a name="key-expression-evaluator-interfaces"></a>Wichtige Schnittstellen für die Ausdrucksauswertung
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schnittstellen für die Ausdrucksauswertung von Schlüssel-Ausdrucks](https://docs.microsoft.com/visualstudio/extensibility/debugger/key-expression-evaluator-interfaces).  
