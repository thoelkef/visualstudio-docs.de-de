...
ms.locfileid: "47513119"
---
# <a name="program-control"></a>Programmsteuerung
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Programmsteuerung](https://docs.microsoft.com/visualstudio/extensibility/debugger/program-control).  
