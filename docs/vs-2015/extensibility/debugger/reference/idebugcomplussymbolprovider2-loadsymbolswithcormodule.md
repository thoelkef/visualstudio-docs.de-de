...
Die neueste Version dieses Themas finden Sie unter [IDebugComPlusSymbolProvider2::LoadSymbolsWithCorModule](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugcomplussymbolprovider2-loadsymbolswithcormodule).  
  
Lädt die Debugsymbole erhält die **ICorDebugModule** Objekt.  
...
#### <a name="parameters"></a>Parameter  
 ...
 `pUnkMetadataImport`  
 [in] Objekt, das die Metadaten der Debug-Symbol enthält.  
