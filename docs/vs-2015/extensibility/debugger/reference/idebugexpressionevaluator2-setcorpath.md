...
ms.locfileid: "47511336"
---
# <a name="idebugexpressionevaluator2setcorpath"></a>IDebugExpressionEvaluator2::SetCorPath
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IDebugExpressionEvaluator2::SetCorPath](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugexpressionevaluator2-setcorpath).  
...
#### <a name="parameters"></a>Parameter  
 `pcstrCorPath`  
 [in] Pfad für die CLR, die in den Debugger geladen werden.  
