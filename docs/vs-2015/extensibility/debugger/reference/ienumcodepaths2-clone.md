...
ms.locfileid: "47516022"
---
# <a name="ienumcodepaths2clone"></a>IEnumCodePaths2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumCodePaths2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-clone).  
