...
ms.locfileid: "47522341"
---
# <a name="ienumcodepaths2skip"></a>IEnumCodePaths2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumCodePaths2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-skip).  
