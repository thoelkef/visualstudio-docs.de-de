...
ms.locfileid: "47509101"
---
# <a name="ienumdebugports2reset"></a>IEnumDebugPorts2::Reset
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumDebugPorts2::Reset](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugports2-reset).  
