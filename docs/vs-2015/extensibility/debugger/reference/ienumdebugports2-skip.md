...
ms.locfileid: "47512170"
---
# <a name="ienumdebugports2skip"></a>IEnumDebugPorts2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumDebugPorts2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugports2-skip).  
