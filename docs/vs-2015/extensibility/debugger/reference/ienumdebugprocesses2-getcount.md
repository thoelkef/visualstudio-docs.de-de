...
ms.locfileid: "47509508"
---
# <a name="ienumdebugprocesses2getcount"></a>IEnumDebugProcesses2::GetCount
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumDebugProcesses2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprocesses2-getcount).  
