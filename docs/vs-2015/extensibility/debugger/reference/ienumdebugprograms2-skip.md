...
ms.locfileid: "47512629"
---
# <a name="ienumdebugprograms2skip"></a>IEnumDebugPrograms2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumDebugPrograms2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprograms2-skip).  
