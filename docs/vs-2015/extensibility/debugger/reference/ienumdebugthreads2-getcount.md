...
ms.locfileid: "47509330"
---
# <a name="ienumdebugthreads2getcount"></a>IEnumDebugThreads2::GetCount
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [IEnumDebugThreads2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugthreads2-getcount).  
