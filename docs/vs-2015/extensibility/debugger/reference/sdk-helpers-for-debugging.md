...
ms.locfileid: "47523224"
---
# <a name="sdk-helpers-for-debugging"></a>SDK-Hilfsprogramme für das Debuggen
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [SDK-Hilfsprogramme zum Debugging](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/sdk-helpers-for-debugging).  
