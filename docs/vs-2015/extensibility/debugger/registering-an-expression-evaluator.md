...
Die neueste Version dieses Themas finden Sie unter [Registrieren einer Ausdrucksauswertung](https://docs.microsoft.com/visualstudio/extensibility/debugger/registering-an-expression-evaluator).  
