...
ms.locfileid: "47514381"
---
# <a name="registering-the-program"></a>Registrieren des Programms
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Registrieren des Programms](https://docs.microsoft.com/visualstudio/extensibility/debugger/registering-the-program).  
