...
ms.locfileid: "47512710"
---
# <a name="required-port-supplier-interfaces"></a>Schnittstellen für erforderliche Portanbieter
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [erforderlichen Schnittstellen ein Port Lieferanten](https://docs.microsoft.com/visualstudio/extensibility/debugger/required-port-supplier-interfaces).  
