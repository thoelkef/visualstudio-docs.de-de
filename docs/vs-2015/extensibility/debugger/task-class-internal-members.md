...
ms.locfileid: "47512543"
---
# <a name="task-class---internal-members"></a>Task-Klasse – interne Member
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Task-Klasse – interne Member](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-class-internal-members).  
