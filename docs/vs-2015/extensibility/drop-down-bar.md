...
ms.locfileid: "47512530"
---
# <a name="drop-down-bar"></a>Dropdownleiste
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Dropdownleiste](https://docs.microsoft.com/visualstudio/extensibility/drop-down-bar).  
