...
## <a name="creating-custom-start-pages"></a>Erstellen benutzerdefinierte Startseiten  
 Erfahren Sie, wie Sie eine eigene Startseite, entweder von Grund auf neu oder aus einem herunterladbaren Start-Seite-Beispiel: [erstellen eine benutzerdefinierte Startseite](../extensibility/creating-a-custom-start-page.md).  
