...
Die neueste Version dieses Themas finden Sie unter [FullClassName-Element (Assistentenerweiterung für Visual Studio-Vorlagen)](https://docs.microsoft.com/visualstudio/extensibility/fullclassname-element-visual-studio-template-wizard-extension).  
