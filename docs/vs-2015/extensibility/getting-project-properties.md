...
ms.locfileid: "47523935"
---
# <a name="getting-project-properties"></a>Abrufen von Projekteigenschaften
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Projekteigenschaften erste](https://docs.microsoft.com/visualstudio/extensibility/getting-project-properties).  
