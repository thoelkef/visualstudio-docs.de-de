...
Die neueste Version dieses Themas finden Sie unter [Abrufen von Dienstinformationen aus dem Store Einstellungen](https://docs.microsoft.com/visualstudio/extensibility/getting-service-information-from-the-settings-store).  
