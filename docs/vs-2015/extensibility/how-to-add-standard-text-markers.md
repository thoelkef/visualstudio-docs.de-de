...
ms.locfileid: "47522882"
---
# <a name="how-to-add-standard-text-markers"></a>Vorgehensweise: Hinzufügen von Standard-Text-Marker
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Hinzufügen der standardmäßigen Textmarkierungen](https://docs.microsoft.com/visualstudio/extensibility/how-to-add-standard-text-markers).  
