...
ms.locfileid: "47509103"
---
# <a name="how-to-get-a-service"></a>Vorgehensweise: Abrufen eines Diensts
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Abrufen eines Diensts](https://docs.microsoft.com/visualstudio/extensibility/how-to-get-a-service).  
