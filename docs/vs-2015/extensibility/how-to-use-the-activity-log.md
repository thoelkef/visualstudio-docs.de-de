...
ms.locfileid: "47522968"
---
# <a name="how-to-use-the-activity-log"></a>Vorgehensweise: Verwenden des Aktivitätsprotokolls
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Verwenden des Aktivitätsprotokolls](https://docs.microsoft.com/visualstudio/extensibility/how-to-use-the-activity-log).  
