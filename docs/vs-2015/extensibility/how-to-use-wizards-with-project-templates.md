...
1. Erstellen Sie ein c#-Projektvorlagen Projekt (in Visual Studio, Datei > Neu > Projekt > **Visual c#/Erweiterbarkeit > c#-Projektvorlage**). Nennen Sie Sie **MyProjectTemplate**.  
