...
ms.locfileid: "47524661"
---
# <a name="command-availability"></a>Befehlsverfügbarkeit
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Befehlsverfügbarkeit](https://docs.microsoft.com/visualstudio/extensibility/internals/command-availability).  
