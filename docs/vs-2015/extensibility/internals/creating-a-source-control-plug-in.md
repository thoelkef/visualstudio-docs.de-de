...
ms.locfileid: "58958815"
---
# <a name="creating-a-source-control-plug-in"></a>Erstellen eines Quellcodeverwaltungs-Plug-Ins
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Visual Studio SDK enthält Ressourcen, die Ihnen ermöglichen, Quelle Steuerungsfunktionen zum Hinzufügen der [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] integrierte Entwicklungsumgebung (IDE). Sie können anhand eine Plug-in-DLL, die erfüllt mit der Source-Plug-in-API in dieser Dokumentation beschrieben.  
...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Verwendet ein Architekturdiagramm zur Erläuterung der Integration von eines Quellcodeverwaltungs-Plug-in mit der [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] IDE.  
...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 Erläutert, wie ein Quellcodeverwaltungs-VSPackage zu erstellen, die nicht nur ein Knoten ersetzt jedoch stellt Quellcodeverwaltungsfunktionen [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Datenquellen-Steuerelement-Benutzeroberfläche.  
