...
Die neueste Version dieses Themas finden Sie unter [erstellen Projekt Instanzen von mithilfe von Projektfactorys](https://docs.microsoft.com/visualstudio/extensibility/internals/creating-project-instances-by-using-project-factories).  
