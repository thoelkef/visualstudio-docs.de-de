...
ms.locfileid: "47523239"
---
# <a name="how-to-create-a-vsct-file"></a>Vorgehensweise: Erstellen Sie ein. VSCT-Datei
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen Sie ein. VSCT-Datei](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-create-a-dot-vsct-file).  
