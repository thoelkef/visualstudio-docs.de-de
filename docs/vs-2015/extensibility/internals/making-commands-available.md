...
ms.locfileid: "47511114"
---
# <a name="making-commands-available"></a>Verfügbarmachen von Befehlen
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Befehle verfügbar machen](https://docs.microsoft.com/visualstudio/extensibility/internals/making-commands-available).  
...
## <a name="delayed-loading"></a>Verzögertes Laden  
 ...
 Das folgende Beispiel zeigt die Definition eines Menübefehls in einer VSCT-Datei. Dies ist der Befehl, der von der Visual Studio-Paket-Vorlage generiert wird bei der **Menübefehl** in der Vorlage ausgewählt ist.  
