...
Die neueste Version dieses Themas finden Sie unter [Generieren neuer Projekte: Under the Hood, Teil 2](https://docs.microsoft.com/visualstudio/extensibility/internals/new-project-generation-under-the-hood-part-two).  
