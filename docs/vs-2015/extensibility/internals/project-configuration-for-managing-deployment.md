...
Die neueste Version dieses Themas finden Sie unter [Projektkonfiguration für die Verwaltung von Bereitstellung](https://docs.microsoft.com/visualstudio/extensibility/internals/project-configuration-for-managing-deployment).  
