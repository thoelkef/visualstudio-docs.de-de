...
ms.locfileid: "47520365"
---
# <a name="project-configuration-object"></a>Projektkonfigurationsobjekt
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Projektkonfigurationsobjekt](https://docs.microsoft.com/visualstudio/extensibility/internals/project-configuration-object).  
