...
ms.locfileid: "47513401"
---
# <a name="project-types"></a>Projekttypen
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Projekttypen](https://docs.microsoft.com/visualstudio/extensibility/internals/project-types).  
