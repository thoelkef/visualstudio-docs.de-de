...
Die neueste Version dieses Themas finden Sie unter [Registrieren von Projekt- und Elementvorlagen](https://docs.microsoft.com/visualstudio/extensibility/internals/registering-project-and-item-templates).  
