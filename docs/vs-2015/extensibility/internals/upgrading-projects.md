...
ms.locfileid: "47511417"
---
# <a name="upgrading-projects"></a>Aktualisieren von Projekten
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Aktualisieren von Projekten](https://docs.microsoft.com/visualstudio/extensibility/internals/upgrading-projects).  
