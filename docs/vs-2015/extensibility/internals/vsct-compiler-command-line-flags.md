...
ms.locfileid: "47516365"
---
# <a name="vsct-compiler-command-line-flags"></a>VSCT-Compiler-Befehlszeilenflags
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [VSCT-Compiler Command-Line-Flags](https://docs.microsoft.com/visualstudio/extensibility/internals/vsct-compiler-command-line-flags).  
...
|-E|Ausgeben von c#-Objekte im angegebenen Namespace für Befehl-Elemente, gefolgt von [C&#124;H&#124;N]:*Filename*, C = c#, H C++-Header, N = = Namespace. Der Namespace ist für C#-Code erforderlich.|  
