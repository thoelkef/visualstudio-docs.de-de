...
ms.locfileid: "47522686"
---
# <a name="name-element-visual-studio-templates"></a>Name-Element (Visual Studio-Vorlagen)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Name-Element (Visual Studio-Vorlagen)](https://docs.microsoft.com/visualstudio/extensibility/name-element-visual-studio-templates).  
