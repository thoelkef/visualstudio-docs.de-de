...
ms.locfileid: "47523698"
---
# <a name="opening-a-dynamic-tool-window"></a>Öffnen eines dynamischen Toolfensters
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Öffnen eines dynamischen Toolfensters](https://docs.microsoft.com/visualstudio/extensibility/opening-a-dynamic-tool-window).  
