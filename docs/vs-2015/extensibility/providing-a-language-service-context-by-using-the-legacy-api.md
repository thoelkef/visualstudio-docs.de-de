...
Die neueste Version dieses Themas finden Sie unter [einen Dienstkontext für die Sprache bereitstellt, mit der Legacy-API](https://docs.microsoft.com/visualstudio/extensibility/providing-a-language-service-context-by-using-the-legacy-api).  
