...
Die neueste Version dieses Themas finden Sie unter [Registrieren von Dateierweiterungen für Seite-an-Seite Bereitstellungen](https://docs.microsoft.com/visualstudio/extensibility/registering-file-name-extensions-for-side-by-side-deployments).  
...
## <a name="related-sections"></a>Verwandte Abschnitte  
 ...
 Beschreibt die Probleme im Zusammenhang mit mehreren Versionen von [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] und dem VSPackage während der Entwicklung und Bereitstellung für Endbenutzer.
