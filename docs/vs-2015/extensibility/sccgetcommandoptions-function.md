...
ms.locfileid: "47511592"
---
# <a name="sccgetcommandoptions-function"></a>SccGetCommandOptions-Funktion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [SccGetCommandOptions-Funktion](https://docs.microsoft.com/visualstudio/extensibility/sccgetcommandoptions-function).  
