...
ms.locfileid: "47521767"
---
# <a name="sccgetparentprojectpath-function"></a>SccGetParentProjectPath-Funktion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [SccGetParentProjectPath-Funktion](https://docs.microsoft.com/visualstudio/extensibility/sccgetparentprojectpath-function).  
