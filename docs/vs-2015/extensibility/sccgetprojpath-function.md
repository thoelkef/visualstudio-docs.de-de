...
ms.locfileid: "47510860"
---
# <a name="sccgetprojpath-function"></a>SccGetProjPath-Funktion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [SccGetProjPath-Funktion](https://docs.microsoft.com/visualstudio/extensibility/sccgetprojpath-function).  
