...
ms.locfileid: "47516200"
---
# <a name="sccopenproject-function"></a>SccOpenProject-Funktion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [SccOpenProject-Funktion](https://docs.microsoft.com/visualstudio/extensibility/sccopenproject-function).  
