...
Die neueste Version dieses Themas finden Sie unter [Auslieferung von Visual Studio-Erweiterungen](https://docs.microsoft.com/visualstudio/extensibility/shipping-visual-studio-extensions).  
