...
ms.locfileid: "47510391"
---
# <a name="signing-vsix-packages"></a>Signieren von VSIX-Paketen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [VSIX-Pakete signieren](https://docs.microsoft.com/visualstudio/extensibility/signing-vsix-packages).  
