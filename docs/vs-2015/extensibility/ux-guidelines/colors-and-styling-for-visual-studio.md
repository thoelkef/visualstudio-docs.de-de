...
### <a name="user-customizable-colors"></a>Benutzer anpassbare Farben
 ...
 ![Dialogfeld "Tools &#62; Optionen" in Visual Studio](../../extensibility/ux-guidelines/media/0301-a-toolsoptionsdialog.png "0301-a_ToolsOptionsDialog")
...
#### <a name="to-create-or-identify-categories"></a>So erstellen oder identifizieren Sie Kategorien
 Erstellen Sie unter [HKLM\SOFTWARE\Microsoft \Visual Studio \\<Visual Studio-Version \> \fontandcolors \\<Kategorie] einen besonderen Typ von kategorieregistrierungseintrag \> . \<Category> der nicht lokalisierte Name der Kategorie.
...
#### <a name="to-create-or-identify-groups"></a>So erstellen oder identifizieren Sie Gruppen
 Erstellen Sie einen besonderen Typ von kategorieregistrierungseintrag unter [HKLM\SOFTWARE\Microsoft \Visual Studio \\<Visual Studio-Version \> \fontandcolors \\<Gruppe \> ]. \<group> der nicht lokalisierte Name der Gruppe.
