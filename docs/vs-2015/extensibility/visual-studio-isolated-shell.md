...
|----------------------|-------------|  
|IDE Features|Import/Export Settings<br /><br /> Toolbox Control Installer<br /><br /> Task List & Error List<br /><br /> Ausgabefenster<br /><br /> Startseite<br /><br /> Eigenschaftenfenster<br /><br /> Werkzeugkasten<br /><br /> Projektmappen-Explorer<br /><br /> Lesezeichenfenster<br /><br /> Klassenansicht<br /><br /> Objektkatalog<br /><br /> Befehlsfenster<br /><br /> Dokumentgliederung<br /><br /> Resource View<br /><br /> External Tool<br /><br /> Windows Communication Foundation (WCF) Add Service Reference<br /><br /> Language Integrated Query (LINQ) Support|  
|Editor/Designer|Code browsing tools (unified find, source definition, inheritance)<br /><br /> IntelliSense<br /><br /> SmartTags<br /><br /> Codeausschnitt-Manager<br /><br /> Codeausschnitte<br /><br /> Umgestaltung<br /><br /> Pretty listing<br /><br /> IntelliSense Filtering<br /><br /> Codedefinitionsfenster<br /><br /> Anwendungs-Designer<br /><br /> Windows Forms-Designer<br /><br /> Windows Presentation Foundation (WPF) Designer|  
|Debugging|C# Expression Evaluator<br /><br /> Local debugging<br /><br /> Managed debugging<br /><br /> Bearbeiten und Fortfahren<br /><br /> Cross-thread debugging<br /><br /> Visualizations<br /><br /> DataTips<br /><br /> Native debugging<br /><br /> Script debugging<br /><br /> Interop debugging<br /><br /> Just-in-time (JIT) debugging<br /><br /> Multi-process debugging<br /><br /> Debuggen von XSLT-Code<br /><br /> Attach to local process<br /><br /> Ablaufverfolgungspunkte<br /><br /> Breakpoint Constraints|  
|Daten|Server Explorer (Simplified - Data Only)<br /><br /> Data bind to local data (.MDF or .MDB)<br /><br /> Data bind to object<br /><br /> Data bind to Web service<br /><br /> Full set of data controls<br /><br /> XML-Editor<br /><br /> Data bind to local database server<br /><br /> Datenquellenfenster|  
|Web|HTML-Editor<br /><br /> Webbrowser<br /><br /> Web Forms-Designer<br /><br /> Web Site Project<br /><br /> Web Application Project|  
|Erweiterungen|Consumes VSPackages and MEF components|  
