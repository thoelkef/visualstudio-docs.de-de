...
ms.locfileid: "47523140"
---
# <a name="vsx-language-pack-schema-reference"></a>Schemareferenz für VSX Sprachpaket
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schemareferenz Sprachpaket VSX](https://docs.microsoft.com/visualstudio/extensibility/vsx-language-pack-schema-reference).  
...
|[Referenz zum VSIX-Erweiterung Schema 1.0](http://msdn.microsoft.com/en-us/76e410ec-b1fb-4652-ac98-4a4c52e09a2b)|Ein VSIX-Manifest beschreibt den Inhalt einer VSIX-Bereitstellungsdatei, mit dem Visual Studio-Erweiterung mithilfe von installiert werden können die **Erweiterungen und Updates** Dialogfeld.|  
