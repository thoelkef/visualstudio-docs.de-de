...
ms.locfileid: "47514331"
---
# <a name="walkthrough-creating-a-margin-glyph"></a>Exemplarische Vorgehensweise: Erstellen einer Randglyphe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Exemplarische Vorgehensweise: Erstellen einer Randglyphe](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-a-margin-glyph).  
