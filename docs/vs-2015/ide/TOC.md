...
#### [Vorgehensweise: Hinzufügen und Entfernen von Verweisen mit dem Verweis-Manager](how-to-add-or-remove-references-by-using-the-reference-manager.md)
...
##### [Vorgehensweise: Aktualisieren vorhandener Vorlagen](how-to-update-existing-templates.md)
...
### [How to: Track Your Code by Customizing the Scrollbar (Vorgehensweise: Nachverfolgen von Code durch Anpassen der Scrollleiste)](how-to-track-your-code-by-customizing-the-scrollbar.md)
### [How to: View and Edit Code by Using Peek Definition (Alt+F12) (Vorgehensweise: Anzeigen und Bearbeiten von Code durch Verwenden von „Definition einsehen“)](how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
#### [How to: Restore C# Refactoring Snippets (Vorgehensweise: Wiederherstellen von C#-Umgestaltungsausschnitten)](how-to-restore-csharp-refactoring-snippets.md)
...
#### [Vorgehensweise: Ausschließen von Projekten aus einem Build](how-to-exclude-projects-from-a-build.md)
...
#### [How to: Manage Configurations with Visual Basic Developer Settings Applied (Vorgehensweise: Verwalten von Buildkonfigurationen mit aktivierten Visual Basic Developer-Einstellungen)](how-to-manage-build-configurations-with-visual-basic-developer-settings-applied.md)
...
### [How to: Disable the Hosting Process (Vorgehensweise: Deaktivieren des Hostprozesses)](how-to-disable-the-hosting-process.md)
...
#### [How to: Find Topics in the Index (Vorgehensweise: Suchen von Themen im Index)](how-to-find-topics-in-the-index.md)
##### [Indexsuchtipps](index-search-tips.md)
#### [How to: Find Topics in the Table of Contents (Vorgehensweise: Suchen von Themen im Inhaltsverzeichnis)](how-to-find-topics-in-the-table-of-contents.md)
...
##### [How to: Customize Search Results (Vorgehensweise: Anpassen von Suchergebnissen)](how-to-customize-search-results.md)
...
##### [How to: Manage Word Wrap in the Editor (Vorgehensweise: Verwalten von Zeilenumbrüchen im Editor)](reference/how-to-manage-word-wrap-in-the-editor.md)
