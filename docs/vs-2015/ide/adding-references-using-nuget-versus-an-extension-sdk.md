...
Die neueste Version dieses Themas finden Sie unter [Hinzufügen von verweisen mithilfe von NuGet im Vergleich zu einer Erweiterungs-SDK](https://docs.microsoft.com/visualstudio/ide/adding-references-using-nuget-versus-an-extension-sdk).  
