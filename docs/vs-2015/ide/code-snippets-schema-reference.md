...
ms.locfileid: "47521832"
---
# <a name="code-snippets-schema-reference"></a>Schemareferenz für Codeausschnitte
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schemareferenz für Codeausschnitte](https://docs.microsoft.com/visualstudio/ide/code-snippets-schema-reference).  
