...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen mehrerer Konfigurationen gleichzeitig](https://docs.microsoft.com/visualstudio/ide/how-to-build-multiple-configurations-simultaneously).  
