...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen Sie Vererbung zwischen Typen (Klassen-Designer)](https://docs.microsoft.com/visualstudio/ide/how-to-create-inheritance-between-types-class-designer).  
