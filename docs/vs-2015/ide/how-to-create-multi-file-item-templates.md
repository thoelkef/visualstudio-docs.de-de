...
ms.locfileid: "47513497"
---
# <a name="how-to-create-multi-file-item-templates"></a>Gewusst wie: Erstellen von Elementvorlagen mit mehreren Dateien
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen von mehreren Dateien Elementvorlagen](https://docs.microsoft.com/visualstudio/ide/how-to-create-multi-file-item-templates).  
