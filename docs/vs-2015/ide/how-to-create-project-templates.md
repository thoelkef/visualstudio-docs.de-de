...
ms.locfileid: "47514237"
---
# <a name="how-to-create-project-templates"></a>Gewusst wie: Erstellen von Projektvorlagen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen von Projektvorlagen](https://docs.microsoft.com/visualstudio/ide/how-to-create-project-templates).  
