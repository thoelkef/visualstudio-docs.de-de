...
ms.locfileid: "47522068"
---
# <a name="managing-external-tools"></a>Verwalten von externen Tools
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Verwalten externer Tools](https://docs.microsoft.com/visualstudio/ide/managing-external-tools).  
