...
5. Klicken Sie mit der rechten Maustaste auf den Knoten **Verweise** im Projekt, das den Fehler verursacht hat, und wählen Sie **Verweis hinzufügen**

6. Klicken Sie auf die Registerkarte **Windows** und dann auf die unter Registerkarte **Erweiterungen** . deaktivieren Sie dann die Kontrollkästchen für die alten Erweiterungs-sdche, und aktivieren Sie die Kontrollkästchen für die neuen Erweiterungs-sdker. Klicken Sie auf **OK**.
...
## <a name="see-also"></a>Weitere Informationen
 [Problembehandlung bei fehlerhafte Verweise](../ide/troubleshooting-broken-references.md) [Programmierung mit](https://msdn.microsoft.com/library/25918b15-701d-42c7-95fc-c290d08648d6) Assemblys Gewusst [wie: Hinzufügen oder Entfernen von verweisen mit dem Verweis-Manager](../ide/how-to-add-or-remove-references-by-using-the-reference-manager.md)
