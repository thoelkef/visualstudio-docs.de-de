...
ms.locfileid: "47523578"
---
# <a name="alias-command"></a>Befehl "Alias"
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Befehl "Alias"](https://docs.microsoft.com/visualstudio/ide/reference/alias-command).  
