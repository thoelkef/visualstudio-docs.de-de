...
ms.locfileid: "47521772"
---
# <a name="build-page-project-designer-c"></a>Seite "Erstellen", Projekt-Designer (C#)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Seite "erstellen", Projekt-Designer (c#)](https://docs.microsoft.com/visualstudio/ide/reference/build-page-project-designer-csharp).  
