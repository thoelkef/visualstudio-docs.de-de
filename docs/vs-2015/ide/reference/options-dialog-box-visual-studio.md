...
ms.locfileid: "47521462"
---
# <a name="options-dialog-box-visual-studio"></a>Dialogfeld "Optionen" (Visual Studio)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Dialogfeld "Optionen" (Visual Studio)](https://docs.microsoft.com/visualstudio/ide/reference/options-dialog-box-visual-studio).  
