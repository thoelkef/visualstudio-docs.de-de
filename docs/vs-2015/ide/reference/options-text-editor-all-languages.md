...
ms.locfileid: "47514422"
---
# <a name="options-text-editor-all-languages"></a>Optionen, Text-Editor, Alle Sprachen
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Optionen, Text-Editor, alle Sprachen](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-all-languages).  
