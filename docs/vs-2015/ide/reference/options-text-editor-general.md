...
ms.locfileid: "47522185"
---
# <a name="options-text-editor-general"></a>Optionen, Text-Editor, Allgemein
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Optionen, Text-Editor, Allgemein](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-general).  
