...
ms.locfileid: "47514766"
---
# <a name="prerequisites-dialog-box"></a>Dialogfeld "Erforderliche Komponenten"
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Prerequisites Dialog Box](https://docs.microsoft.com/visualstudio/ide/reference/prerequisites-dialog-box).  
