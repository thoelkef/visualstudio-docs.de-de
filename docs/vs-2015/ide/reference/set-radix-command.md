...
ms.locfileid: "47510600"
---
# <a name="set-radix-command"></a>Befehl "Wurzel setzen"
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Basis-Befehl Set](https://docs.microsoft.com/visualstudio/ide/reference/set-radix-command).  
