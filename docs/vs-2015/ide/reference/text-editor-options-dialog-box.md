...
ms.locfileid: "47524579"
---
# <a name="text-editor-options-dialog-box"></a>Text-Editor-Dialogfeld "Optionen"
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Text-Editor-Optionsdialogfeld](https://docs.microsoft.com/visualstudio/ide/reference/text-editor-options-dialog-box).  
