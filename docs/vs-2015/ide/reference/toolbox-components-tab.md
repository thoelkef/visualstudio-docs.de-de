...
ms.locfileid: "47521508"
---
# <a name="toolbox-components-tab"></a>Toolbox, Registerkarte „Komponenten“
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [in der Toolbox, Registerkarte "Komponenten"](https://docs.microsoft.com/visualstudio/ide/reference/toolbox-components-tab).  
