...
ms.locfileid: "47514737"
---
# <a name="toolbox-data-tab"></a>Toolbox, Daten (Registerkarte )
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [in der Toolbox, Registerkarte "Daten"](https://docs.microsoft.com/visualstudio/ide/reference/toolbox-data-tab).  
...
> [!TIP]
>  Durch Ausführen des Assistenten zum Konfigurieren von Datenquellen werden die meisten Datenelemente automatisch erstellt und konfiguriert. Weitere Informationen finden Sie unter [Erstellen von Datenanwendungen mit Visual Studio](http://msdn.microsoft.com/en-us/28edce21-220a-484c-b461-a75b0232d293).  
