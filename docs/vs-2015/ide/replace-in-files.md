...
## <a name="result-options"></a>Ergebnisoptionen
 ...
 Geänderte Dateien geöffnet lassen, nachdem alle ersetzen aktiviert ist, bleiben alle Dateien geöffnet, in denen Ersetzungen vorgenommen wurden, sodass Sie die Änderungen rückgängig machen oder speichern können. Einschränkungen des Speicherplatzes können die Anzahl von Dateien beeinflussen, die nach einem Ersetzungsvorgang geöffnet bleiben können.
