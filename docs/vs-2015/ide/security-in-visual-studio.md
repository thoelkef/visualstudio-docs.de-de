...
## <a name="coding-for-security"></a>Richtige Codierung zur Gewährleistung der Sicherheit
 ...
 [Secure Coding Guidelines (Richtlinien für das Schreiben von sicherem Code):](http://msdn.microsoft.com/library/4f882d94-262b-4494-b0a6-ba9ba1f5f177) Stellt Richtlinien zum Klassifizieren der Komponenten bereit, um Sicherheitsprobleme zu beheben.

 [Security Best Practices (Empfohlene Vorgehensweisen bezüglich der Sicherheit):](http://msdn.microsoft.com/library/86acaccf-cdb4-4517-bd58-553618e3ec42) Behandelt Pufferüberläufe und beschreibt ausführlich das über das Kompilierzeitflag /GS bereitgestellte Feature für Sicherheitsüberprüfungen von Microsoft Visual C++.
