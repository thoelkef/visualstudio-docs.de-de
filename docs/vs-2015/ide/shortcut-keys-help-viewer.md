...
ms.locfileid: "47521469"
---
# <a name="shortcut-keys-help-viewer"></a>Tastenkombinationen (Help Viewer)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Tastenkombinationen (Help Viewer)](https://docs.microsoft.com/visualstudio/ide/shortcut-keys-help-viewer).  
