...
|ToolBar|Rückschritt<br /><br /> -ODER-<br /><br /> ALT + NACH-LINKS-TASTE|Vorherige Seite anzeigen|
|ToolBar|ALT + NACH-RECHTS-TASTE|Nächste Seite anzeigen|
|ToolBar|ALT + POS1|Startseite von Help Reviewer anzeigen|
|ToolBar|STRG+ S|Markiert das aktuelle Thema im Inhaltsverzeichnis (auf der Registerkarte **„Inhalt“** )|
...
|ToolBar|STRG+P|Druckt die aktuelle Seite|
|ToolBar|STRG + F2|Zeigt eine Druckvorschau der aktuellen Seite an|
|ToolBar|STRG + O|Öffnet das Dialogfeld **Viewer-Optionen**|
...
|Topic|Menütaste<br /><br /> ODER<br /><br /> UMSCHALT + F10|Öffnet das Kontextmenü für das aktuelle UI-Element|
|Topic|NACH-OBEN|Scrollt Zeile für Zeile zum Anfang des Dokuments|
|Topic|NACH-UNTEN|Scrollt Zeile für Zeile zum Anfang des Dokuments|
|Topic|Taste VORHERIGE SEITE|Scrollt Bildschirm für Bildschirm zum Anfang des Dokuments|
|Topic|Taste NÄCHSTE SEITE|Scrollt Bildschirm für Bildschirm zum Anfang des Dokuments|
|Topic|POS1|Springt zum Anfang des Dokuments|
|Topic|Ende|Springt zum Ende des Dokuments|
|Topic|STRG + F|Finden von Suchtext auf dieser Seite|
|Topic|F5|Aktualisiert die aktuelle Seite|
|Topic|STRG+P|Druckt die aktuelle Seite|
|Topic|STRG + F2|Zeigt eine Druckvorschau der aktuellen Seite an|
|Topic|F4|Zeigt das Dialogfeld **Eigenschaften** für die aktuelle Seite an|
|Topic|STRG + T|Öffnet eine andere Registerkarte „Inhalt“ im Vordergrund|
|Topic|STRG + Klick|Öffnet einen Link in einer neuen Registerkarte im Vordergrund|
|Topic|STRG + TAB|Wechselt von links nach rechts zwischen Registerkarten|
|Topic|STRG + UMSCHALT + TAB|Wechselt von rechts nach links zwischen Registerkarten|
|Topic|STRG + W|Schließt die aktuelle Registerkarte|
|Topic|STRG + *Zahl*|Wechselt zu einer bestimmten Registerkarte, wobei *Zahl* zwischen 1 und 9 liegt und angibt, zu welcher Registerkarte gewechselt werden soll|
|Topic|STRG + ALT + F4|Schließt andere Inhaltsregisterkarten|
|Topic|STRG + UMSCHALT + Pluszeichen|Zoomt um 10 % heran|
|Topic|STRG + Minuszeichen|Zoomt um 10 % heraus|
|Topic|STRG + 0 (null)|Ändert den Zoom auf 100 %|
...
|Suche|Esc|Löscht den Inhalt des Suchtextfelds|
...
|Registerkarte|Fokus zum Verschieben ändern **...** Schaltfläche.|
