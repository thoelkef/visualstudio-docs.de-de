...
Die neueste Version dieses Themas finden Sie unter [Schritt 1: Erstellen einer Windows Forms-Anwendungsprojekts](https://docs.microsoft.com/visualstudio/ide/step-1-create-a-windows-forms-application-project).  
