...
ms.locfileid: "47522320"
---
# <a name="step-3-add-a-countdown-timer"></a>Schritt 3: Hinzufügen eines Countdowntimers
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schritt 3: Hinzufügen eines Countdowntimers](https://docs.microsoft.com/visualstudio/ide/step-3-add-a-countdown-timer).  
...
7.  Speichern Sie das Programm, führen Sie es aus, und wählen Sie dann die Schaltfläche **Start** auf dem Formular aus.  
     ...
     ![Mathetest wird durchgeführt](../ide/media/express-addcountdown.png "Express_AddCountdown")  
