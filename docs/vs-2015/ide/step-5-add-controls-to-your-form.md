...
ms.locfileid: "47511905"
---
# <a name="step-5-add-controls-to-your-form"></a>Schritt 5: Hinzufügen von Steuerelementen zum Formular
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schritt 5: Hinzufügen von Steuerelementen zum Formular](https://docs.microsoft.com/visualstudio/ide/step-5-add-controls-to-your-form).  
