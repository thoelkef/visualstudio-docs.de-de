...
ms.locfileid: "47512369"
---
# <a name="step-6-name-your-button-controls"></a>Schritt 6: Benennen der Schaltflächen-Steuerelemente
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Schritt 6: Benennen der Schaltflächen-Steuerelemente](https://docs.microsoft.com/visualstudio/ide/step-6-name-your-button-controls).  
