...
Die neueste Version dieses Themas finden Sie unter [Schritt 8: Schreiben von Code für das zeigt ein Bild-Ereignishandler](https://docs.microsoft.com/visualstudio/ide/step-8-write-code-for-the-show-a-picture-button-event-handler).  
