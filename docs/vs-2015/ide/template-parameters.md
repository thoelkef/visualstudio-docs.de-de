...
ms.locfileid: "47523529"
---
# <a name="template-parameters"></a>Vorlagenparameter
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorlagenparameter](https://docs.microsoft.com/visualstudio/ide/template-parameters).  
