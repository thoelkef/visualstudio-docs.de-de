...
ms.locfileid: "47510663"
---
# <a name="visual-c-classes-in-class-designer"></a>Visual C++-Klassen im Klassen-Designer
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Visual C++-Klassen im Klassen-Designer](https://docs.microsoft.com/visualstudio/ide/visual-cpp-classes-in-class-designer).  
