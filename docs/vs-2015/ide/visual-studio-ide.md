...
Die Ausgabe des Builds, einschließlich der Fehler- oder Erfolgsbenachrichtigungen, wird im **Ausgabefenster** angezeigt. Die **Fehlerliste** zeigt detaillierte Informationen zu Buildfehlern.
