...
Die Ausgabe des Builds, einschließlich der Fehler-oder Erfolgsmeldungen, wird im Fenster **Ausgabe** angezeigt. Auf der **Fehlerliste** werden detaillierte Informationen zu Buildfehlern aufgeführt.
