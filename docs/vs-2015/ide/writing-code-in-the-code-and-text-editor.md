...
|Leerstelle anzeigen|Zeigt Leerzeichen als Hochpunkte und Tabstopps als Pfeile an. Das Ende einer Datei wird als rechteckiges Symbol angezeigt. Wenn Extras > Optionen > Text-Editor > Alle Sprachen > Zeilenumbruch > **sichtbare Symbole für** Zeilenumbruch anzeigen ausgewählt ist, wird dieses Symbol ebenfalls angezeigt.|
 ...
 **Tastaturzuordnung**: Sie können neue Hotkeys definieren oder bestehende Hotkeys in den Einstellungen "Extras &gt; Optionen &gt; Umgebung &gt; Tastatur" neu definieren. Weitere Informationen zu Hotkeys finden Sie unter [Standard Tastenkombinationen](../ide/default-keyboard-shortcuts-in-visual-studio.md).
