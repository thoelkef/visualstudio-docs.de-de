...
1.  Kopieren Sie die benutzerdefinierte AdminDeployment.xml-Datei in eine Netzwerkfreigabe, die schreibgeschützt ist (z. B. \\ \\ *ServerName*\IDEinstall\packages\AdminDeployment.xml).  
