...
|[ASP.NET-Webstapel](https://support.microsoft.com/kb/2902020)|ASP.NET MVC 4<br /><br /> ASP.NET MVC 5<br /><br /> ASP.NET-Web-API<br /><br /> ASP.NET-Web-API 2<br /><br /> ASP.NET Web Pages 2<br /><br /> ASP.NET-Webseiten 3|  
