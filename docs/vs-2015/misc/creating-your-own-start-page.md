...
3.  Entfernen Sie den gesamten Inhalt der Seite verlassen, nur die äußeren Xml-Elemente und das enthaltende <xref:System.Windows.Controls.Grid> -Element, sodass die XAML-Datei das folgende Beispiel ähnelt.  
