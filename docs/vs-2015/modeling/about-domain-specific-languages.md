...
- Netzwerke mit Transport Bändern und Gepäck Behandlungsgeräten für einen Flughafen.
  ...
  ![Tudor-Stammbaummodell](../modeling/media/tudor-familytreemodel.png "Tudor_FamilyTreeModel")
...
## <a name="what-you-can-do-with-dsls"></a>Was Sie mit DSLs tun können
 ...
 Wenn Sie eine DSL definiert haben, können Sie Sie an andere Benutzer verteilen, die Sie auf Ihren eigenen Computern installieren können. Benutzer Ihrer DSL können Modelle in erstellen und bearbeiten [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .
 ...
 [!INCLUDE[dsl](../includes/dsl-md.md)] ermöglicht es Ihnen, eine domänenspezifische Sprache zu erstellen, die über einen eigenen grafischen Designer und eine eigene Diagramm Notation verfügt, und dann die Sprache zu verwenden, um für jedes Projekt den entsprechenden Quellcode zu generieren.
