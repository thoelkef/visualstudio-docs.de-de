...
|Ändern Sie die Größe der Übersicht, und passen Sie sie auf die Fenstergröße an.|Wählen Sie in der Code Map Symbolleiste in der Liste **Zoom** den Wert **Zoom** aus.<br /><br /> - oder -<br /><br /> Klicken Sie auf der Symbolleiste Code Map auf das Symbol Zoom ![Symbol Zoom](../modeling/media/almcodemapzoomicon.png "ALmcodemapzoomicon ") auf **der Symbolleiste** Symbolleiste. Tastatur: Drücken Sie **STRG + 0** (null).|
