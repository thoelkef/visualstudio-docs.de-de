...
Die neueste Version dieses Themas finden Sie unter [anpassen und Erweitern einer domänenspezifischen Sprache](https://docs.microsoft.com/visualstudio/modeling/customizing-and-extending-a-domain-specific-language).  
