...
ms.locfileid: "47515045"
---
# <a name="customizing-copy-behavior"></a>Anpassen des Kopierverhaltens
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Anpassen des Verhaltens beim Kopieren](https://docs.microsoft.com/visualstudio/modeling/customizing-copy-behavior).  
