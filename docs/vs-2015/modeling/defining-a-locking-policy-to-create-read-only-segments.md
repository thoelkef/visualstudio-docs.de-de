...
> Eine Sperr Richtlinie kann mithilfe von Reflektion umgangen werden. Er bietet eine klare Grenze für Entwickler von Drittanbietern, bietet aber keine hohe Sicherheit.
 ...
 Weitere Informationen finden Sie auf der [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Website zum [visualisieren und modellieren von SDK](https://www.microsoft.com/download/details.aspx?id=48148) .
...
|All|Bitweises OR der anderen-Werte.|
