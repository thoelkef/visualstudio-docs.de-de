...
ms.locfileid: "47522844"
---
# <a name="export-diagrams-as-images"></a>Exportieren von Diagrammen als Bild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Exportieren von Diagrammen als Bild](https://docs.microsoft.com/visualstudio/modeling/export-diagrams-as-images).  
