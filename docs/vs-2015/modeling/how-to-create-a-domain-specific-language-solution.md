...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Erstellen einer domänenspezifischen Sprachlösung](https://docs.microsoft.com/visualstudio/modeling/how-to-create-a-domain-specific-language-solution).  
