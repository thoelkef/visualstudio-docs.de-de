...
Die neueste Version dieses Themas finden Sie unter [Integrieren von UML-Modellen in andere Modelle und Tools](https://docs.microsoft.com/visualstudio/modeling/integrate-uml-models-with-other-models-and-tools).  
