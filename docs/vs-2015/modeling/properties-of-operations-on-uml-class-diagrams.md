...
|**Parameter**|(keine)|Eine Liste der Form _Namen_**:**_Typ_**,** _Namen_**:**  _Typ_**,...** Klicken Sie auf **[...]**  so bearbeiten Sie die Liste.<br /><br /> Die Typen können primitive Typen oder im Modell definierte Typen sein. Wenn Sie einen Namen für einen neuen Typ in dieser Eigenschaft eingeben, wird dem Abschnitt **Nicht spezifizierte Typen** des UML-Modell-Explorers ein Typ hinzugefügt.|  
