...
|*Klassendiagramm (UML)*<br /><br /> Thema<br /><br /> -   [UML-Klassendiagramme: Angabe](../modeling/uml-class-diagrams-reference.md)<br />-   [UML-Klassendiagramme: Richtlinien](../modeling/uml-class-diagrams-guidelines.md)|Die bei Besprechungen verwendeten Geschäftsentitäten und Begriffe sowie die Beziehungen zwischen ihnen Beispielsweise sind "Bestellung" und "Menüelement" Teil des Vokabulars in diesem Szenario.|  
 ...
 ![UML-Anwendungsfall Diagramm](../modeling/media/uml-usecase.png "UML_UseCase")  
...
|**Diagramm**|**Beschreibt**|  
|-----------------|-------------------|  
|*Anwendungsfall Diagramm (UML)*<br /><br /> Thema<br /><br /> -   [UML-Anwendungsfall Diagramme: Angabe](../modeling/uml-use-case-diagrams-reference.md)<br />-   [UML-Anwendungsfall Diagramme: Richtlinien](../modeling/uml-use-case-diagrams-guidelines.md)|Ein neuer Anwendungsfall für "Restaurantkritik verfassen"|  
|*Aktivitätsdiagramm (UML)*<br /><br /> Thema<br /><br /> -   [UML-Aktivitätsdiagramme: Angabe](../modeling/uml-activity-diagrams-reference.md)<br />-   [UML-Aktivitätsdiagramme: Richtlinien](../modeling/uml-activity-diagrams-guidelines.md)|Die Schritte, die auftreten, wenn ein Kunde eine Restaurantkritik schreiben möchte|  
|*Klassendiagramm (UML)*<br /><br /> Thema<br /><br /> -   [UML-Klassendiagramme: Angabe](../modeling/uml-class-diagrams-reference.md)<br />-   [UML-Klassendiagramme: Richtlinien](../modeling/uml-class-diagrams-guidelines.md)|Die Daten, die zum Speichern einer Kritik erforderlich sind|  
...
|*Codebasiertes Klassendiagramm*<br /><br /> Weitere Informationen finden Sie unter [How to: Hinzufügen von Klassendiagrammen zu Projekten (](../ide/how-to-add-class-diagrams-to-projects-class-designer.md)Klassen-Designer).|Vorhandene Klassen in Code|  
...
|*Sequenzdiagramm (UML)*<br /><br /> Thema<br /><br /> -   [UML-Sequenzdiagramme: Angabe](../modeling/uml-sequence-diagrams-reference.md)<br />-   [UML-Sequenzdiagramme: Richtlinien](../modeling/uml-sequence-diagrams-guidelines.md)|Die Sequenz der Interaktionen zwischen Instanzen|  
 ...
 ![UML-Komponenten Diagramm](../modeling/media/uml-internal.png "UML_Internal")  
...
#### <a name="summary-strengths-of-component-diagrams"></a>Zusammenfassung: Stärken von Komponenten Diagrammen  
...
#### <a name="summary-strengths-of-code-maps"></a>Zusammenfassung: Stärken von Code Maps  
...
|Klassendiagramm (codebasiert)|Vorhandene Klassen in Code für ein bestimmtes Projekt<br /><br /> Verwenden Sie den Klassen-Designer, um eine vorhandene Klasse in Code zu visualisieren und zu ändern.<br /><br /> Weitere Informationen finden Sie unter [How to: Hinzufügen von Klassendiagrammen zu Projekten (](../ide/how-to-add-class-diagrams-to-projects-class-designer.md)Klassen-Designer).|  
  
### <a name="DescribeSequence"></a>Beschreiben Sie die Interaktionen: Sequenzdiagramme  
...
- Während einer *synchronen* Meldung wartet das Absender Objekt, bis der Steuerungs\<< > > wie in einem regulären Funktions Aufrufwert zurückgibt. Bei einer *asynchronen* Meldung kann der Absender unmittelbar fortfahren.  
  
- Verwenden Sie\<< > > Nachrichten erstellen, um die Erstellung von Objekten durch andere Objekte anzugeben. Dies sollte die erste an das Objekt gesendete Meldung sein.  
...
#### <a name="summary-strengths-of-sequence-diagrams"></a>Zusammenfassung: Stärken von Sequenzdiagrammen  
...
### <a name="DefineClasses"></a>Definieren Sie ein Glossar von Typen: Klassendiagramme  
...
#### <a name="summary-strengths-of-class-diagrams"></a>Zusammenfassung: Stärken von Klassendiagrammen  
...
### <a name="DescribeLayers"></a>Beschreiben Sie die logische Architektur: Ebenendiagramme  
