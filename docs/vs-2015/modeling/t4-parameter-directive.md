...
ms.locfileid: "47523862"
---
# <a name="t4-parameter-directive"></a>T4-Parameter-Anweisung
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [T4-Parameter-Direktive](https://docs.microsoft.com/visualstudio/modeling/t4-parameter-directive).  
...
## <a name="passing-parameter-values-to-a-template"></a>Übergeben von Parameterwerten zu einer Vorlage  
 Wenn Sie schreiben eine [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Erweiterungstypen, z. B. einen Menübefehl oder einen Ereignishandler, können Sie eine Vorlage mithilfe des Textvorlagendiensts verarbeiten:  
