...
ms.locfileid: "47524716"
---
# <a name="uml-model-element-types"></a>UML-Modellelementtypen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [UML-Modellelementtypen](https://docs.microsoft.com/visualstudio/modeling/uml-model-element-types).  
