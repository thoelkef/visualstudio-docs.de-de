...
ms.locfileid: "47513048"
---
# <a name="understanding-the-dsl-code"></a>Grundlegendes zum DSL-Code
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Grundlegendes zum DSL-Code](https://docs.microsoft.com/visualstudio/modeling/understanding-the-dsl-code).  
