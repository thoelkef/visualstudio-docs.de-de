...
#### <a name="to-create-a-modelbus-adapter-that-is-compatible-with-text-templates"></a>So erstellen Sie einen ModelBus-Adapter, der mit Textvorlagen kompatibel ist
