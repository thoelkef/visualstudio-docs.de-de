...
|**Kategorie**|**Links**|
|------------------|---------------|
|**Videos**|![Link zu Video](../data-tools/media/playvideo.gif "Wiedergeben") [Channel 9: Doug 7: Code Verständnis und System Entwurf mit Visual Studio 2010](https://go.microsoft.com/fwlink/?LinkId=216100)<br /><br /> ![Link zu Video](../data-tools/media/playvideo.gif "Playvideo ") [Channel 9: Architektur einer Anwendung mithilfe eines ebenendiagramms](https://go.microsoft.com/fwlink/?LinkID=201117)<br /><br /> ![Link zu Video](../data-tools/media/playvideo.gif "Playvideo ") [MSDN-Gewusst wie-Reihe: Überprüfen von Code mit ebenendiagrammen](https://go.microsoft.com/fwlink/?LinkID=214405)|
