---
title: Arbeiten mit dem domänenspezifischen sprach-Explorer | Microsoft-Dokumentation
ms.date: 11/15/2016
...
- **Verbindungs**-Generatoren. Eine Liste der Verbindungsgeneratoren im Modell. Weitere Informationen zu Verbindungs-Generatoren finden Sie unter [Anpassen der Link Erstellung: Umleitung](../misc/customizing-link-creation-redirection.md).

- **Connectors**. Eine Liste der Verbindungsdiagrammelemente im Modell. Weitere Informationen zu Connectors finden Sie unter [Typen von Formen und Connectors-umleiten](../misc/types-of-shapes-and-connectors-redirect.md).
