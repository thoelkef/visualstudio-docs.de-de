...
ms.locfileid: "47512104"
---
# <a name="assigntargetpath-task"></a>AssignTargetPath-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [AssignTargetPath-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/assigntargetpath-task).  
