...
ms.locfileid: "47513964"
---
# <a name="configuring-targets-and-tasks"></a>Konfigurieren von Zielen und Aufgaben
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Konfigurieren von Zielen und Aufgaben](https://docs.microsoft.com/visualstudio/msbuild/configuring-targets-and-tasks).  
