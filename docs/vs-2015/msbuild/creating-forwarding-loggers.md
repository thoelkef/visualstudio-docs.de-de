...
ms.locfileid: "47513115"
---
# <a name="creating-forwarding-loggers"></a>Erstellen von Weiterleitungsprotokollierungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Erstellen von Weiterleitungsprotokollierungen](https://docs.microsoft.com/visualstudio/msbuild/creating-forwarding-loggers).  
