...
ms.locfileid: "47521009"
---
# <a name="generateresource-task"></a>GenerateResource-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [GenerateResource-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/generateresource-task).  
