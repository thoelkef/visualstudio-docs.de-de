...
ms.locfileid: "47515365"
---
# <a name="getassemblyidentity-task"></a>GetAssemblyIdentity-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [GetAssemblyIdentity-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/getassemblyidentity-task).  
