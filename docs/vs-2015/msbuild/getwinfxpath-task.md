...
ms.locfileid: "47513097"
---
# <a name="getwinfxpath-task"></a>GetWinFXPath-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [GetWinFXPath-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/getwinfxpath-task).  
