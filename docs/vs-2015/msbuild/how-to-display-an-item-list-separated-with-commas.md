...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Anzeigen einer Item List Separated with Commas](https://docs.microsoft.com/visualstudio/msbuild/how-to-display-an-item-list-separated-with-commas).  
