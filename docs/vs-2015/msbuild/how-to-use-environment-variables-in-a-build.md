...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Verwenden von Umgebungsvariablen in einem Build](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-environment-variables-in-a-build).  
