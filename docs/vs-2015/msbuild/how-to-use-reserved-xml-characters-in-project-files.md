...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Verwenden reservierter XML-Zeichen in Projektdateien](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-reserved-xml-characters-in-project-files).  
