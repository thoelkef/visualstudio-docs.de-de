...
|**AdditionalOptions**|Optionaler **String**-Parameter.<br /><br /> Eine Liste von lib.exe-Optionen, wie in der Befehlszeile angegeben. Z. B. ** "_option1/option2 /option#_". Verwenden Sie diesen Parameter, um lib.exe-Optionen anzugeben, die nicht durch einen anderen **LIB**-Aufgabenparameter repräsentiert werden.<br /><br /> Weitere Informationen finden Sie unter [Ausführen von LIB](http://msdn.microsoft.com/library/d54f5c81-7147-4b2c-a8db-68ce6eb1eabd).|  
