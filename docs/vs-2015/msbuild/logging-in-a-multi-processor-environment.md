...
ms.locfileid: "47524538"
---
# <a name="logging-in-a-multi-processor-environment"></a>Protokollierung in einer Multiprozessorumgebung
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Protokollierung in einer Umgebung mit mehreren Prozessoren](https://docs.microsoft.com/visualstudio/msbuild/logging-in-a-multi-processor-environment).  
