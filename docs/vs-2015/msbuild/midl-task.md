...
- **AdditionalIncludeDirectories**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/I**.  
...
- **ApplicationConfigurationMode**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/app_config**.  
...
- **ClientStubFile**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/cstub**. Siehe auch den Parameter **ServerStubFile** in dieser Tabelle.  
...
- **CPreprocessOptions**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/cpp_opt**.  
...
- **DefaultCharType**  
    ...
    |**Ascii**|**/char ascii7**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/char**.  
...
- **DllDataFileName**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/dlldata**.  
...
- **ErrorCheckAllocations**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/error allocation**.  
...
- **ErrorCheckBounds**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/error bounds_check**.  
...
- **ErrorCheckRefPointers**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/error ref**.  
...
- **ErrorCheckStubData**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/error stub_data**.  
...
- **GenerateClientFiles**  
    ...
    |**Stub**|**/client stub**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/client**.  
...
- **GenerateServerFiles**  
    ...
    |**Stub**|**/server stub**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/server**.  
...
- **GenerateStublessProxies**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/Oicf**.  
...
- **GenerateTypeLibrary**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/notlb**.  
...
- **HeaderFileName**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter den Optionen **/h** und **/header**.  
...
- **IgnoreStandardIncludePath**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/no_def_idir**.  
...
- **InterfaceIdentifierFileName**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/iid**.  
...
- **LocaleID**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/lcid**. Siehe auch „Microsoft-Zuweisungen der Gebietsschema-IDs“ auf MSDN.  
...
- **MkTypLibCompatible**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/mktyplib203**. Siehe auch „Syntax der ODL-Datei“ auf MSDN.  
...
- **OutputDirectory**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/out**.  
...
- **PreprocessorDefinitions**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/D**. Siehe auch die Parameter **UndefinePreprocessorDefinitions** in dieser Tabelle.  
...
- **ProxyFileName**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/proxy**.  
...
- **RedirectOutputAndErrors**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/o**.  
...
- **StructMemberAlignment**  
    ...
    |**8**|**/Zp8**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/Zp**. Die Option **/Zp** ist äquivalent zu der Option **/pack** und der älteren Option **/align**.  
...
- **SuppressCompilerWarnings**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/no_warn**.  
...
- **SuppressStartupBanner**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/nologo**.  
...
- **TargetEnvironment**  
    ...
    |**X64**|**/env x64**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/env**.  
...
- **TypeLibFormat**  
    ...
    |**OldFormat**|**/oldtlb**|  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter den Optionen **/newtlb** und **/oldtlb**.  
...
- **TypeLibraryName**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/tlb**.  
...
- **UndefinePreprocessorDefinitions**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/U**. Siehe auch die Parameter **PreprocessorDefinitions** in dieser Tabelle.  
...
- **ValidateAllParameters**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter den Optionen **/robust** und **/no_robist**.  
...
- **WarnAsError**  
     ...
     Weitere Informationen finden Sie auf der [MSDN](https://msdn.microsoft.com/)-Website unter „MIDL-Befehlszeilenreferenz“ unter der Option **/WX**. Siehe auch den Parameter **WarningLevel** in dieser Tabelle.  
