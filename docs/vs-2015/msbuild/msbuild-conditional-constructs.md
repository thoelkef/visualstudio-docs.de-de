...
ms.locfileid: "47510302"
---
# <a name="msbuild-conditional-constructs"></a>MSBuild Conditional Constructs
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [MSBuild Conditional Constructs](https://docs.microsoft.com/visualstudio/msbuild/msbuild-conditional-constructs).  
