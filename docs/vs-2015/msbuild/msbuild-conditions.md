...
## <a name="see-also"></a>Siehe auch  
 ...
 [Exemplarische Vorgehensweise: MSBuild-Projektdatei erstellen von Grund auf neu](../msbuild/walkthrough-creating-an-msbuild-project-file-from-scratch.md)
