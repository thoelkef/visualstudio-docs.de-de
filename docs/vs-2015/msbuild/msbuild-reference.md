...
ms.locfileid: "47514740"
---
# <a name="msbuild-reference"></a>MSBuild-Referenz
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [MSBuild-Referenz](https://docs.microsoft.com/visualstudio/msbuild/msbuild-reference).  
