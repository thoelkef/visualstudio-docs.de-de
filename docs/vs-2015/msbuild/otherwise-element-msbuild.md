...
ms.locfileid: "47510475"
---
# <a name="otherwise-element-msbuild"></a>Otherwise-Element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Otherwise-Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/otherwise-element-msbuild).  
