...
ms.locfileid: "47520688"
---
# <a name="overriding-toolsversion-settings"></a>Überschreiben von ToolsVersion-Einstellungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Überschreiben von ToolsVersion-Einstellungen](https://docs.microsoft.com/visualstudio/msbuild/overriding-toolsversion-settings).  
