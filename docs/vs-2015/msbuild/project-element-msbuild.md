...
|        `Xmlns`         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Erforderliches-Attribut (in MSBuild 15. x und früher).<br /><br /> Das `xmlns`-Attribut muss den Wert `http://schemas.microsoft.com/developer/msbuild/2003`haben.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
