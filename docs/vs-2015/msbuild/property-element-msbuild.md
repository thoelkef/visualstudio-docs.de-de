...
ms.locfileid: "47514733"
---
# <a name="property-element-msbuild"></a>Property-Element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Property-Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/property-element-msbuild).  
