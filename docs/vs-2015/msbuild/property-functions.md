...
ms.locfileid: "47516055"
---
# <a name="property-functions"></a>Eigenschaftenfunktionen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Eigenschaftenfunktionen](https://docs.microsoft.com/visualstudio/msbuild/property-functions).  
