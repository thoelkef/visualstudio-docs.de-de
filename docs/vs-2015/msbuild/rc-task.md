...
Umschließt das Microsoft Windows-Ressourcencompilertool („rc.exe“). Der **RC** -Task kompiliert Ressourcen (z. b. Cursor, Symbole, Bitmaps, Dialogfelder und Schriftarten) in eine Ressourcen Datei (. res). Weitere Informationen finden Sie unter „Ressourcencompiler“ auf der [MSDN](https://msdn.microsoft.com/)-Website.  
