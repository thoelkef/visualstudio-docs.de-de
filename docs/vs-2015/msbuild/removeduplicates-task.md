...
ms.locfileid: "47516061"
---
# <a name="removeduplicates-task"></a>RemoveDuplicates-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [RemoveDuplicates-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/removeduplicates-task).  
