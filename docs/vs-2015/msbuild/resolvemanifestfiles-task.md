...
ms.locfileid: "47516060"
---
# <a name="resolvemanifestfiles-task"></a>ResolveManifestFiles-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [ResolveManifestFiles-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/resolvemanifestfiles-task).  
