...
ms.locfileid: "47510128"
---
# <a name="resolving-assemblies-at-design-time"></a>Auflösen von Assemblys zur Entwurfszeit
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Resolving Assemblies at Design Time Assemblys](https://docs.microsoft.com/visualstudio/msbuild/resolving-assemblies-at-design-time).  
