...
Die neueste Version dieses Themas finden Sie unter [Standard- und benutzerdefinierte Toolsetkonfigurationen](https://docs.microsoft.com/visualstudio/msbuild/standard-and-custom-toolset-configurations).  
