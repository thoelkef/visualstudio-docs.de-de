...
ms.locfileid: "47520421"
---
# <a name="target-build-order"></a>Buildreihenfolge für Ziele
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Buildreihenfolge für Ziele](https://docs.microsoft.com/visualstudio/msbuild/target-build-order).  
