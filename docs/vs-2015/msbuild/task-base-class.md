...
ms.locfileid: "47514044"
---
# <a name="task-base-class"></a>Aufgabenbasisklasse
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Aufgabenbasisklasse](https://docs.microsoft.com/visualstudio/msbuild/task-base-class).  
