...
ms.locfileid: "47520567"
---
# <a name="task-element-msbuild"></a>Aufgabenelement (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Aufgabenelement (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/task-element-msbuild).  
