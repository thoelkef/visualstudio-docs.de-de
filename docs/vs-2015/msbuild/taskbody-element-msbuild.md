...
ms.locfileid: "47512105"
---
# <a name="taskbody-element-msbuild"></a>TaskBody-Element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [TaskBody-Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/taskbody-element-msbuild).  
