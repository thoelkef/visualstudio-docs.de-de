...
ms.locfileid: "47520570"
---
# <a name="tooltaskextension-base-class"></a>ToolTaskExtension-Basisklasse
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [ToolTaskExtension-Basisklasse](https://docs.microsoft.com/visualstudio/msbuild/tooltaskextension-base-class).  
