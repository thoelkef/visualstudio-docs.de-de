...
ms.locfileid: "47512833"
---
# <a name="uidmanager-task"></a>UidManager-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [UidManager-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/uidmanager-task).  
