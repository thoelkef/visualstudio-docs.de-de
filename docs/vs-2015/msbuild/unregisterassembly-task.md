...
ms.locfileid: "47524563"
---
# <a name="unregisterassembly-task"></a>UnregisterAssembly-Aufgabe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [UnregisterAssembly-Aufgabe](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
