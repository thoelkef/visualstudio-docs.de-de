...
Visual Studio enthält [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] , um verwaltete Projekte zu laden und zu erstellen. Da das Projekt über [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] ausgeführt wird, können nahezu alle Projekte im Format von [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]erfolgreich verwendet werden, selbst wenn das Projekt über ein anderes Tool erstellt wurde und über einen angepassten Buildprozess verfügt.  
 ...
 Weitere Informationen über C++-Projekte finden Sie unter [Project Files](/cpp/build/reference/project-files).  
...
## <a name="in-process-compilers"></a>Prozessinterne Compiler  
 Aus Gründen der Leistungssteigerung wird in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] nach Möglichkeit die prozessinterne Version des [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]-Compilers verwendet. (Gilt nicht für [!INCLUDE[csprcs](../includes/csprcs-md.md)] .) Damit dies ordnungsgemäß funktioniert, müssen die folgenden Bedingungen erfüllt sein:  
...
2. Öffnen Sie in **Projektmappen-Explorer**das Kontextmenü für das nicht verfügbare Projekt, und wählen Sie dann **Bearbeiten \<Project File> **aus.  
...
## <a name="intellisense-and-validation"></a>IntelliSense und Validierung  
 Bei Verwendung des XML-Editors zum Bearbeiten von Projektdateien werden IntelliSense und die Validierung über [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] -Schemadateien gesteuert. Diese werden im Schema Cache installiert, der in *\<Visual Studio installation directory>* \xml\schemas\1033\msbuild.  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Starten eines Builds innerhalb der IDE](../msbuild/starting-a-build-from-within-the-ide.md)   
 [Die Erweiterungen des .NET Framework werden registriert.](../msbuild/registering-extensions-of-the-dotnet-framework.md)   
