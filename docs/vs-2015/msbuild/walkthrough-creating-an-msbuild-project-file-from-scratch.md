...
Die neueste Version dieses Themas finden Sie unter [Exemplarische Vorgehensweise: erstellen ein MSBuild-Projektdatei von Grund auf Neu](https://docs.microsoft.com/visualstudio/msbuild/walkthrough-creating-an-msbuild-project-file-from-scratch).  
