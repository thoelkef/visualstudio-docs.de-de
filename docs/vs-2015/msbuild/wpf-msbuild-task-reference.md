...
ms.locfileid: "47510612"
---
# <a name="wpf-msbuild-task-reference"></a>Referenz zu MSBuild-Aufgaben für WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [WPF-MSBuild-Aufgabenreferenz](https://docs.microsoft.com/visualstudio/msbuild/wpf-msbuild-task-reference).  
