...
ms.locfileid: "47522998"
---
# <a name="caller--callee-view----contention-data"></a>Ansicht der Aufrufer/Aufgerufenen – Konfliktdaten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Aufrufer-/ Aufgerufener-Ansicht – Konfliktdaten](https://docs.microsoft.com/visualstudio/profiling/caller-callee-view-contention-data).  
