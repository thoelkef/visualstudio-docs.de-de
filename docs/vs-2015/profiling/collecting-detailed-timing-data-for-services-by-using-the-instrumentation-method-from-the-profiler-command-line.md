...
|----------|---------------------|  
|**Profil für einen .NET-Dienst**|-   [Gewusst wie: Instrumentieren eines .net-Dienstanbieter und Sammeln ausführlicher Zeit Steuerungsdaten](../profiling/how-to-instrument-a-dotnet-service-and-collect-detailed-timing-data-by-using-the-profiler-command-line.md)|  
...
|**Profil eines C/C++-Diensts**|-   [Gewusst wie: Instrumentieren eines nativen Dienstanbieter und Sammeln ausführlicher Zeit Steuerungsdaten](../profiling/how-to-instrument-a-native-service-and-collect-detailed-timing-data-by-using-the-profiler-command-line.md)|  
...
|Aufgabe|Verwandter Inhalt|  
|----------|---------------------|  
|**Profilerstellung für eigenständige (Client-)Anwendungen**|-   [Sammeln ausführlicher Zeit Steuerungsdaten mithilfe der Instrumentierung](../profiling/collecting-detailed-timing-data-for-a-stand-alone-application-by-using-the-profiler-command-line.md)|  
|**Profilerstellung für ASP.NET-Webanwendungen**|-   [Sammeln ausführlicher Zeit Steuerungsdaten mithilfe der Instrumentierung](/visualstudio/profiling/collecting-detailed-timing-data-aspnet-profiler-instrumentation-method?view=vs-2015)|  
