---
title: Sammeln von .NET Framework-Speicherdaten für eigenständige Anwendungen über die Profiler-Befehlszeile | Microsoft-Dokumentation
ms.date: 11/15/2016
...
ms.locfileid: "68158231"
---
# <a name="collecting-net-framework-memory-data-for-stand-alone-applications-by-using-the-profiler-command-line"></a>Sammeln von .NET Framework-Speicherdaten für eigenständige Anwendungen über die Profiler-Befehlszeile
...
|**Instrumentieren einer Anwendung zum Sammeln von .NET-Arbeitsspeicherdaten**|-   [Gewusst wie: Instrumentieren einer eigenständigen .NET Framework Komponente und Sammeln von Speicherdaten mit dem Profiler](/visualstudio/profiling/how-to-instrument-a-dotnet-framework-component-and-collect-memory-data?view=vs-2015)|  
...
|Aufgabe|Verwandter Inhalt|  
|----------|---------------------|  
|**Profilerstellung ASP.NET Anwendungen**|-   [Sammeln von Arbeitsspeicherdaten](../profiling/collecting-memory-data-from-an-aspnet-web-application-by-using-the-profiler-command-line.md)|  
|**Profil Erstellungs Dienste**|-   [Sammeln von .NET-Arbeitsspeicherdaten](../profiling/collecting-memory-data-from-dotnet-framework-services-by-using-the-profiler-command-line.md)|  
