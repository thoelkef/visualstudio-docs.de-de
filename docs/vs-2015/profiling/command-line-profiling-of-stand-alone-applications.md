...
Die neueste Version dieses Themas finden Sie unter [Command-Line Profiling von Stand-Alone Applications](https://docs.microsoft.com/visualstudio/profiling/command-line-profiling-of-stand-alone-applications).  
