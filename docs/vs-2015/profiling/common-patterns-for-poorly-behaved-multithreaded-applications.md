...
Die neueste Version dieses Themas finden Sie unter [häufige Muster von Multithreadanwendungen Poorly-Behaved](https://docs.microsoft.com/visualstudio/profiling/common-patterns-for-poorly-behaved-multithreaded-applications).  
