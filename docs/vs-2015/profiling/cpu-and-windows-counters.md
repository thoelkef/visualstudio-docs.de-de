...
ms.locfileid: "47509629"
---
# <a name="cpu-and-windows-counters"></a>CPU- und Windows-Indikatoren
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [CPU- und Windows-Indikatoren](https://docs.microsoft.com/visualstudio/profiling/cpu-and-windows-counters).  
