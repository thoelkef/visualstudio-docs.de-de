...
ms.locfileid: "47522496"
---
# <a name="cvcreatemarkerseries-function"></a>CvCreateMarkerSeries-Funktion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [CvCreateMarkerSeries-Funktion](https://docs.microsoft.com/visualstudio/profiling/cvcreatemarkerseries-function).  
