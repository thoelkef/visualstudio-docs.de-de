...
Die neueste Version dieses Themas finden Sie unter [DA0007: Verwenden Sie Ausnahmen für die ablaufsteuerung](https://docs.microsoft.com/visualstudio/profiling/da0007-avoid-using-exceptions-for-control-flow).  
