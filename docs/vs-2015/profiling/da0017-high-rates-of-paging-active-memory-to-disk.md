...
Die neueste Version dieses Themas finden Sie unter [DA0017: hohes Maß an paging von aktivem Speicher auf den Datenträger von](https://docs.microsoft.com/visualstudio/profiling/da0017-high-rates-of-paging-active-memory-to-disk).  
