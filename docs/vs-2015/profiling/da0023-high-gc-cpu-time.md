...
ms.locfileid: "47512916"
---
# <a name="da0023-high-gc-cpu-time"></a>DA0023: Hohe GC-CPU-Zeit
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [DA0023: Hohe GC-CPU-Zeit](https://docs.microsoft.com/visualstudio/profiling/da0023-high-gc-cpu-time).  
