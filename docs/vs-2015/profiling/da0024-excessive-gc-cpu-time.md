...
ms.locfileid: "47510666"
---
# <a name="da0024-excessive-gc-cpu-time"></a>DA0024: Übermäßige GC-CPU-Zeit
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [DA0024: Übermäßige GC-CPU-Zeit](https://docs.microsoft.com/visualstudio/profiling/da0024-excessive-gc-cpu-time).  
