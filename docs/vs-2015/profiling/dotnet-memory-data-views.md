...
ms.locfileid: "47522487"
---
# <a name="net-memory-data-views"></a>.NET-Arbeitsspeicherdatenansichten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [.NET Memory Datenansichten](https://docs.microsoft.com/visualstudio/profiling/dotnet-memory-data-views).  
