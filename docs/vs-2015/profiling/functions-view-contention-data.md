...
ms.locfileid: "47512906"
---
# <a name="functions-view---contention-data"></a>Funktionsansicht – Konfliktdaten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Funktionsansicht – Konfliktdaten](https://docs.microsoft.com/visualstudio/profiling/functions-view-contention-data).  
