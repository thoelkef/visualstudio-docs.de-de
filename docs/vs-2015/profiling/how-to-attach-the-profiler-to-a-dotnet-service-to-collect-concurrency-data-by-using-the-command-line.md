...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Anfügen von den Profiler an einen .NET-Dienst zum Sammeln Parallelitätsdaten über die Befehlszeile](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-the-profiler-to-a-dotnet-service-to-collect-concurrency-data-by-using-the-command-line).  
