...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Anfügen von den Profiler an eine ASP.NET-Webanwendung zum Sammeln Parallelitätsdaten über die Befehlszeile](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-the-profiler-to-an-aspnet-web-application-to-collect-concurrency-data-by-using-the-command-line).  
