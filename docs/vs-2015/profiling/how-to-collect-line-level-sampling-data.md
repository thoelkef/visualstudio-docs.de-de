...
ms.locfileid: "47515077"
---
# <a name="how-to-collect-line-level-sampling-data"></a>Gewusst wie: Sammeln von Samplingdaten auf Zeilenebene
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Sammeln von .NET-Profilerstellungsdaten auf Zeilenebene Samplingdaten](https://docs.microsoft.com/visualstudio/profiling/how-to-collect-line-level-sampling-data).  
