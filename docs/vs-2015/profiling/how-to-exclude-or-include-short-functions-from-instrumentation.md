...
ms.locfileid: "60078589"
---
# <a name="how-to-exclude-or-include-short-functions-from-instrumentation"></a>Vorgehensweise: Schließen Sie aus oder einschließen Sie kurzer Funktionen in die Instrumentierung
