...
Die neueste Version dieses Themas finden Sie unter [How to: Limit Instrumentation auf bestimmte Funktionen](https://docs.microsoft.com/visualstudio/profiling/how-to-limit-instrumentation-to-specific-functions).  
