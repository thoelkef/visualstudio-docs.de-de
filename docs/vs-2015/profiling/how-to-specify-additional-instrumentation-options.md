...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Angeben zusätzlicher Instrumentierungsoptionen](https://docs.microsoft.com/visualstudio/profiling/how-to-specify-additional-instrumentation-options).  
