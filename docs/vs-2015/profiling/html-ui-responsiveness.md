...
ms.locfileid: "47510618"
---
# <a name="html-ui-responsiveness"></a>HTML-UI-Reaktionsfähigkeit
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Analysieren der HTML-UI-Reaktionsfähigkeit in UWP-Apps](https://docs.microsoft.com/visualstudio/profiling/html-ui-responsiveness).  
