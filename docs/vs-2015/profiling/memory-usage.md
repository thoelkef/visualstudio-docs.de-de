...
ms.locfileid: "47513405"
---
# <a name="memory-usage"></a>Speicherauslastung
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Analysieren der Speicherauslastung in Visual Studio](https://docs.microsoft.com/visualstudio/profiling/memory-usage).  
