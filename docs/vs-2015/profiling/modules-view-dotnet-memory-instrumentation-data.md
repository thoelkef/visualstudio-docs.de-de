...
Die neueste Version dieses Themas finden Sie unter [Modulansicht – Profiler-Instrumentationsdaten für .NET Memory](https://docs.microsoft.com/visualstudio/profiling/modules-view-dotnet-memory-instrumentation-data).  
