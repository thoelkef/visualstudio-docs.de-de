...
ms.locfileid: "47515646"
---
# <a name="modules-view---sampling-data"></a>Modulansicht – Profiler-Samplingdaten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Modulansicht – Profiler-Samplingdaten](https://docs.microsoft.com/visualstudio/profiling/modules-view-sampling-data).  
