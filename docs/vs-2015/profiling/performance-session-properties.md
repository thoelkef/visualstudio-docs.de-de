...
ms.locfileid: "47510909"
---
# <a name="performance-session-properties"></a>Eigenschaften von Leistungssitzungen
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Eigenschaften von Leistungssitzungen](https://docs.microsoft.com/visualstudio/profiling/performance-session-properties).  
