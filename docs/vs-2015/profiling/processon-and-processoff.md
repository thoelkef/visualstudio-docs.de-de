...
ms.locfileid: "47516340"
---
# <a name="processon-and-processoff"></a>ProcessOn und ProcessOff
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [ProcessOn und ProcessOff](https://docs.microsoft.com/visualstudio/profiling/processon-and-processoff).  
