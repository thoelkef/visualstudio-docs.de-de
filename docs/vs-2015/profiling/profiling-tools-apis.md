...
ms.locfileid: "47508987"
---
# <a name="profiling-tools-apis"></a>APIs für Profilerstellungstools
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [APIs der Profilerstellungstools](https://docs.microsoft.com/visualstudio/profiling/profiling-tools-apis).  
