...
ms.locfileid: "47509339"
---
# <a name="summary-view---instrumentation-data"></a>Zusammenfassungansicht – Instrumentationsdaten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Zusammenfassung-Ansicht – Instrumentationsdaten](https://docs.microsoft.com/visualstudio/profiling/summary-view-instrumentation-data).  
