...
ms.locfileid: "47513102"
---
# <a name="summary-view---sampling-data"></a>Zusammenfassungsansicht – Samplingdaten
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Zusammenfassungsansicht – Samplingdaten](https://docs.microsoft.com/visualstudio/profiling/summary-view-sampling-data).  
