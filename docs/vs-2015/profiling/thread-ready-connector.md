...
ms.locfileid: "47509216"
---
# <a name="thread-ready-connector"></a>Threadbereiter Konnektor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [threadbereite Connector Thread](https://docs.microsoft.com/visualstudio/profiling/thread-ready-connector).  
