...
ms.locfileid: "47523045"
---
# <a name="threads-view-parallel-performance"></a>Threadansicht (Parallele Leistung)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Threadansicht (parallele Leistung)](https://docs.microsoft.com/visualstudio/profiling/threads-view-parallel-performance).  
