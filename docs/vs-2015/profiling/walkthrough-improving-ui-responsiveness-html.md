...
Die neueste Version dieses Themas finden Sie unter [Exemplarische Vorgehensweise: Verbessern der UI-Reaktionsfähigkeit (HTML)](https://docs.microsoft.com/visualstudio/profiling/walkthrough-improving-ui-responsiveness-html).  
