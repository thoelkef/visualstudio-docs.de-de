...
ms.locfileid: "47510559"
---
# <a name="walkthrough-using-profiler-apis"></a>Exemplarische Vorgehensweise: Verwenden von Profiler-APIs
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Exemplarische Vorgehensweise: Verwenden von Profiler-APIs](https://docs.microsoft.com/visualstudio/profiling/walkthrough-using-profiler-apis).  
