...
Jetzt müssen Sie [Python installieren](https://www.python.org/download/). Python wird von der Community verwaltet, und die Startseite ist Python.org. Continuum Analytics erzeugt ein kostenloses Bündel namens Anaconda, das Python und viele nützliche Bibliotheken (insbesondere für die Wissenschaft und die Datenverarbeitung) enthält. das enthought erzeugt ein ähnliches Bündel namens Canopy. Sie müssen jedoch nur eines dieser Produkte installieren. Wenn Sie sich nicht sicher sind, beginnen Sie mit [Anaconda](https://www.anaconda.com/products/individual). Damit erhalten Sie eine aktuelle Python-Version und die meisten der schwieriger zu installierenden Pakete.
