...
ms.locfileid: "47513503"
---
# <a name="anatomy-of-a-coded-ui-test"></a>Anatomy of a Coded UI Test
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Anatomie eines Tests der programmierten UI](https://docs.microsoft.com/visualstudio/test/anatomy-of-a-coded-ui-test).  
