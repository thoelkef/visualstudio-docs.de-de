...
ms.locfileid: "47590609"
---
# <a name="customizing-code-coverage-analysis"></a>Anpassen der Code Coverage-Analyse
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Anpassen von Code Coverage-Analyse](https://docs.microsoft.com/visualstudio/test/customizing-code-coverage-analysis).  
