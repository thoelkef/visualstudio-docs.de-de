...
## <a name="open-a-coded-ui-test"></a>Einen Test der codierten UI öffnen
 ...
 ![Kontextmenü mit Coded UI-Test-Generator bearbeiten](../test/media/editcodeduitest.png "Editcodeduitest")
...
## <a name="CodedUITestEditor_SplitMethods"></a> Eine Testmethode in zwei separate Methoden aufteilen
 ...
 ![SPLT a Testmethode](../test/media/codeduitestsplitmethod1.png "CodedUITestSplitMethod1")
...
## <a name="CodedUITestEditor_LocateUIControl"></a> Suchen eines UI-Steuerelements in der getesteten Anwendung
 ...
 ![Steuerelement in der getesteten Anwendung](../test/media/codeduilocatecontrol2.png "CodedUILocateControl2")
...
## <a name="CodedUITestEditor_LocateDecendants"></a> Suchen eines Steuerelements und seiner Nachfolgerelemente
 ...
 ![Alle Nachfolger Steuerelemente suchen](../test/media/codeduilocateall.png "Codeduilocateall")
...
## <a name="CodedUITestEditor_InsertDelay"></a> Einfügen einer Verzögerung vor einer UI-Aktion
 ...
 ![Verzögerung vor einer UI-Aktion einfügen](../test/media/codeduidelay.png "Codeduidelay")
