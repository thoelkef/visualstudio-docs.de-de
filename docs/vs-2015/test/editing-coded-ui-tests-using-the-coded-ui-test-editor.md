...
Die neueste Version dieses Themas finden Sie unter [Editing Coded UI-Tests mit dem Editor für Tests der programmierten UI](https://docs.microsoft.com/visualstudio/test/editing-coded-ui-tests-using-the-coded-ui-test-editor).  
...
Bearbeiten der Eigenschaften der UI-Aktion  
 ...
 Gibt z. B. wenn ein Server nicht verfügbar ist und Sie eine UI-Aktion, die Ihrem Webbrowser zugeordnet haben, die **wechseln Sie zur Webseite 'http://Contoso1/default.aspx"**, könnten Sie die URL zum Ändern `‘ http://Contoso2/default.aspx’`.  
