...
Die neueste Version dieses Themas finden Sie unter [Isolieren von getestetem Code mithilfe von Microsoft Fakes](https://docs.microsoft.com/visualstudio/test/isolating-code-under-test-with-microsoft-fakes).  
