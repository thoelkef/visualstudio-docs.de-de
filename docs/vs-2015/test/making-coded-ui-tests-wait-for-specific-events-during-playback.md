...
Die neueste Version dieses Themas finden Sie unter [machen Coded UI Tests warten Sie, während der Wiedergabe auf bestimmte Ereignisse](https://docs.microsoft.com/visualstudio/test/making-coded-ui-tests-wait-for-specific-events-during-playback).  
