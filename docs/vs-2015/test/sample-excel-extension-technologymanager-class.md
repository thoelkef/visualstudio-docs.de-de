...
ms.locfileid: "47510397"
---
# <a name="sample-excel-extension-technologymanager-class"></a>Sample Excel Extension: TechnologyManager Class
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Beispiel für Excel-Erweiterung: TechnologyManager-Klasse](https://docs.microsoft.com/visualstudio/test/sample-excel-extension-technologymanager-class).  
