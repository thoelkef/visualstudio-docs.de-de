...
Die neueste Version dieses Themas finden Sie unter [Test-Windows-UWP- und 8.1-Store-Apps mit Tests der programmierten UI](https://docs.microsoft.com/visualstudio/test/test-windows-store-8-1-apps-with-coded-ui-tests).  
