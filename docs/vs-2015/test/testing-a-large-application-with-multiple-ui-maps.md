...
ms.locfileid: "47512185"
---
# <a name="testing-a-large-application-with-multiple-ui-maps"></a>Testing a Large Application with Multiple UI Maps
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Testen einer großen Anwendung mit mehreren UI-Zuordnungen](https://docs.microsoft.com/visualstudio/test/testing-a-large-application-with-multiple-ui-maps).  
