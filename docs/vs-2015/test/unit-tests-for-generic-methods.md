...
ms.locfileid: "47514385"
---
# <a name="unit-tests-for-generic-methods"></a>Komponententests für generische Methoden
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Komponententests für generische Methoden](https://docs.microsoft.com/visualstudio/test/unit-tests-for-generic-methods).  
