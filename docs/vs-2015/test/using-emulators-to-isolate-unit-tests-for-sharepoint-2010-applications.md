...
- [Ausführen einer Testmethode mit Emulation](#BKMK__Running_a_test_method_in_the_emulation_context)
  ...
  [Verwenden der Attribute "TestInitialize" und "TestCleanup" zum Erstellen einer Dual-Use-Testklasse](#BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class)
...
## <a name="the-appointmentswebpart-example"></a><a name="BKMK_The_AppointmentsWebPart_example"></a> Das Beispiel ""
...
## <a name="converting-an-existing-test"></a><a name="BKMK_Converting_an_existing_test"></a> Ein vorhandener Test wird umgerechnet.
...
### <a name="adding-the-emulators-package-to-a-test-project"></a><a name="BKMK_Adding_the_Emulators_package_to_a_test_project"></a> Hinzufügen des Emulatorpakets zu einem Testprojekt
...
### <a name="running-a-test-method-with-emulation"></a><a name="BKMK__Running_a_test_method_in_the_emulation_context"></a> Ausführen einer Testmethode mit Emulation
...
## <a name="creating-dual-use-classes-and-methods"></a><a name="BKMK_Creating_dual_use_classes_and_methods"></a> Erstellen von zweifach verwendbaren Klassen und Methoden
...
## <a name="using-testinitialize-and-testcleanup-attributes-to-create-a-dual-use-test-class"></a><a name="BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class"></a> Verwenden der Attribute „TestInitialize“ und „TestCleanup“ zur Erstellung einer zweifach verwendbaren Testklasse
...
## <a name="handling-non-emulated-sharepoint-methods"></a><a name="BKMK_Handling_non_emulated_SharePoint_methods"></a> Behandeln von nicht emulierten SharePoint-Methoden
...
## <a name="writing-emulation-tests-from-scratch-and-a-summary"></a><a name="BKMK_Writing_emulation_tests_from_scratch__and_a_summary"></a> Vollständig Verfassen von Emulations Tests und eine Zusammenfassung
...
## <a name="emulated-sharepoint-types"></a><a name="BKMK_Emulated_SharePoint_types"></a> Emulierten SharePoint-Typen
...
## <a name="see-also"></a>Weitere Informationen
 Komponenten [Test Code](../test/unit-test-your-code.md) [Testen von SharePoint 2010-Anwendungen mit Coded UI-Tests](../test/testing-sharepoint-2010-applications-with-coded-ui-tests.md) [webleistungs-und Auslastungs Tests SharePoint 2010 und 2013-Anwendungen](https://msdn.microsoft.com/library/20c2e469-0e4e-4296-a739-c0e8fff36e54) [entwickeln von SharePoint-Lösungen](https://msdn.microsoft.com/library/059bce0f-c301-4234-a0b4-9c14b7cdfa3e)
