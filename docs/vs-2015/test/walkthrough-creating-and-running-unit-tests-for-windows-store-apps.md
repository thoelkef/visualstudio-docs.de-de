...
### <a name="msdn-library"></a>MSDN Library
 [MSDN Library – Erstellen und Ausführen von Komponententests für vorhandenen Code (Visual Studio 2010)](https://msdn.microsoft.com/library/hh270865(v=vs.110).aspx)
