---
title: 'Vorgehensweise: Erstellen einer Zustands Automat-Workflow Bibliothek (Legacy) | Microsoft-Dokumentation'
ms.date: 11/15/2016
...
5. Wählen Sie im Bereich **Vorlagen** die Option **Zustands Automat-Workflow Bibliothek**aus.
...
## <a name="see-also"></a>Siehe auch
 Erstellen von [Zustands Automaten Workflows](https://msdn.microsoft.com/library/344caacd-bf3b-4716-bd5a-eca74fc5a61d) für [Legacy Workflow Projekte](../workflow-designer/creating-legacy-workflow-projects.md)