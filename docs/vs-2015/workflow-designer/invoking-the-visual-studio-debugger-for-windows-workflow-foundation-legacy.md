---
title: Aufrufen des Debuggers für Windows Workflow Foundation (Vorgängerversion) | Microsoft-Dokumentation
ms.date: 11/15/2016
...
## <a name="see-also"></a>Siehe auch
 [Vorgehensweise: Festlegen von Haltepunkten in Workflows (Vorgängerversion)](../workflow-designer/how-to-set-breakpoints-in-workflows-legacy.md) [Debuggen von Legacyworkflows](../workflow-designer/debugging-legacy-workflows.md)