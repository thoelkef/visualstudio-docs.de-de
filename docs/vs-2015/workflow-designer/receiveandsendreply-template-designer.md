...
|         <xref:System.ServiceModel.Activities.SendReply.Action%2A>          |  False   |                                                                                                                                                                                                                                              Gibt den Aktionsheader der Nachricht an. Ist er nicht explizit festgelegt, lautet sein Standardwert:<br /><br /> <strong>https://tempuri.org/{service Vertrag Namespace} / {Dienstvertragsname} / {Vorgangsname}</strong>                                                                                                                                                                                                                                              |
