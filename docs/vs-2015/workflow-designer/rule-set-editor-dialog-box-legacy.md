...
In diesem Thema wird beschrieben, wie Sie das Dialogfeld **Regelsatz-Editor** in der Legacy-[!INCLUDE[wfd1](../includes/wfd1-md.md)] verwenden. Verwenden Sie die Vorgängerversion von [!INCLUDE[wfd2](../includes/wfd2-md.md)], wenn Sie entweder auf [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] oder [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)] abzielen möchten.
 ...
 Das Dialogfeld **Regelsatz-Editor** wird verwendet, um [PolicyActivity](http://go.microsoft.com/fwlink?LinkID=65019) -Regelsätze zu erstellen und zu ändern, die in eine rules-Datei serialisiert werden.
...
```
 ...
 Weitere Informationen zur Verwendung von **Update** mit vorwärts Verkettung finden Sie unter [Verwenden der PolicyActivity-Aktivität](http://go.microsoft.com/fwlink?LinkID=65004).

## <a name="see-also"></a>Siehe auch
 [PolicyActivity](http://go.microsoft.com/fwlink?LinkID=65019) - [Dialog Feld "Regelsatz auswählen" (Legacy)](../workflow-designer/select-rule-set-dialog-box-legacy.md) [mithilfe der PolicyActivity-Aktivität unter](http://go.microsoft.com/fwlink?LinkID=65004) [Verwendung von Bedingungen in Workflows](http://go.microsoft.com/fwlink?LinkID=65009)