...
### <a name="using-the-transactionscope-activity-designer"></a>Verwenden des TransactionScope-Aktivitätsdesigners
 Der **transaktionscope** -Aktivitäts Designer befindet sich in der Kategorie **Transaktion** der **Toolbox**, auf die Sie zugreifen können, indem Sie in [!INCLUDE[wfd2](../includes/wfd2-md.md)] auf die Registerkarte **Toolbox** klicken (Sie können auch **Symbolleiste** aus der **Ansicht** auswählen. Menü oder STRG + ALT + X.)
...
## <a name="see-also"></a>Siehe auch
 [Abschluss](../workflow-designer/compensate-activity-designer.md) [Bestätigung für](../workflow-designer/confirm-activity-designer.md) [Transaktion](../workflow-designer/transaction-activity-designers.md) [terminateworkflow](../workflow-designer/terminateworkflow-activity-designer.md) [CompensableActivity](../workflow-designer/compensableactivity-activity-designer.md)