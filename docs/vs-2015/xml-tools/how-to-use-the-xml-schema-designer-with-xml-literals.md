...
Die neueste Version dieses Themas finden Sie unter [Vorgehensweise: Verwenden des XML-Schema-Designers mit XML-Literalen](https://docs.microsoft.com/visualstudio/xml-tools/how-to-use-the-xml-schema-designer-with-xml-literals).  
