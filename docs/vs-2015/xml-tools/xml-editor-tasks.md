...
ms.locfileid: "47524921"
---
# <a name="xml-editor-tasks"></a>Aufgaben im XML-Editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Aufgaben im XML-Editor](https://docs.microsoft.com/visualstudio/xml-tools/xml-editor-tasks).  
