...
ms.locfileid: "47510619"
---
# <a name="xml-schema-designer-workspace"></a>Arbeitsbereich des XML-Schema-Designers
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [Arbeitsbereich des XML-Schema-Designers](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-designer-workspace).  
