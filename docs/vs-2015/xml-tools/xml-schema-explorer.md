...
ms.locfileid: "47512371"
---
# <a name="xml-schema-explorer"></a>XML-Schema-Explorer
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Die neueste Version dieses Themas finden Sie unter [XML-Schema-Explorer](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-explorer).  
