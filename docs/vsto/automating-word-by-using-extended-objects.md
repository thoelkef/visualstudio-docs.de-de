...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Word [Office-Entwicklung in Visual Studio], Automatisierung"
  - "Erweiterte Objekte [Office-Entwicklung in Visual Studio], Word"
  - "Automatisierung [Office-Entwicklung in Visual Studio], Word"
  - "Hostelemente [Office-Entwicklung in Visual Studio], Word"
  - "Automatisieren von Word"
  - "Steuerelemente [Office-Entwicklung in Visual Studio], Word-Hoststeuerelemente"
  - "Hoststeuerelemente, Word"
  - "Hoststeuerelemente [Office-Entwicklung in Visual Studio], Word"
