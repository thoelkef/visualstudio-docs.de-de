...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Office-Entwicklung in Visual Studio, Erste Schritte"
  - "FAQs (Häufig gestellte Fragen) [Office-Entwicklung in Visual Studio]"
  - "Office-Entwicklung in Visual Studio, häufig gestellte Fragen (FAQs)"
...
### Steuerelemente in Dokumenten und Arbeitsblättern  
...
### Aufgabenbereiche in VSTO\-Add\-Ins  
...
-   [Gewusst wie: Programmgesteuertes Anzeigen einer Zeichenfolge in einer Arbeitsblattzelle](../vsto/how-to-programmatically-display-a-string-in-a-worksheet-cell.md).  
...
### Zwischengespeicherte Daten in Projektmappen auf Dokumentebene  
...
-   [Gewusst wie: Veröffentlichen einer Office\-Projektmappe mithilfe von ClickOnce](http://msdn.microsoft.com/de-de/2b6c247e-bc04-4ce4-bb64-c4e79bb3d5b8).  
  
-   [Gewusst wie: Veröffentlichen einer Office\-Projektmappe auf Dokumentebene auf einem SharePoint Server mithilfe von ClickOnce](http://msdn.microsoft.com/de-de/2408e809-fb78-42a1-9152-00afa1522e58).  
...
-   [Gewusst wie: Installieren der erforderlichen Komponenten auf Endbenutzercomputern zum Ausführen von Office\-Projektmappen](http://msdn.microsoft.com/de-de/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98).  
  
-   [Gewusst wie: Vorbereiten von IIS für die Bereitstellung von Office\-Projektmappen](http://msdn.microsoft.com/de-de/f62bce70-81d4-4f8b-86e6-2f2afec5d9b4).  
  
-   [Gewusst wie: Aktualisieren von bereitgestellten Office\-Projektmappen](http://msdn.microsoft.com/de-de/be96db53-b6ea-46ab-b8d9-b76b098b3b13).  
