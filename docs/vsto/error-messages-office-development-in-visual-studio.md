---
title: Fehlermeldungen (Office-Entwicklung in Visual Studio) | Microsoft Docs
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
|||  
|-|-|  
|F1|Wenn eine Fehlermeldung angezeigt wird, können Sie F1 drücken. Dadurch wird das entsprechende Thema der Onlinedokumentation zur Fehlermeldung geöffnet.|  
