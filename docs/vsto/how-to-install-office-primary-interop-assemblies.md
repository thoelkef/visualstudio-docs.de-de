---
title: "Vorgehensweise: Installieren von primären Interopassemblys für Office | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-install-office-primary-interop-assemblies"></a>Gewusst wie: Installieren von primären Interopassemblys für Office
...
2.  Installieren Sie Microsoft Office und stellen Sie sicher, dass die **.NET-Programmierunterstützung für** Funktion ausgewählt ist, für die Anwendungen, die Sie erweitern möchten (dieses Feature ist in der Standardinstallation enthalten).  
  
    > [!WARNING]  
    >  Standardmäßig werden PIAS in Ihre Projektmappe eingebettet, wenn Sie sie erstellen, Sie müssen also keine PIAs als Voraussetzung für die Verwendung von Ihr VSTO-Add-in oder Ihre Anpassung an Benutzer verteilen.  
