---
title: "Vorgehensweise: Programmgesteuertes Hinzufügen eines Eintrags zu Outlook-Kontakten | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
# <a name="how-to-programmatically-add-an-entry-to-outlook-contacts"></a>Gewusst wie: Programmgesteuertes Hinzufügen eines Eintrags zu Outlook-Kontakten
  In diesem Beispiel erstellt einen neuen Kontakt und Daten in den neuen Kontakt gelangt.  
