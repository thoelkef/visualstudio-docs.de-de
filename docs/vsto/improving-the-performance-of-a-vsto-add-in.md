...
2.  Erstellen Sie ein Postbuildereignis, das die Registrierung mithilfe des Skripts aktualisiert.  
    ...
    ```  
     ...
     Informationen über das Erstellen von Postbuildereignis in eine C# Projekt, finden Sie unter [wie: Angeben von Buildereignissen &#40;C&#35;&#41;](/visualstudio/ide/how-to-specify-build-events-csharp).  
  
     Weitere Informationen zur Verwendung ein postbuildereignisses in einem Visual Basic-Projekt zu erstellen, finden Sie unter [wie: Angeben von Buildereignissen &#40;Visual Basic&#41;](/visualstudio/ide/how-to-specify-build-events-visual-basic).  
