...
1.  Installieren Sie Microsoft Office-Anwendung, die den Projekttyp, einschließlich der primären Interop-Assemblys zugeordnet. Weitere Informationen zu unterstützten Versionen von Microsoft Office finden Sie unter [konfigurieren ein Computers zum Entwickeln von Office-Projektmappen](../vsto/configuring-a-computer-to-develop-office-solutions.md).  
