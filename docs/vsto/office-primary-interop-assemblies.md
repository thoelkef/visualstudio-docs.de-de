...
##  <a name="separateassemblies"></a> Separate primäre interop-Assemblys erstellen und Ausführen von Projekten  
...
##  <a name="usingfeatures"></a> Verwenden von Funktionen mehrerer Microsoft Office-Anwendungen in einem einzelnen Projekt  
 ...
 In den meisten Fällen sollten Sie Verweise auf die PIAs, die von Visual Studio unter dem *%ProgramFiles%\Microsoft Visual Studio 12. 0\Visual Studio Tools für Office\PIA installiert sind hinzufügen\* Verzeichnis. Diese Versionen der Assemblys werden im Dialogfeld **Verweis-Manager** auf der Registerkarte **Framework** angezeigt. Weitere Informationen finden Sie unter [Vorgehensweise: Target Office-Anwendungen durch primäre Interopassemblys](../vsto/how-to-target-office-applications-through-primary-interop-assemblies.md).  
...
##  <a name="pialist"></a> Primäre Interopassemblys für Microsoft Office-Anwendungen  
