...
# PowerPoint-Projektmappen
 ...
 ![Link zu Video](~/data-tools/media/playvideo.gif "Link zu Video") Eine entsprechende Videodemo finden Sie unter [Gewusst wie: Erstellen eines Add\-Ins für Microsoft PowerPoint](http://go.microsoft.com/fwlink/?LinkId=132767).  
