...
## <a name="add-a-ribbon-visual-designer-item-to-a-project"></a>Hinzufügen eines Elements von Menüband (visueller Designer) zu einem Projekt  
 Um dem Menüband-Designer zu verwenden, fügen Sie ein neues **Menüband (visueller Designer)** Element zu Ihrem Projekt. Weitere Informationen finden Sie unter [wie: Erste Schritte beim Anpassen des Menübands](../vsto/how-to-get-started-customizing-the-ribbon.md).  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Gewusst wie: Exportieren eines Menübands vom Menüband-Designer in Menüband-XML](../vsto/how-to-export-a-ribbon-from-the-ribbon-designer-to-ribbon-xml.md)   
