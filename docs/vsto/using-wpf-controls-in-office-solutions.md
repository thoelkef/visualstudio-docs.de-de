...
ms.locfileid: "34767594"
---
# <a name="use-wpf-controls-in-office-solutions"></a>Verwenden von WPF-Steuerelementen in Office-Projektmappen
...
5.  Fügen Sie dem Projekt einen Aktionsbereich, einen Formularbereich oder einen benutzerdefinierten Aufgabenbereich hinzu:  
    ...
    -   Für benutzerdefinierte Aufgabenbereiche, Hinzufügen einer **Benutzersteuerelement** Element aus, um das Projekt. Weitere Informationen finden Sie unter [wie: Hinzufügen ein benutzerdefinierten Aufgabenbereichs zu einer Anwendung](../vsto/how-to-add-a-custom-task-pane-to-an-application.md).  
...
## <a name="host-wpf-controls-by-using-the-elementhost-class"></a>Host-WPF-Steuerelementen mithilfe der ElementHost-Klasse  
...
-   [Interoperabilität Eingabearchitektur für Windows Forms und WPF](/dotnet/framework/wpf/advanced/windows-forms-and-wpf-interoperability-input-architecture)  
...
-   [Windows Forms-Steuerelemente und entsprechende WPF-Steuerelementen](/dotnet/framework/wpf/advanced/windows-forms-controls-and-equivalent-wpf-controls)  
...
-   [Exemplarische Vorgehensweise: Erstellen Sie neuen WPF-Inhalts in Windows Forms zur Entwurfszeit](/dotnet/framework/winforms/advanced/walkthrough-creating-new-wpf-content-on-windows-forms-at-design-time)  
...
-   [Exemplarische Vorgehensweise: Stil WPF-Inhalt](/dotnet/framework/winforms/advanced/walkthrough-styling-wpf-content)  
