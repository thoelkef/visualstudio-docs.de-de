---
title: "&#220;bersicht &#252;ber die Visual Studio Tools for Office-Laufzeit | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Office-Laufzeit [Office-Entwicklung in Visual Studio], Informationen zur Office-Laufzeit"
  - "VSTOLoader.dll"
  - "Laufzeitladeprogramm [Office-Entwicklung in Visual Studio]"
  - "Office-Laufzeit [Office-Entwicklung in Visual Studio], Assemblys"
  - "Office-Laufzeit [Office-Entwicklung in Visual Studio]"
  - "Laufzeit [Office-Entwicklung in Visual Studio], Assemblys"
  - "vstoee.dll"
  - "Visual Studio-Tools für Office-Laufzeit"
  - "Office-Projektmappen [Office-Entwicklung in Visual Studio], Laufzeit"
  - "Projektmappen [Office-Entwicklung in Visual Studio], Laufzeit"
  - "Versionen [Office-Entwicklung in Visual Studio], Laufzeit"
  - "Assemblys [Office-Entwicklung in Visual Studio], Laufzeit"
  - "Laufzeit [Office-Entwicklung in Visual Studio], Informationen über die VSTO-Laufzeit"
  - "Projektmappenladeprogramm [Office-Entwicklung in Visual Studio]"
  - "Laufzeit [Office-Entwicklung in Visual Studio]"
...
# &#220;bersicht &#252;ber die Visual Studio Tools for Office-Laufzeit
  Um Projektmappen auszuführen, die mit Microsoft Office Developer Tools in Visual Studio erstellt wurden, muss Visual Studio 2010\-Tools für Office\-Laufzeit auf den Endbenutzercomputern installiert sein. Weitere Informationen finden Sie unter [Gewusst wie: Installieren der verteilbaren Visual Studio Tools for Office Runtime](../vsto/how-to-install-the-visual-studio-tools-for-office-runtime-redistributable.md). Visual Studio 2010\-Tools für Office\-Laufzeit besteht aus zwei Hauptkomponenten:  
...
-   Dem Office\-Projektmappenladeprogramm. Bei dieser Komponente handelt es sich um einen Satz nicht verwalteter DLLs, die Office\-Anwendungen verwenden, um die Laufzeit und Projektmappen zu laden. Weitere Informationen finden Sie unter [Grundlegendes zum Office\-Projektmappenladeprogramm](#UnmanagedLoader).  
 ...
 Die Laufzeit kann auf unterschiedliche Weise installiert werden. In Abhängigkeit von der Konfiguration des Computers werden unterschiedliche Laufzeitkomponenten installiert, wenn Sie die Laufzeit installieren. Weitere Informationen finden Sie unter [Laufzeitinstallationsszenarios für Visual Studio Tools for Office](../vsto/visual-studio-tools-for-office-runtime-installation-scenarios.md).  
...
### Aktivieren von Typäquivalenz und eingebetteten Typen in Projekten, die auf .NET Framework 4 oder höher ausgerichtet sind  
...
##  <a name="UnmanagedLoader"></a> Grundlegendes zum Office\-Projektmappenladeprogramm  
 ...
 Informationen darüber, wie diese Komponenten während des Ladevorgangs verwendet werden, finden Sie unter [Architektur von Anpassungen auf Dokumentebene](../vsto/architecture-of-document-level-customizations.md) und unter [Architektur von VSTO-Add-Ins](../vsto/architecture-of-vsto-add-ins.md)  
...
-   Es implementiert die IManagedAddin\-Schnittstelle. Diese Schnittstelle wird von Office\-Anwendungen beim Laden von VSTO\-Add\-Ins verwendet. Weitere Informationen finden Sie unter [IManagedAddin-Schnittstelle](../vsto/imanagedaddin-interface.md).  
