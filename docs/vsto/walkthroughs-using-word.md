...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Exemplarische Vorgehensweisen [Office-Entwicklung in Visual Studio], Word"
  - "Word [Office-Entwicklung in Visual Studio], Exemplarische Vorgehensweisen"
...
## Exemplarische Vorgehensweisen auf Dokumentebene  
 ...
 Zeigt , wie Text einem Word\-Dokument hinzugefügt wird, wenn Benutzer Text in Steuerelemente in einem Aktionsbereich eingeben.  
...
## Exemplarische Vorgehensweisen auf Anwendungsebene  
 ...
 Veranschaulicht, wie eine benutzerdefinierte Registerkarte des Menübands mithilfe einer XML\-Beschreibungsdatei in einem VSTO\-Add\-In erstellt wird.  
...
## Siehe auch  
 ...
 [Exemplarische Vorgehensweisen für Anpassungen der Office-Benutzeroberfläche](../vsto/office-ui-customization-walkthroughs.md)   
