...
---
# <a name="working-with-worksheets"></a>Arbeiten mit Arbeitsblättern
...
|Aufgabe|Prozedur|  
|----------|---------------|  
|Hinzufügen eines neuen Arbeitsblatts zu einer Arbeitsmappe.|[Vorgehensweise: Programmgesteuertes Hinzufügen neuer Arbeitsblätter zu Arbeitsmappen](../vsto/how-to-programmatically-add-new-worksheets-to-workbooks.md)|  
...
|Durchlaufen der Auflistung aller Arbeitsblätter.|[Vorgehensweise: Programmgesteuertes Auflisten aller Arbeitsblätter in einer Arbeitsmappe](../vsto/how-to-programmatically-list-all-worksheets-in-a-workbook.md)|  
