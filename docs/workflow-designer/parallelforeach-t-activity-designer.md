...
Greifen Sie auf den **ParallelForEach-\<T >** Aktivitäts Designer in der Kategorie **Ablauf Steuerung** der **Toolbox**zu.

Der **ParallelForEach-\<T >** Aktivitäts Designer kann aus der **Toolbox** gezogen und auf der Workflow-Designer-Oberfläche dort abgelegt werden, wo Aktivitäts Designer normalerweise platziert werden (z. b. innerhalb einer **Sequenz** Aktivität). Designer. Nach dem ablegen im Workflow-Designer wird eine <xref:System.Activities.Statements.ParallelForEach%601>-Aktivität erstellt, die standardmäßig eine <xref:System.Activities.Activity.DisplayName%2A> von **ParallelForEach < Int32 \> enthält.**
