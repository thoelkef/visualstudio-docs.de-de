---
title: Hinzufügen von Knoten zu Arbeitsbereich aus der Ausgangsansicht im XML-Schema-Designer
ms.date: 11/04/2016
ms.topic: conceptual
...
In diesem Thema wird beschrieben, wie globale Knoten hinzufügen der [XML-Schema-Designer-Arbeitsbereich](../xml-tools/xml-schema-designer-workspace.md) aus der [Ausgangsansicht](../xml-tools/start-view.md).
