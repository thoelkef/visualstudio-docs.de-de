---
title: 'Vorgehensweise: Verwenden von XML-Ausschnitte | Microsoft Docs'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
> [!NOTE]
>  Die **Ausschnitt einfügen** Befehl steht auch über die Tastenkombination (STRG + K, anschließend STRG + X).  
