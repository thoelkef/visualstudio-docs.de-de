...
2. Fügen Sie den Cursor nach `<xsl:stylesheet version="1.0">` ein, und drücken **Sie die Eingabe**Taste Geben Sie dann das folgende `xsl:namespace-alias`-Element ein:
