...
## [Activation (Aktivierung)](activation.md)
...
### [Extending Visual Studio for Mac Walkthrough (Exemplarische Vorgehensweise: Erweitern von Visual Studio für Mac)](extending-visual-studio-mac-walkthrough.md)
