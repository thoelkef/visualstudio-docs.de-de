...
JavaScript Runtime (JsRT)-APIs ermöglichen Ihnen, Desktopanwendungen und serverseitigen Anwendungen, die unter Windows ausgeführt werden, Skriptfunktionen hinzufügen.  
 ...
 Wenn Sie [ChakraCore](https://github.com/Microsoft/ChakraCore) in Ihre Anwendung einbetten möchten, finden Sie unter [ChakraCore Wiki](http://aka.ms/corejsrtref) die für Sie relevanten JsRT-Referenzdokumentationen.  
