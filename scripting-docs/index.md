...
description: Erfahren Sie, wie Sie Visual Studio 2017 zum Erstellen von Anwendungen verwenden.
...
ms.locfileid: "54956804"
---
# <a name="javascript-in-visual-studio"></a>JavaScript in Visual Studio

Visual Studio stellt mehrere unterschiedliche Tools bereit, die Sie beim Erstellen von Apps mithilfe von JavaScript oder TypeScript unterstützen.

<h2>Informationen zum Verwenden von JavaScript in Visual Studio mit 5-minütigen Schnellstarts</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einfachen Node.js-App</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer Vue.js-App</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer universellen Windows-App (UWP)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer App mit ASP.NET und AngularJS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer Node.js-App mit Express</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer Node.js-App mit React</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen einer App mit Apache Cordova</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>JavaScript-Sprachreferenz</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>JavaScript-Laufzeithosting</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Windows-Skriptschnittstellen (Archiv)</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>JScript und VBScript (Archiv)</h3>
                    </div>
                </div>
            </div>
        </div>
