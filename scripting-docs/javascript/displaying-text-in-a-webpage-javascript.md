---
title: "Anzeigen von Text auf einer Webseite (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# Anzeigen von Text auf einer Webseite (JavaScript)
...
-   Um Text anzuzeigen, wird empfohlen, ein Element zu erstellen und in seine [textContent](http://msdn.microsoft.com/de-de/e530667f-f8fa-4b6d-a47c-4d5c75e71265)\-Eigenschaft zu schreiben:  
    ...
    ```  
     ...
     In diesem Beispiel ist „my text“ der Wert des `text`\-Parameters.  Der Wert, der von der Eigenschaft [textContent](http://msdn.microsoft.com/de-de/e530667f-f8fa-4b6d-a47c-4d5c75e71265) auf einem übergeordneten Knoten abgerufen bzw. in dieser festgelegt wird, kann jedoch Text von den untergeordneten Elementen des Knotens enthalten.  Das folgende Beispiel zeigt, dass der [textContent](http://msdn.microsoft.com/de-de/e530667f-f8fa-4b6d-a47c-4d5c75e71265), der in einem untergeordneten Knoten festgelegt ist, im [textContent](http://msdn.microsoft.com/de-de/e530667f-f8fa-4b6d-a47c-4d5c75e71265)\-Wert des übergeordneten Knotens enthalten ist:  
...
-   Sie können auch ein Element erstellen und in seine [innerHTML](http://msdn.microsoft.com/library/ie/ms533897\(v=vs.85\).aspx)\- oder [innerText](http://msdn.microsoft.com/library/ie/ms533899\(v=vs.85\).aspx)\-Eigenschaften schreiben.  Das Festlegen dieser Eigenschaften beeinflusst nur den Text im Element selbst, nicht den in den untergeordneten Elementen.  Diese Eigenschaften haben allerdings auch einige Nachteile:  
    ...
    -   Die [innerText](http://msdn.microsoft.com/library/ie/ms533899\(v=vs.85\).aspx)\-Eigenschaft wird nicht in allen Browsern unterstützt. Sie sollten sie daher aus Gründen der Kompatibilität vermeiden.  
  
    -   Die [innerText](http://msdn.microsoft.com/library/ie/ms533899\(v=vs.85\).aspx)\-Eigenschaft wird von CSS\-Formatvorlagen beeinflusst und nicht angezeigt, wenn das Element ausgeblendet ist.  
