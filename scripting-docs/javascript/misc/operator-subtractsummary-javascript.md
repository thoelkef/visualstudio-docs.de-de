...
## <a name="computational-operators"></a>Arithmetische Operatoren  
  
|Operator|Symbol|  
|--------------|------------|  
|[Hinzufügen](../../javascript/reference/addition-operator-decrement-javascript.md)|+|  
|[Dekrementoperatoren](../../javascript/reference/increment-and-decrement-operators-javascript.md)|--|  
...
|Operator|Symbol|  
|--------------|------------|  
|[Durch Trennzeichen](../../javascript/reference/comma-operator-decrement-javascript.md)|,|  
...
|[Ungleichheitsoperator](../../javascript/reference/comparison-operators-javascript.md)|!=|  
...
|[Bitweiser Left Shift](../../javascript/reference/bitwise-left-shift-operator-decrement-javascript.md)|<\<|  
...
|[Bitweiser Right-Shift](../../javascript/reference/bitwise-right-shift-operator-decrement-javascript.md)|>>|  
|[Bitweises XOR](../../javascript/reference/bitwise-xor-operator-decrement-hat-javascript.md)|^|  
|[Ohne Vorzeichen nach rechts verschieben](../../javascript/reference/unsigned-right-shift-operator-decrement-javascript.md)|>>>|  
...
## <a name="miscellaneous-operators"></a>Verschiedene Operatoren  
 [Löschen](../../javascript/reference/delete-operator-decrementjavascript.md)  
