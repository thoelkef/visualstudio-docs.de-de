---
title: Buffer-Eigenschaft (DataView) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633620"
---
# <a name="buffer-property-dataview"></a>buffer-Eigenschaft (DataView)
...
## <a name="example"></a>Beispiel  
 Das folgende Beispiel zeigt, wie die Länge des ArrayBuffer abgerufen zugrunde liegenden DataView.  
