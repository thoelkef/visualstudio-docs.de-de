---
title: BYTES_PER_ELEMENT-Konstante (Float32Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633570"
---
# <a name="bytesperelement-constant-float32array"></a>BYTES_PER_ELEMENT-Konstante (Float32Array)
