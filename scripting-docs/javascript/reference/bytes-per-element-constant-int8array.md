---
title: BYTES_PER_ELEMENT-Konstante (Int8Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633900"
---
# <a name="bytesperelement-constant-int8array"></a>BYTES_PER_ELEMENT-Konstante (Int8Array)
