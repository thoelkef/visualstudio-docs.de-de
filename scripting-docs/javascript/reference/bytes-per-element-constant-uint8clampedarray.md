---
title: BYTES_PER_ELEMENT-Konstante (Uint8ClampedArray) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633810"
---
# <a name="bytesperelement-constant-uint8clampedarray"></a>BYTES_PER_ELEMENT-Konstante (Uint8ClampedArray)
