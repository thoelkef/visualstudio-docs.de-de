...
|Operator|Symbol|  
|--------------|------------|  
|[Hinzufügen](../../javascript/reference/addition-assignment-operator-decrement-equal-javascript.md)|+=|  
...
|[Ohne Vorzeichen nach rechts verschieben](../../javascript/reference/unsigned-right-shift-assignment-operator-decrement-equal-javascript.md)|>>>=|  
