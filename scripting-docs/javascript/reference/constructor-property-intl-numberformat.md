---
title: Constructor-Eigenschaft (Intl.NumberFormat) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636110"
---
# <a name="constructor-property-intlnumberformat"></a>constructor-Eigenschaft (Intl.NumberFormat)
Gibt die Funktion an, durch die ein Formatierer erstellt wird.  
...
## <a name="remarks"></a>Hinweise  
 Der erforderliche `numberFormatter` ist der Name des Formatierers.  
