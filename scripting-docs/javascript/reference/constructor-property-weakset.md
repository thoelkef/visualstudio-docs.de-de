---
title: Constructor-Eigenschaft (WeakSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636130"
---
# <a name="constructor-property-weakset"></a>constructor-Eigenschaft (WeakSet)
Gibt die Funktion an, durch die `WeakSet` erstellt wird.  
...
## <a name="remarks"></a>Hinweise  
 Der erforderliche `weakset` ist der Name des Satzes.  
