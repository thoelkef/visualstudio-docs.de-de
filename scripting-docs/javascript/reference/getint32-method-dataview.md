...
ms.locfileid: "24636570"
---
# <a name="getint32-method-dataview"></a>getInt32-Methode (DataView)
Ruft den Int32-Wert am angegebenen Byteoffset vom Beginn der Ansicht ab. Es ist keine Einschränkung der Ausrichtung. Multi-Byte-Werte können aus jeder Offset abgerufen werden.  
...
## <a name="parameters"></a>Parameter  
 `testInt`  
 Erforderlich. Den Int32-Wert, der von der Methode zurückgegeben wird.  
...
## <a name="example"></a>Beispiel  
 Im folgende Beispiel wird gezeigt, wie der erste Int32 in der DataView abgerufen wird.  
