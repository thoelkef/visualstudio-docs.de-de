...
|[ScriptEngineMinorVersion\-Funktion](../../javascript/reference/scriptengineminorversion-function-javascript.md)|Gibt die Nebenversionsnummer des verwendeten Skriptmoduls zurück.|`Global`|  
