...
ms.locfileid: "24642910"
---
# <a name="javascript-methods"></a>JavaScript-Methoden
Die folgende Tabelle enthält [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] Methoden.  
...
|[Apply-Methode](../../javascript/reference/apply-method-function-javascript.md)|Eine Methode eines Objekts, Ersetzen ein anderes Objekt für das aktuelle Objekt angewendet wird.|`Function`|  
...
|[Big-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<BIG >-Tags um Text.|`String`|  
|[BIND-Methode](../../javascript/reference/bind-method-function-javascript.md)|Erstellt eine Funktion, die mit einem angegebenen Objekt verknüpft ist und für die können bestimmte Startparametern.|`Function`|  
|[blink-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<BLINK >-Tags um Text.|`String`|  
|[Bold-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<B >-Tags um Text.|`String`|  
...
|[CharAt-Methode](../../javascript/reference/charat-method-string-javascript.md)|Gibt das Zeichen am angegebenen Index zurück.|`String`|  
...
|[Compile-Methode](../../javascript/reference/compile-method-regular-expression-javascript.md)|Wird einen regulären Ausdruck in ein internes Format kompiliert.|`Regular Expression`|  
...
|[Concat-Methode (String)](../../javascript/reference/concat-method-string-javascript.md)|Gibt eine `String` Objekt, das die Verkettung von zwei angegebenen Zeichenfolgen enthält.|`String`|  
...
|[Exec-Methode](../../javascript/reference/exec-method-regular-expression-javascript.md)|Führt eine Suche nach einer Übereinstimmung in einer angegebenen Zeichenfolge.|`Regular Expression`|  
|[Filtermethode](../../javascript/reference/filter-method-array-javascript.md)|Ruft eine definierte Rückruffunktion für jedes Element eines Arrays auf und gibt ein Array von Werten zurück, für das die Rückruffunktion `true` zurückgibt.|`Array`|  
|[Fixed-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<TT >-Tags um Text.|`String`|  
|[Fontcolor-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<FONT >-Tags mit einem COLOR-Attribut, um den Text.|`String`|  
|[FontSize-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<FONT >-Tags mit einem SIZE-Attribut, um den Text.|`String`|  
|[foreach-Methode](../../javascript/reference/foreach-method-array-javascript.md)|Ruft eine definierte Rückruffunktion für jedes Element in einem Array auf.|`Array`|  
...
|[GetTimezoneOffset-Methode](../../javascript/reference/gettimezoneoffset-method-date-javascript.md)|Gibt den Unterschied zwischen der Zeit auf dem Hostcomputer und UTC (Universal Coordinated Time) in Minuten zurück.|`Date`|  
...
|[GetVarDate-Methode](../../javascript/reference/getvardate-method-date-javascript.md)|Gibt den `Date`-Wert in einem -Objekt zurück.|`Date`|  
...
|[IndexOf-Methode (String)](../../javascript/reference/indexof-method-string-javascript.md)|Gibt die Position des Zeichens, das erste Vorkommen einer Teilzeichenfolge innerhalb tritt, einer `String` Objekt.|`String`|  
...
|[Italics-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<ich >-Tags um Text.|`String`|  
...
|[LastIndexOf-Methode (String)](../../javascript/reference/lastindexof-method-string-javascript.md)|Gibt das letzte Vorkommen einer Teilzeichenfolge innerhalb einer `String` Objekt.|`String`|  
|[Lbound-Methode](../../javascript/reference/lbound-method-vbarray-javascript.md)|Gibt die niedrigsten Indexwert in der angegebenen Dimension des ein VBArray verwendet.|`VBArray`|  
...
|[LocaleCompare-Methode](../../javascript/reference/localecompare-method-string-javascript.md)|Gibt einen Wert, der angibt, ob zwei Zeichenfolgen im aktuellen Gebietsschema gleich sind.|`String`|  
...
|[Match-Methode](../../javascript/reference/match-method-string-javascript.md)|Gibt als ein Array zurück, die Ergebnisse einer Suche für eine Zeichenfolge mit einer angegebenen **reguläre** Objekt.|`String`|  
|[MoveFirst-Methode](../../javascript/reference/movefirst-method-enumerator-javascript.md)|Setzt das aktuelle Element in der Sammlung auf das erste Element zurück|`Enumerator`|  
...
|[Replace-Methode](../../javascript/reference/replace-method-string-javascript.md)|Gibt eine Kopie einer Zeichenfolge durch Text ersetzt, mit einem regulären Ausdruck zurück.|`String`|  
...
|[Search-Methode](../../javascript/reference/search-method-string-javascript.md)|Gibt die Position der ersten übereinstimmenden Teilzeichenfolge in einer Suche mit einem regulären Ausdruck zurück.|`String`|  
...
|[Shift-Methode](../../javascript/reference/shift-method-array-javascript.md)|Entfernt das erste Element aus einem Array und gibt es zurück.|`Array`|  
|[Slice-Methode (Array)](../../javascript/reference/slice-method-array-javascript.md)|Gibt einen Abschnitt eines Arrays zurück.|`Array`|  
|[Slice-Methode (String)](../../javascript/reference/slice-method-string-javascript.md)|Gibt einen Abschnitt einer Zeichenfolge zurück.|`String`|  
|[Small-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<kleine >-Tags um Text.|`String`|  
...
|[strike-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<STRIKE >-Tags um Text.|`String`|  
|[Sub-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<SUB >-Tags um Text.|`String`|  
|[Substr-Methode](../../javascript/reference/substr-method-string-javascript.md)|Gibt eine Teilzeichenfolge zurück, die an der angegebenen Position beginnt und eine angegebene Länge hat.|`String`|  
...
|[sup-Methode](../../javascript/reference/html-tag-methods-javascript.md)|Fügt HTML \<SUP >-Tags um Text.|`String`|  
|[Test-Methode](../../javascript/reference/test-method-regular-expression-javascript.md)|Gibt einen booleschen Wert, der angibt, ob ein Muster in einer durchsuchten Zeichenfolge vorhanden ist.|`Regular Expression`|  
|[ToArray-Methode](../../javascript/reference/toarray-method-vbarray-javascript.md)|Gibt ein [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] -Standardarray zurück, das aus einem VBArray konvertiert wurde.|`VBArray`|  
...
|[ToExponential-Methode](../../javascript/reference/toexponential-method-number-javascript.md)|Gibt eine Zeichenfolge, die in Exponentialnotation dargestellte Zahl enthält.|`Number`|  
|[ToFixed-Methode](../../javascript/reference/tofixed-method-number-javascript.md)|Gibt eine Zeichenfolge, die Zahl in Festkommanotation darstellt.|`Number`|  
...
|[ToJSON-Methode](../../javascript/reference/tojson-method-date-javascript.md)|Wird verwendet, um Daten eines Objekttyps vor der JSON-Serialisierung zu transformieren.|`Date`|  
...
|[ToLocaleLowerCase-Methode](../../javascript/reference/tolocalelowercase-method-string-javascript.md)|Gibt eine Zeichenfolge zurück, in der alle alphabetische Zeichen in Kleinbuchstaben konvertiert wurden unter Berücksichtigung aktuellen Gebietsschemas der hostumgebung.|`String`|  
...
|[ToLocaleUpperCase-Methode](../../javascript/reference/tolocaleuppercase-method-string-javascript.md)|Gibt eine Zeichenfolge zurück, in dem alle alphabetische Zeichen in Großbuchstaben unter Berücksichtigung der Host konvertiert Umgebung aktuelle Gebietsschema worden ist.|`String`|  
|[ToLowerCase-Methode](../../javascript/reference/tolowercase-method-javascript.md)|Gibt eine Zeichenfolge zurück, in der alle alphabetische Zeichen in Kleinbuchstaben konvertiert wurden.|`String`|  
|[ToPrecision-Methode](../../javascript/reference/toprecision-method-number-javascript.md)|Gibt eine Zeichenfolge, die eine Zahl enthält, die entweder in Exponentialnotation oder in Festkommanotation Notation mit einer angegebenen Anzahl von Ziffern dargestellt.|`Number`|  
...
|[ToUpperCase-Methode](../../javascript/reference/touppercase-method-string-javascript.md)|Gibt eine Zeichenfolge zurück, in der alle alphabetische Zeichen in Großbuchstaben konvertiert wurden.|`String`|  
|[ToUTCString-Methode](../../javascript/reference/toutcstring-method-date-javascript.md)|Gibt ein Datum zurück, das anhand der UTC in eine Zeichenfolge konvertiert wurde.|`Date`|  
...
|[Ubound-Methode](../../javascript/reference/ubound-method-vbarray-javascript.md)|Gibt den höchsten Indexwert zurück, der in der angegebenen Dimension im VBArray verwendet wird|`VBArray`|  
