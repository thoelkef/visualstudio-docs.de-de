...
|Verschiebt die Bits eines Ausdrucks nach links.|[Bitweiser Linksschiebeoperator (<\<)](../../javascript/reference/bitwise-left-shift-operator-decrement-javascript.md)|  
...
|Führt eine bitweise OR-Operation für zwei Ausdrücke durch.|[Bitweise OR-Operator (&#124;)](../../javascript/reference/bitwise-or-operator-decrement-javascript.md)|  
...
|Dekrementiert eine Variable in Einerschritten.|[Dekrementoperator (--)](../../javascript/reference/increment-and-decrement-operators-javascript.md)|  
...
|Vergleicht zwei Ausdrücke, um zu bestimmen, ob ein Ausdruck kleiner oder gleich dem anderem ist.|[Kleiner als oder gleich-Operator (\<=)](../../javascript/reference/comparison-operators-javascript.md)|  
