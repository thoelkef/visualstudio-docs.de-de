...
|[$1...$9\-Eigenschaften](../../javascript/reference/dollar-1-dot-dot-dot-dollar-9-properties-regexp-javascript.md)|Gibt die neun zuletzt gespeicherten Teile zurück, die während des Mustervergleichs gefunden wurden.|`RegExp`|  
...
|[global\-Eigenschaft](../../javascript/reference/global-property-regular-expression-javascript.md)|Gibt einen booleschen Wert zurück, der den Zustand des mit einem regulären Ausdruck verwendeten global\-Flags \(**g**\) angibt.|`Regular Expression`|  
|[ignoreCase\-Eigenschaft](../../javascript/reference/ignorecase-property-regular-expression-javascript.md)|Gibt einen booleschen Wert zurück, der den Zustand des mit einem regulären Ausdruck verwendeten ignoreCase\-Flags \(**i**\) angibt.|`Regular Expression`|  
...
|[length\-Eigenschaft \(Arguments\)](../../javascript/reference/length-property-arguments-javascript.md)|Gibt die tatsächliche Anzahl der Argumente zurück, die von der aufrufenden Routine an eine Funktion übergeben wurden.|`arguments`|  
...
|[length\-Eigenschaft \(Function\)](../../javascript/reference/length-property-function-javascript.md)|Gibt die Anzahl der für eine Funktion definierten Argumente zurück.|`Function`|  
...
|[multiline\-Eigenschaft](../../javascript/reference/multiline-property-regular-expression-javascript.md)|Gibt einen booleschen Wert zurück, der den Zustand des mit einem regulären Ausdruck verwendeten multiline\-Flags \(**m**\) angibt.|`Regular Expression`|  
