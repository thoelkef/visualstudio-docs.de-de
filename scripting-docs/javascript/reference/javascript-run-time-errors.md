...
ms.locfileid: "24640800"
---
# <a name="javascript-run-time-errors"></a>JavaScript-Laufzeitfehler
...
## <a name="windows-runtime-errors"></a>Windows-Runtime-Fehler  
...
|5019|[Erwartet ' &#93; "in regulärem Ausdruck](../../javascript/misc/expected-right-square-bracket-in-regular-expression-javascript.md)|  
