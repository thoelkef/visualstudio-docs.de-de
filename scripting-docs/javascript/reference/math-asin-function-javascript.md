...
## Hinweise  
 Das erforderliche `number`\-Argument ist ein numerischer Ausdruck, für den der Arkussinus benötigt wird.  
  
 Der Rückgabewert ist der im Bogenmaß angegebene Arkussinus des `number`\-Arguments.  
