---
title: Math.Atanh-Funktion (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639340"
---
# <a name="mathatanh-function-javascript"></a>Math.atanh-Funktion (JavaScript)
Gibt den umgekehrten Hyperbeltangens einer Zahl zurück.  
...
## <a name="remarks"></a>Hinweise  
 Wenn `x` gleich `NaN` ist, lautet das Ergebnis `NaN`.  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Math.Asinh-Funktion](../../javascript/reference/math-asinh-function-javascript.md)   
 ...
 [Math.cosh-Funktion](../../javascript/reference/math-cosh-function-javascript.md)   
 ...
 [Math.tanh-Funktion](../../javascript/reference/math-tanh-function-javascript.md)