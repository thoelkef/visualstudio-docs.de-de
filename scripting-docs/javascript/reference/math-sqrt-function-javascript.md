---
title: Math.SQRT-Funktion (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638430"
---
# <a name="mathsqrt-function-javascript"></a>Math.sqrt-Funktion (JavaScript)
...
## <a name="remarks"></a>Hinweise  
 ...
 Wenn `number` ist negativ, wird der Rückgabewert `NaN`.  
