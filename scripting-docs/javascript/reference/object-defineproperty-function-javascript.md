...
dev_langs: 
  ...
  - "DHTML"
helpviewer_keywords: 
  - "defineProperty-Funktion [JavaScript]"
  - "Object.defineProperty-Funktion [JavaScript]"
...
## Parameter  
 ...
 `descriptor`  
 Erforderlich.  Ein Deskriptor für die Eigenschaft.  Er kann sich auf eine Dateneigenschaft oder eine Accessoreigenschaft beziehen.  
...
-   Ändert Attribute einer vorhandenen Eigenschaft.  Dies geschieht, wenn das Objekt den angegebenen Eigenschaftennamen bereits enthält.  
 ...
 Um einem Objekt mehrere Eigenschaften hinzuzufügen oder mehrere vorhandene Eigenschaften zu ändern, können Sie die [Object.defineProperties\-Funktion](../../javascript/reference/object-defineproperties-function-javascript.md). verwenden.  
...
-   Das Objekt ist nicht [erweiterbar](../../javascript/reference/object-isextensible-function-javascript.md), und der angegebene Eigenschaftenname ist nicht vorhanden.  
...
## Hinzufügen einer Dateneigenschaft  
...
## Hinzufügen einer Accessor\-Eigenschaft  
...
## Ändern einer Accessor\-Eigenschaft  
...
## Ändern einer Eigenschaft in einem DOM\-Element  
