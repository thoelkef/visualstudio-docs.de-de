...
|-----------------|------------------|  
|[\_\_proto\_\_\-Eigenschaft](../../javascript/reference/proto-property-object-javascript.md)|Gibt den Prototyp für ein Objekt an.|  
...
|[Object.getOwnPropertyDescriptor\-Funktion](../../javascript/reference/object-getownpropertydescriptor-function-javascript.md)|Gibt die Definition einer Dateneigenschaft oder der Accessoreigenschaft zurück.|  
...
|[Object.is\-Funktion](../../javascript/reference/object-is-function-javascript.md)|Gibt einen Wert zurück, der angibt, ob zwei Werte gleich sind.|  
