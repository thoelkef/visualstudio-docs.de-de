---
title: Subarray-Methode (Uint8Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24640040"
---
# <a name="subarray-method-uint8array"></a>subarray-Methode (Uint8Array)
Ruft eine neue Uint8Array-Ansicht des der [ArrayBuffer-Objekt](../../javascript/reference/arraybuffer-object.md) -Speichers für dieses Array ab und gibt die erste und letzte Member des Unterarrays.  
