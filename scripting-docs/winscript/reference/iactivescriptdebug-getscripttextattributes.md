...
---
# IActiveScriptDebug::GetScriptTextAttributes
Gibt die Textattribute für einen beliebigen Block Skripttext zurück.  
...
#### Parameter  
 `pstrCode`  
 \[in\] Der Skriptblocktext.  Diese Zeichenfolge muss, nicht NULL sein beendet.  
...
## Hinweise  
 ...
 Diese Methode für Skriptblöcke; die `GetScriptletTextAttributes`\-Methode ist für Skriptlets.  
