---
title: 'Idebugdocumenthelper:: bringdocumentantop | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72577008"
---
# <a name="idebugdocumenthelperbringdocumenttotop"></a>IDebugDocumentHelper::BringDocumentToTop
Zeigt dieses Dokument am oberen Rand der Debugger-Benutzeroberfläche an.  
...
## <a name="remarks"></a>Hinweise  
 Diese Methode startet den Debugger, wenn er nicht bereits gestartet wurde.  
