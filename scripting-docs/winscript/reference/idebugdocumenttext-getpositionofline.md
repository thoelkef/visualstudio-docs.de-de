...
ms.locfileid: "24726710"
---
# <a name="idebugdocumenttextgetpositionofline"></a>IDebugDocumentText::GetPositionOfLine
Gibt die Zeichenposition, auf das erste Zeichen einer Zeile entspricht.  
...
#### <a name="parameters"></a>Parameter  
 ...
 `pcCharacterPosition`  
 [out] Die Zeichenposition innerhalb des Dokuments, der den Anfang der Zeile `cLineNumber`.  
...
## <a name="remarks"></a>Hinweise  
 Diese Methode gibt die Position des Zeichens, das erste Zeichen einer Zeile entspricht.  
