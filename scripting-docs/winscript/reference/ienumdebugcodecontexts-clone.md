---
title: 'Ienumdebugcodekontexte:: Clone | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Parameter  
 `ppescc`  
 vorgenommen Gibt die `IEnumDebugCodeContexts`-Schnittstelle des Klons des Enumerators zurück.  
