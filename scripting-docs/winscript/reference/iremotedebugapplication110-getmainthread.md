...
---
# IRemoteDebugApplication110::GetMainThread
Gibt den Hauptthread für Hosts, die aufrufen [SetSite](http://go.microsoft.com/fwlink/?LinkId=232439); andernfalls zurückgibt E\_FAIL zurück.  
...
#### Parameter  
 `ppThread`  
 \[out\] [IRemoteDebugApplicationThread\-Schnittstelle](../../winscript/reference/iremotedebugapplicationthread-interface.md).  
