---
title: IRemoteDebugApplicationEvents::OnCreateThread | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
## <a name="remarks"></a>Hinweise  
 Diese Methode behandelt das Thread-Ereignis erstellen.  
