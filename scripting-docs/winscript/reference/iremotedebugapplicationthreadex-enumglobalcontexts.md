...
#### <a name="parameters"></a>Parameter  
 `ppEnum`  
 [out] Ein Enumerator, der die globalen anwendungsausdrücken Kontexten für alle Sprachen, die in diesem Thread ausgeführt werden aufgelistet.  
