...
---
# <a name="administrator-overview"></a>Übersicht für Administratoren
## <a name="roles--responsibilities"></a>Rollen und Zuständigkeiten
Als Gegenleistung für einen Preisnachlass auf Microsoft-Produkte und -Dienste stimmt Ihre Organisation bestimmten Verantwortlichkeiten und Einschränkungen im Hinblick auf Ihre Visual Studio-Abonnements zu. Die Verantwortlichkeit eines Visual Studio-Administrators besteht hauptsächlich aus vier Aufgaben:
...
## <a name="large-teams-and-internal-contractors"></a>Große Teams und interne Auftragnehmer
...
### <a name="open-license-and-open-value"></a>Open License und Open Value
Ihre Abonnements werden Ihnen möglicherweise über Volumenlizenzierungsprogramme von Microsoft wie Microsoft Open License oder Microsoft Open Value zugewiesen. Wenn dies der Fall ist, müssen Sie Ihre Bestellung für zusätzliche Benutzer in dem Monat verarbeiten, in dem diese (Mitarbeiter oder externe Vertragspartner) mit der Interaktion mit lizenzierter Visual Studio-Software beginnen.
