...
- Cloud-Abonnements können über den Visual Studio Marketplace erworben werden.
...
5.  Bestätigen Sie Ihren Kauf, und schließen Sie diesen ab. Besuchen Sie das Portal für Visual Studio-Abonnements [(https://my.visualstudio.com)](https://my.visualstudio.com) oder klicken Sie auf **View my subscription** (Mein Abonnement anzeigen), um Ihre Abonnementvorteile jetzt anzuzeigen.
    ...
    Wenn Sie mehr als ein Abonnement erworben haben, können Sie Abonnements im [Portal zur Verwaltung von Visual Studio-Abonnements]( https://manage.visualstudio.com/cloud) anderen Personen zuweisen oder, indem Sie auf **Assign to users** (Benutzern zuweisen) klicken.
...
*   Senken Sie die Anzahl der Abonnements auf null (0), um diese Abonnements zu kündigen. Sie werden dann am Ende des Monats nicht erneuert.
...
Sehen Sie sich die [Fragen und Antworten zu Marketplace und zur Abrechnung](/vsts/marketplace/marketplace-billing-qa) an, um Antworten auf mehrere häufig gestellte Fragen rund um Visual Studio Marketplace und die Abrechnung in Azure zu erhalten. 
...
8. Wählen Sie Ihre Zahlungsmethode aus, und klicken Sie auf **Select** (Verwenden).

9. Wenn Sie ein Zahlungsmittel hinterlegt haben, wählen Sie dieses aus.  Sie können ein Zahlungsmittel hinzufügen, z.B. eine Kreditkarte, indem Sie die Detailinformationen zu diesem angeben und auf **Speichern** klicken.

10. Klicken Sie auf **Auftrag erteilen**, um den Kauf abzuschließen.  
...
Wenn Sie über den Microsoft Store ein Visual Studio-Abonnement erworben haben, können die Aktivierungsschritte von der Bestätigungsseite aus oder über die Bestätigungs-E-Mail der Zahlung initiiert werden. Hinweis: Wenn Sie keine E-Mail erhalten haben, überprüfen Sie bitte Ihre E-Mail-Adresse, und überprüfen Sie Ihre Spam-Ordner.
...
## <a name="buying-standard-subscriptions-through-volume-license-programs"></a>Standardabonnements über Volumenlizenz-Programme erwerben
