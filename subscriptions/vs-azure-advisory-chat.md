---
title: Azure Advisory Chat-Vorteil in Visual Studio-Abonnements | Microsoft-Dokumentation
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 01/02/2018
...
| Visual Studio Professional (Standard, jährliche Cloud, monatliche Cloud), Visual Studio Enterprise (monatliche Cloud, NFR<sup>1</sup>) | Alle                                      | Nicht verfügbar                                                            |  Nein          |
...
<sup>1</sup> *Umfasst: Not for Resale (NFR), Microsoft Valued Partner (MVP), Region Director (RD), Visual Studio Industry Partner (VSIP), BizSpark, Imagine, MCT*
